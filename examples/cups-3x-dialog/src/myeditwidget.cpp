...
#if 0
    /* Be extremely careful with colors if you wish to support printing.
     * The default print() method only uses the foreground color so
     * if you have white text on a dark background, you will be trying to
     * see the contrast between white on white.
     */
