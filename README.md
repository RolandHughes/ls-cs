...
accept code from them. It is a work in progress and when completed will be
Basis Doctrina.  https://basisdoctrina.com/*
...
The original licese was LGPL V2.1 for CopperSpice. All new source modules
having a Roland Hughes/Logikal Solutions or Basis Doctrina copyright.

Oddly enough CopperSpice included these libraries that were BSD.
...
collisions. Each of these will eventually be replaced by external
libraries as time allows.
...
### Contributing
This is a young project with an old base. As such there is much along the
lines of "grunt work" which would be great for beginning coders who need to
how to use tools and get their feet wet with real projects. Must follow
the [coding standard](https://lscs-software.com/LsCs-CodingStandard.html).
In fact one of the early grunt work projects is converting the code base to
the new coding standard prefered by embedded systems projects. In fact,
fixing QComboBox should be a quick hit for one with just a bit of coding experience.

Purging the legacy display plugins, making GLFW the singular graphics layer
this library communicates with will require someone with a bit more skill.

Keep in mind this project cares primarily about embedded systems and
secondarily about desktops. It will _never_ care about phones.
...
Once LS-CS is "completed" and moved to Basis Doctrina the RedDiamond text
editor should be ported to use Basis Doctrina instead of CopperSpice.
https://sourceforge.net/p/reddiamond/code/ci/master/tree/

You will note that project also has build*.sh files Thieving just a few
files from that project should jumpstart your use of LsCs.

As time allows examples will be added to this code base and instructions
for them added to [the primary Web site](https://lscs-software.com/).
...
Eventually, when the new coding standard is fully implemmented, all of
the documentation will be in the code as Doxygen comments so you can
generate at any point in time.

### License

The CopperSpice library is released under the LGPL V2.1 license.
https://www.gnu.org/licenses

All new Basis Doctrina modules having Roland Hughes/Logikal Solutions
or Basis Doctrina Project copyright are released under the Basis
Doctrina License.

Bais_Doctrina_License.txt
