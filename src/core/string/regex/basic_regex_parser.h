...
template <class charT, class traits> basic_regex_parser<charT, traits>::basic_regex_parser( regex_data<charT, traits> *data )
...
bool basic_regex_parser<charT, traits>::parse_open_paren()
{
    ...
    if ( ( ( this->flags() & ( regbase::main_option_type | regbase::no_perl_ex ) ) == 0 ) ||
            ( ( this->flags() & ( regbase::main_option_type | regbase::emacs_ex ) ) == ( regbase::basic_syntax_group |
                    regbase::emacs_ex ) ) )
    {
        ...
        case regex_constants::escape_type_extended_backref:
            if ( 0 == ( this->flags() & ( regbase::main_option_type | regbase::no_perl_ex ) ) )
            {
                ...
                if ( ( ( i > 0 ) && ( i < std::numeric_limits<unsigned>::digits )
                        && ( i - 1 < static_cast<intmax_t>( sizeof( unsigned ) * CHAR_BIT ) ) &&
...
bool basic_regex_parser<charT, traits>::parse_repeat( std::size_t low, std::size_t high )
{
    ...
    if ( ( m_position != m_end ) && (
                ...
                ( ( regbase::basic_syntax_group | regbase::emacs_ex ) == ( this->flags() & ( regbase::main_option_type |
                        regbase::emacs_ex ) ) ) ) )
    {
...
bool basic_regex_parser<charT, traits>::parse_inner_set( basic_char_set<charT, traits> &char_set )
{
    ...
    switch ( this->m_traits.syntax_type( *m_position ) )
    {
        ...
        case regex_constants::syntax_colon:
        {
            ...
            if ( ( this->flags() & ( regbase::main_option_type | regbase::no_char_classes ) ) == ( regbase::basic_syntax_group  |
...
charT basic_regex_parser<charT, traits>::unescape_character()
{
    ...
    switch ( this->m_traits.escape_syntax_type( *m_position ) )
    {
        ...
        case regex_constants::syntax_digit:
        {
            ...
            std::ptrdiff_t len = ( std::min )( static_cast<std::ptrdiff_t>( std::distance( m_position, m_end ) ),
