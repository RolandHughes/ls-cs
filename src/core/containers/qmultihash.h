...
template <typename Key, typename Val, typename Hash, typename KeyEqual>
typename QMultiHash<Key, Val, Hash, KeyEqual>::size_type QMultiHash<Key, Val, Hash, KeyEqual>::count( const Key &key,
        const Val &value ) const
{
    size_type retval = 0;
...
template <typename Key, typename Val, typename Hash, typename KeyEqual>
typename QMultiHash<Key, Val, Hash, KeyEqual>::size_type QMultiHash<Key, Val, Hash, KeyEqual>::remove( const Key &key,
        const Val &value )
{
    size_type retval = 0;
