...
public:
    ...
    static typename std::enable_if<std::is_base_of<SlotClass, Receiver>::value>::type singleShot( int msec, Receiver *receiver,
    ...
    template <typename Receiver, typename SlotClass, typename SlotReturn>
    static typename std::enable_if<std::is_base_of<SlotClass, Receiver>::value>::type singleShot( int msec, Qt::TimerType timerType,
