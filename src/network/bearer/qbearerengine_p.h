...
public:
    ...
    NET_LSCS_SIGNAL_1( Public, void configurationAdded( QNetworkConfigurationPrivatePointer config ) )
    NET_LSCS_SIGNAL_2( configurationAdded, config )

    NET_LSCS_SIGNAL_1( Public, void configurationRemoved( QNetworkConfigurationPrivatePointer config ) )
    NET_LSCS_SIGNAL_2( configurationRemoved, config )

    NET_LSCS_SIGNAL_1( Public, void configurationChanged( QNetworkConfigurationPrivatePointer config ) )
