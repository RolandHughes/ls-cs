...
void QNetworkReplyHttpImplPrivate::postRequest( const QNetworkRequest &newHttpRequest )
{
    ...
    if ( ! synchronous )
    {
        ...
        QObject::connect( delegate, &QHttpThreadDelegate::downloadData,     q, &QNetworkReplyHttpImpl::replyDownloadData,
                          Qt::QueuedConnection );
        QObject::connect( delegate, &QHttpThreadDelegate::downloadFinished, q, &QNetworkReplyHttpImpl::replyFinished,
                          Qt::QueuedConnection );
        QObject::connect( delegate, &QHttpThreadDelegate::downloadMetaData, q, &QNetworkReplyHttpImpl::replyDownloadMetaData,
                          Qt::QueuedConnection );
        QObject::connect( delegate, &QHttpThreadDelegate::downloadProgress, q, &QNetworkReplyHttpImpl::replyDownloadProgressSlot,
                          Qt::QueuedConnection );
        QObject::connect( delegate, &QHttpThreadDelegate::error,            q, &QNetworkReplyHttpImpl::httpError, Qt::QueuedConnection );
        QObject::connect( delegate, &QHttpThreadDelegate::redirected,       q, &QNetworkReplyHttpImpl::onRedirected,
                          Qt::QueuedConnection );
...
void QNetworkReplyHttpImplPrivate::replySslErrors( const QList<QSslError> &errorList, bool *ignoreAll,
...
QNonContiguousByteDevice *QNetworkReplyHttpImplPrivate::createUploadByteDevice()
{
    ...
    if ( !synchronous )
    {
        QObject::connect( uploadByteDevice.data(), &QNonContiguousByteDevice::readProgress, q,
                          &QNetworkReplyHttpImpl::emitReplyUploadProgress );
    }
