...
void QHttpNetworkConnectionChannel::init()
{
    ...
    QObject::connect( socket, &QTcpSocket::bytesWritten, this, &QHttpNetworkConnectionChannel::_q_bytesWritten,
                      Qt::QueuedConnection );
    QObject::connect( socket, &QTcpSocket::connected,    this, &QHttpNetworkConnectionChannel::_q_connected,
                      Qt::QueuedConnection );
    QObject::connect( socket, &QTcpSocket::readyRead,    this, &QHttpNetworkConnectionChannel::_q_readyRead,
                      Qt::QueuedConnection );
    ...
    QObject::connect( socket, &QTcpSocket::disconnected, this, &QHttpNetworkConnectionChannel::_q_disconnected,
                      Qt::QueuedConnection );
