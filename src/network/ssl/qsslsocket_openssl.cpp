        ...
        QList<QSslCertificate> *caCertificates, const QByteArray &passPhrase )
{
    ...
    if ( ! p12 )
    {
        qWarning( "QSslSocketBackend::importPkcs12() Unable to read PKCS#12 structure, %s", q_ERR_error_string( q_ERR_get_error(),
                  nullptr ) );
        q_BIO_free( bio );
    ...
    {
        qWarning( "QSslSocketBackend::importPkcs12() Unable to parse PKCS#12 structure, %s", q_ERR_error_string( q_ERR_get_error(),
                  nullptr ) );
