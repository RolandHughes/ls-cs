...
template<typename T, typename U, typename V, typename W, typename X>
inline pair<typename RefPtrHashMap<T, U, V, W, X>::iterator, bool> RefPtrHashMap<T, U, V, W, X>::inlineAdd( const KeyType &key,
...
template<typename T, typename U, typename V, typename W, typename X>
inline pair<typename RefPtrHashMap<T, U, V, W, X>::iterator, bool> RefPtrHashMap<T, U, V, W, X>::inlineAdd( RawKeyType key,
        const MappedType &mapped )
{
...
template<typename T, typename U, typename V, typename W, typename X>
pair<typename RefPtrHashMap<T, U, V, W, X>::iterator, bool> RefPtrHashMap<T, U, V, W, X>::set( RawKeyType key,
        const MappedType &mapped )
{
    pair<iterator, bool> result = inlineAdd( key, mapped );
...
template<typename T, typename U, typename V, typename W, typename X>
pair<typename RefPtrHashMap<T, U, V, W, X>::iterator, bool> RefPtrHashMap<T, U, V, W, X>::add( RawKeyType key,
        const MappedType &mapped )
{
    return inlineAdd( key, mapped );
}
...
typename RefPtrHashMap<T, U, V, W, MappedTraits>::MappedType RefPtrHashMap<T, U, V, W, MappedTraits>::get(
...
template<typename T, typename U, typename V, typename W, typename MappedTraits>
typename RefPtrHashMap<T, U, V, W, MappedTraits>::MappedType RefPtrHashMap<T, U, V, W, MappedTraits>::get( RawKeyType key ) const
{
...
template<typename T, typename U, typename V, typename W, typename MappedTraits>
typename RefPtrHashMap<T, U, V, W, MappedTraits>::MappedType RefPtrHashMap<T, U, V, W, MappedTraits>::take( RawKeyType key )
{
    // This can probably be made more efficient to avoid ref/deref churn.
    iterator it = find( key );
