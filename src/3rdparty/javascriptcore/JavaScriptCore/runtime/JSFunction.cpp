...
JSFunction::JSFunction( ExecState *exec, NonNullPassRefPtr<Structure> structure, int length, const Identifier &name,
                        NativeFunction func )
...
JSValue JSFunction::call( ExecState *exec, JSValue thisValue, const ArgList &args )
{
    ...
    return exec->interpreter()->execute( jsExecutable(), exec, this, thisValue.toThisObject( exec ), args, scopeChain().node(),
                                         exec->exceptionSlot() );
}
...
JSObject *JSFunction::construct( ExecState *exec, const ArgList &args )
{
    ...
    JSValue result = exec->interpreter()->execute( jsExecutable(), exec, this, thisObj, args, scopeChain().node(),
                     exec->exceptionSlot() );
