...
RegisterID *ThrowableExpressionData::emitThrowError( BytecodeGenerator &generator, ErrorType type, const char *messageTemplate,
        const UString &label )
{
...
inline RegisterID *ThrowableExpressionData::emitThrowError( BytecodeGenerator &generator, ErrorType type,
        const char *messageTemplate, const Identifier &label )
{
...
RegisterID *EvalFunctionCallNode::emitBytecode( BytecodeGenerator &generator, RegisterID *dst )
{
    ...
    return generator.emitCallEval( generator.finalDestination( dst, func.get() ), func.get(), thisRegister.get(), m_args, divot(),
...
RegisterID *FunctionCallValueNode::emitBytecode( BytecodeGenerator &generator, RegisterID *dst )
{
    ...
    return generator.emitCall( generator.finalDestination( dst, func.get() ), func.get(), thisRegister.get(), m_args, divot(),
                               startOffset(), endOffset() );
}
...
RegisterID *FunctionCallResolveNode::emitBytecode( BytecodeGenerator &generator, RegisterID *dst )
{
    ...
    {
        RefPtr<RegisterID> thisRegister = generator.emitLoad( generator.newTemporary(), jsNull() );
        return generator.emitCall( generator.finalDestination( dst, thisRegister.get() ), local.get(), thisRegister.get(), m_args,
...
RegisterID *FunctionCallBracketNode::emitBytecode( BytecodeGenerator &generator, RegisterID *dst )
{
    ...
    return generator.emitCall( generator.finalDestination( dst, function.get() ), function.get(), thisRegister.get(), m_args, divot(),
                               startOffset(), endOffset() );
}
...
RegisterID *ApplyFunctionCallDotNode::emitBytecode( BytecodeGenerator &generator, RegisterID *dst )
{
    ...
    generator.emitJumpIfNotFunctionApply( function.get(), realCall.get() );
    {
        ...
        else
        {
            ...
            generator.emitCallVarargs( finalDestination.get(), realFunction.get(), thisRegister.get(), argsCountRegister.get(), divot(),
                                       startOffset(), endOffset() );
        }
