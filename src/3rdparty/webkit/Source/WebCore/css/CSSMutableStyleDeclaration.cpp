...
bool CSSMutableStyleDeclaration::setProperty( int propertyID, double value, CSSPrimitiveValue::UnitTypes unit, bool important,
        bool notifyChanged )
{
...
void CSSMutableStyleDeclaration::setStringProperty( int propertyId, const String &value, CSSPrimitiveValue::UnitTypes type,
        bool important )
{
    ASSERT( !m_iteratorCount );
