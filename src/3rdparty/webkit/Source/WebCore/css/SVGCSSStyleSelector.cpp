...
void CSSStyleSelector::applySVGProperty( int id, CSSValue *value )
{
    ...
    switch ( id )
    {
        ...
        case CSSPropertyStroke:
        {
            ...
            {
                const SVGRenderStyle *svgParentStyle = m_parentStyle->svgStyle();
                svgstyle->setStrokePaint( svgParentStyle->strokePaintType(), svgParentStyle->strokePaintColor(),
        ...
        case CSSPropertyWebkitSvgShadow:
        {
            if ( isInherit )
            {
                return svgstyle->setShadow( adoptPtr( m_parentStyle->svgStyle()->shadow() ? new ShadowData(
                        *m_parentStyle->svgStyle()->shadow() ) : 0 ) );
            }
            ...
            OwnPtr<ShadowData> shadowData = adoptPtr( new ShadowData( x, y, blur, 0, Normal, false,
