...
public:
    ...
    void setTop( PassRefPtr<CSSPrimitiveValue> top )
    {
        m_top = top;
    }
    void setRight( PassRefPtr<CSSPrimitiveValue> right )
    {
        m_right = right;
    }
    ...
    void setLeft( PassRefPtr<CSSPrimitiveValue> left )
    {
        m_left = left;
    }
...
{
public:
    static PassRefPtr<Rect> create()
    {
        return adoptRef( new Rect );
    }
