...
public:
    ...
    {
        load( cachedResourceLoader, false, DoSecurityCheck, true );
    }
    ...
    void setRequestedFromNetworkingLayer()
    {
    ...
    Status status() const
    {
        return static_cast<Status>( m_status );
    }
    ...
    bool isLoaded() const
    {
        return !m_loading;    // FIXME. Method name is inaccurate. Loading might not have started yet.
    }
    ...
    void setInLiveDecodedResourcesList( bool b )
    {
        m_inLiveDecodedResourcesList = b;
    }
    bool inLiveDecodedResourcesList()
    {
        return m_inLiveDecodedResourcesList;
    }
    ...
    {
        return !hasClients() && !m_request && !m_preloadCount && !m_handleCount && !m_resourceToRevalidate && !m_proxyResource;
    }
    ...
    {
        m_owningCachedResourceLoader = cachedResourceLoader;
    }
