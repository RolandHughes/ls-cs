...
public:
    ...
    static PassRefPtr<Animation> create()
    {
        return adoptRef( new Animation );
    }
    static PassRefPtr<Animation> create( const Animation *o )
    {
        return adoptRef( new Animation( *o ) );
    }
    ...
    {
        return m_fillModeSet;
    }
    bool isIterationCountSet() const
    {
        return m_iterationCountSet;
    }
    ...
    {
        return !m_isNone && !m_name.isEmpty();
    }
    ...
    void clearPlayState()
    {
        m_playStateSet = AnimPlayStatePlaying;
    }
    void clearProperty()
    {
        m_propertySet = false;
    ...
    {
        return static_cast<AnimationDirection>( m_direction );
    }
    ...
    {
        return static_cast<EAnimPlayState>( m_playState );
    }
    int property() const
    {
        return m_property;
    }
    const PassRefPtr<TimingFunction> timingFunction() const
    {
    ...
    {
        return m_fillModeSet && ( m_fillMode == AnimationFillModeBackwards || m_fillMode == AnimationFillModeBoth );
    }
    bool fillsForwards() const
    {
        return m_fillModeSet && ( m_fillMode == AnimationFillModeForwards || m_fillMode == AnimationFillModeBoth );
    }
...
public:
    static float initialAnimationDelay()
    {
        return 0;
    }
    static AnimationDirection initialAnimationDirection()
    {
        return AnimationDirectionNormal;
    }
    static double initialAnimationDuration()
    {
        return 0;
    }
    static unsigned initialAnimationFillMode()
    {
        return AnimationFillModeNone;
    }
    static int initialAnimationIterationCount()
    {
        return 1;
    }
    static String initialAnimationName()
    {
        return String( "none" );
    }
    ...
    static int initialAnimationProperty()
    {
        return cAnimateAll;
    }
    static PassRefPtr<TimingFunction> initialAnimationTimingFunction()
    {
