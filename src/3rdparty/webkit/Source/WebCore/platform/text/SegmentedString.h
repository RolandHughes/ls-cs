...
public:
    ...
    {
        return lookAheadInline<SegmentedString::equalsLiterally>( string );
    }
    LookAheadResult lookAheadIgnoringCase( const String &string )
    {
        return lookAheadInline<SegmentedString::equalsIgnoringCase>( string );
    }
...
private:
    ...
    static bool equalsLiterally( const UChar *str1, const UChar *str2, size_t count )
    {
        return !memcmp( str1, str2, count * sizeof( UChar ) );
    }
    static bool equalsIgnoringCase( const UChar *str1, const UChar *str2, size_t count )
    {
        return !WTF::Unicode::umemcasecmp( str1, str2, count );
    }
