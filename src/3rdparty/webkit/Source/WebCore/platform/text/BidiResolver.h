...
struct BidiStatus
{
    ...
    BidiStatus( WTF::Unicode::Direction eorDir, WTF::Unicode::Direction lastStrongDir, WTF::Unicode::Direction lastDir,
...
public:
    ...
    MidpointState<Iterator> &midpointState()
    {
        return m_midpointState;
    }
...
void BidiResolver<Iterator, Run>::embed( WTF::Unicode::Direction dir, BidiEmbeddingSource source )
{
    ...
    ASSERT( dir == PopDirectionalFormat || dir == LeftToRightEmbedding || dir == LeftToRightOverride || dir == RightToLeftEmbedding
...
template <class Iterator, class Run>
void BidiResolver<Iterator, Run>::createBidiRunsForLine( const Iterator &end, VisualDirectionOverride override,
        bool hardLineBreak )
{
    using namespace WTF::Unicode;
