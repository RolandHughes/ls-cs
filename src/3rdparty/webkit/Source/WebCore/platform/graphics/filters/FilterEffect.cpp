...
ImageBuffer *FilterEffect::asImageBuffer()
{
    ...
    if ( m_premultipliedImageResult )
    {
        m_imageBufferResult->putPremultipliedImageData( m_premultipliedImageResult.get(), destinationRect.size(), destinationRect,
                IntPoint() );
    }
    else
    {
        m_imageBufferResult->putUnmultipliedImageData( m_unmultipliedImageResult.get(), destinationRect.size(), destinationRect,
                IntPoint() );
    }
