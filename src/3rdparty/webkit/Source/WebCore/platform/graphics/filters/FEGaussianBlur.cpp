...
inline void FEGaussianBlur::platformApplyGeneric( ByteArray *srcPixelArray, ByteArray *tmpPixelArray, unsigned kernelSizeX,
        unsigned kernelSizeY, IntSize &paintSize )
{
    ...
    for ( int i = 0; i < 3; ++i )
    {
        if ( kernelSizeX )
        {
            ...
            boxBlur( srcPixelArray, tmpPixelArray, kernelSizeX, dxLeft, dxRight, 4, stride, paintSize.width(), paintSize.height(),
                     isAlphaImage() );
        }
        else
        {
        ...
        if ( kernelSizeY )
        {
            ...
            boxBlur( tmpPixelArray, srcPixelArray, kernelSizeY, dyLeft, dyRight, stride, 4, paintSize.height(), paintSize.width(),
                     isAlphaImage() );
        }
        else
        {
...
inline void FEGaussianBlur::platformApply( ByteArray *srcPixelArray, ByteArray *tmpPixelArray, unsigned kernelSizeX,
        unsigned kernelSizeY, IntSize &paintSize )
{
