...
PassRefPtr<TransformOperation> TranslateTransformOperation::blend( const TransformOperation *from, double progress,
        bool blendToIdentity )
{
    ...
    return TranslateTransformOperation::create( m_x.blend( fromX, narrowPrecisionToFloat( progress ) ), m_y.blend( fromY,
            narrowPrecisionToFloat( progress ) ), m_z.blend( fromZ, narrowPrecisionToFloat( progress ) ), m_type );
}
