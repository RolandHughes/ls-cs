...
static void webKitWebSrcNeedDataCb( GstAppSrc *appsrc, guint length, gpointer userData )
{
    ...
    priv->needDataID = g_timeout_add_full( G_PRIORITY_DEFAULT, 0, ( GSourceFunc ) webKitWebSrcNeedDataMainCb, gst_object_ref( src ),
...
static void webKitWebSrcEnoughDataCb( GstAppSrc *appsrc, gpointer userData )
{
    ...
    priv->enoughDataID = g_timeout_add_full( G_PRIORITY_DEFAULT, 0, ( GSourceFunc ) webKitWebSrcEnoughDataMainCb,
...
static gboolean webKitWebSrcSeekDataCb( GstAppSrc *appsrc, guint64 offset, gpointer userData )
{
    ...
    priv->seekID = g_timeout_add_full( G_PRIORITY_DEFAULT, 0, ( GSourceFunc ) webKitWebSrcSeekMainCb, gst_object_ref( src ),
                                       ( GDestroyNotify ) gst_object_unref );
    GST_OBJECT_UNLOCK( src );
