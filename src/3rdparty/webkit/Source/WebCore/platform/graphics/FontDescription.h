...
public:
    ...
    {
        return static_cast<FontItalic>( m_italic );
    }
    int computedPixelSize() const
    {
        return int( m_computedSize + 0.5f );
    }
    FontSmallCaps smallCaps() const
    {
        return static_cast<FontSmallCaps>( m_smallCaps );
    }
    ...
    {
        return static_cast<FontWeight>( m_weight );
    }
    ...
    {
        return m_usePrinterFont;
    }
    // only use fixed default size when there is only one font family, and that family is "monospace"
    bool useFixedDefaultSize() const
    {
        return genericFamily() == MonospaceFamily && !family().next() && family().family() == "-webkit-monospace";
    }
    FontRenderingMode renderingMode() const
    {
        return static_cast<FontRenderingMode>( m_renderingMode );
    }
    unsigned keywordSize() const
    {
        return m_keywordSize;
    }
    ...
    void setItalic( FontItalic i )
    {
        m_italic = i;
    }
    void setItalic( bool i )
    {
        setItalic( i ? FontItalicOn : FontItalicOff );
    }
    void setSmallCaps( FontSmallCaps c )
    {
        m_smallCaps = c;
    }
    void setSmallCaps( bool c )
    {
        setSmallCaps( c ? FontSmallCapsOn : FontSmallCapsOff );
    }
    ...
    {
        m_isSpecifiedFont = isSpecifiedFont;
    }
