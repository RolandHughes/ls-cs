...
public:
    ...
    {
        return m_paginationStrut;
    }
    void setPaginationStrut( int s )
    {
        m_paginationStrut = s;
    }
    ...
    int blockLogicalHeight() const
    {
        return m_blockLogicalHeight;
    }
    void setBlockLogicalHeight( int h )
    {
        m_blockLogicalHeight = h;
    }
    ...
    void placeEllipsis( const AtomicString &ellipsisStr, bool ltr, float blockLeftEdge, float blockRightEdge, float ellipsisWidth,
                        InlineBox *markupBox = 0 );
    ...
    {
        return boxModelObject()->lineHeight( m_firstLine, isHorizontal() ? HorizontalLine : VerticalLine, PositionOfInteriorLineBoxes );
    }
    ...
    {
        return m_hasSelectedChildrenOrCanHaveLeadingExpansion;
    }
    void setHasSelectedChildren( bool hasSelectedChildren )
    {
        m_hasSelectedChildrenOrCanHaveLeadingExpansion = hasSelectedChildren;
    }
    ...
    GapRects lineSelectionGap( RenderBlock *rootBlock, const IntPoint &rootBlockPhysicalPosition, const IntSize &offsetFromRootBlock,
                               int selTop, int selHeight, const PaintInfo * );
    ...
    {
        return m_hasAnnotationsBefore;
    }
    bool hasAnnotationsAfter() const
    {
        return m_hasAnnotationsAfter;
    }

    IntRect paddedLayoutOverflowRect( int endPadding ) const;

    void ascentAndDescentForBox( InlineBox *, GlyphOverflowAndFallbackFontsMap &, int &ascent, int &descent, bool &affectsAscent,
...
private:
    ...
    {
        return m_hasEllipsisBoxOrHyphen;
    }
