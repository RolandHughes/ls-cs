...
public:
    ...
    {
        return toRenderTableSection( parent()->parent() );
    }
    RenderTable *table() const
    {
        return toRenderTable( parent()->parent()->parent() );
    }
    ...
    bool cellWidthChanged() const
    {
        return m_cellWidthChanged;
    }
    void setCellWidthChanged( bool b = true )
    {
...
private:
    ...
    {
        return isAnonymous() ? "RenderTableCell (anonymous)" : "RenderTableCell";
    }
