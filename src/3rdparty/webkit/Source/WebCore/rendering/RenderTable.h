...
public:
    ...
    {
        return m_columnPos[col];
    }

    int hBorderSpacing() const
    {
        return m_hSpacing;
    }
    int vBorderSpacing() const
    {
        return m_vSpacing;
    }
    ...
    const CollapsedBorderValue *currentBorderStyle() const
    {
    ...
    {
        return m_head || m_foot || m_firstBody;
    }
