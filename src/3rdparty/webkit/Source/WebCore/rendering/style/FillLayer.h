...
public:
    ...
    Length xPosition() const
    {
        return m_xPosition;
    }
    Length yPosition() const
    {
        return m_yPosition;
    }
    ...
    EFillBox clip() const
    {
        return static_cast<EFillBox>( m_clip );
    }
    EFillBox origin() const
    {
        return static_cast<EFillBox>( m_origin );
    }
    EFillRepeat repeatX() const
    {
        return static_cast<EFillRepeat>( m_repeatX );
    }
    EFillRepeat repeatY() const
    {
        return static_cast<EFillRepeat>( m_repeatY );
    }
    CompositeOperator composite() const
    {
        return static_cast<CompositeOperator>( m_composite );
    }
    LengthSize sizeLength() const
    {
        return m_sizeLength;
    }
    ...
    {
        return m_compositeSet;
    }
    bool isSizeSet() const
    {
        return m_sizeType != SizeNone;
    }
    ...
    void setXPosition( Length l )
    {
        m_xPosition = l;
        m_xPosSet = true;
    }
    void setYPosition( Length l )
    {
        m_yPosition = l;
        m_yPosSet = true;
    }
    ...
    {
        return static_cast<EFillLayerType>( m_type );
    }
