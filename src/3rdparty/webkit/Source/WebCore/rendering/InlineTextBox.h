...
void updateGraphicsContext( GraphicsContext *, const Color &fillColor, const Color &strokeColor, float strokeThickness,
                            ColorSpace );
...
public:
    ...
    {
        return m_prevTextBox;
    }
    InlineTextBox *nextTextBox() const
    {
        return m_nextTextBox;
    }
    ...
    {
        return logicalOverflowRect().x();
    }
    int logicalRightVisualOverflow() const
    {
        return logicalOverflowRect().maxX();
    }
...
private:
    ...
    virtual float placeEllipsisBox( bool flowIsLTR, float visibleLeftEdge, float visibleRightEdge, float ellipsisWidth,
                                    bool &foundBox );
...
public:
    ...
    static FloatSize applyShadowToGraphicsContext( GraphicsContext *, const ShadowData *, const FloatRect &textRect, bool stroked,
            bool opaque, bool horizontal );
...
protected:
    void paintCompositionBackground( GraphicsContext *, const FloatPoint &boxOrigin, RenderStyle *, const Font &, int startPos,
                                     int endPos );
...
private:
    ...
    void paintSpellingOrGrammarMarker( GraphicsContext *, const FloatPoint &boxOrigin, const DocumentMarker &, RenderStyle *,
                                       const Font &, bool grammar );
