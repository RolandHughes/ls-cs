...
public:
    ...
    bool placeholderIsVisible() const
    {
...
private:
    ...
    virtual String itemToolTip( unsigned ) const
    {
        return String();
    }
    virtual String itemAccessibilityText( unsigned ) const
    {
        return String();
    }
