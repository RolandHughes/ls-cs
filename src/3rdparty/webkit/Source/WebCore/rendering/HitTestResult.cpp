...
HitTestResult::HitTestResult( const IntPoint &centerPoint, unsigned topPadding, unsigned rightPadding, unsigned bottomPadding,
...
String HitTestResult::replacedString() const
{
    ...
    DocumentMarker *marker = m_innerNonSharedNode->document()->markers()->markerContainingPoint( m_point,
...
void HitTestResult::append( const HitTestResult &other )
{
    ...
    if ( other.m_rectBasedTestResult )
    {
        ...
        for ( NodeSet::const_iterator it = other.m_rectBasedTestResult->begin(), last = other.m_rectBasedTestResult->end(); it != last;
                ++it )
        {
            set.add( it->get() );
        }
...
IntRect HitTestResult::rectForPoint( const IntPoint &point, unsigned topPadding, unsigned rightPadding, unsigned bottomPadding,
                                     unsigned leftPadding )
{
