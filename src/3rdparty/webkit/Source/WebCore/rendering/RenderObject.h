...
public:
    ...
    void showRenderTreeAndMark( const RenderObject *markedObject1 = 0, const char *markedLabel1 = 0,
                                const RenderObject *markedObject2 = 0, const char *markedLabel2 = 0, int depth = 0 ) const;
#endif
...
public:
    ...
    static inline bool isBeforeContent( const RenderObject *obj )
    {
        return obj && obj->isBeforeContent();
    }
    static inline bool isAfterContent( const RenderObject *obj )
    {
        return obj && obj->isAfterContent();
    }
    static inline bool isBeforeOrAfterContent( const RenderObject *obj )
    {
    ...
    void setChildrenInline( bool b = true )
    {
        m_childrenInline = b;
    }
    ...
    void setHasColumns( bool b = true )
    {
        m_hasColumns = b;
    }
    ...
    bool isAnonymousBlock() const
    {
        ...
        return m_isAnonymous && ( style()->display() == BLOCK || style()->display() == BOX ) && style()->styleType() == NOPSEUDO
               && isRenderBlock() && !isListMarker()
#if ENABLE(FULLSCREEN_API)
               && !isRenderFullScreen()
#endif
               ;
    }
    bool isAnonymousColumnsBlock() const
    {
        return style()->specifiesColumns() && isAnonymousBlock();
    }
    bool isAnonymousColumnSpanBlock() const
    {
        return style()->columnSpan() && isAnonymousBlock();
    }
    ...
    {
        return m_positioned;    // absolute or fixed positioning
    }
    bool isRelPositioned() const
    {
        return m_relPositioned;    // relative positioning
    }
    bool isText() const
    {
        return m_isText;
    ...
    {
        return m_replaced;    // a "replaced" element (see CSS)
    }
    bool isHorizontalWritingMode() const
    {
        return m_horizontalWritingMode;
    }
    ...
    {
        return m_needsLayout || m_normalChildNeedsLayout || m_posChildNeedsLayout || m_needsSimplifiedNormalFlowLayout
    ...
    {
        return m_needsPositionedMovementLayout;
    }
    bool needsPositionedMovementLayoutOnly() const
    {
        return m_needsPositionedMovementLayout && !m_needsLayout && !m_normalChildNeedsLayout && !m_posChildNeedsLayout
    ...
    {
        return m_needsSimplifiedNormalFlowLayout;
    }
    ...
    {
        return m_preferredLogicalWidthsDirty;
    }
    ...
    void setHasBoxDecorations( bool b = true )
    {
        m_paintBackground = b;
    }
    void setIsText()
    ...
    void setHasTransform( bool b = true )
    {
        m_hasTransform = b;
    }
    void setHasReflection( bool b = true )
    {
        m_hasReflection = b;
    }
    ...
    bool repaintAfterLayoutIfNeeded( RenderBoxModelObject *repaintContainer, const IntRect &oldBounds, const IntRect &oldOutlineBox,
                                     const IntRect *newBoundsPtr = 0, const IntRect *newOutlineBoxPtr = 0 );
    ...
    void setHasMarkupTruncation( bool b = true )
    {
        m_hasMarkupTruncation = b;
    }
    bool hasMarkupTruncation() const
    {
        return m_hasMarkupTruncation;
    }
    ...
    IntRect selectionRect( bool clipToVisibleContent = true )
    {
        return selectionRectForRepaint( 0, clipToVisibleContent );
    }
    ...
    {
        return m_selectionState != SelectionNone;
    }
    ...
    bool isMarginBeforeQuirk() const
    {
        return m_marginBeforeQuirk;
    }
    bool isMarginAfterQuirk() const
    {
        return m_marginAfterQuirk;
    }
    void setMarginBeforeQuirk( bool b = true )
    {
        m_marginBeforeQuirk = b;
    }
    void setMarginAfterQuirk( bool b = true )
    {
    ...
    bool hasOverrideSize() const
    {
        return m_hasOverrideSize;
    }
    void setHasOverrideSize( bool b )
    {
        m_hasOverrideSize = b;
    }
    ...
    {
        return style()->visibility() == VISIBLE && style()->pointerEvents() != PE_NONE;
    }
...
protected:
    ...
    virtual IntRect outlineBoundsForRepaint( RenderBoxModelObject * /*repaintContainer*/,
            IntPoint * /*cachedOffsetToRepaintContainer*/ = 0 ) const
    {
        return IntRect();
    }
...
inline bool objectIsRelayoutBoundary( const RenderObject *obj )
{
    ...
    return obj->isTextControl()
           || ( obj->hasOverflowClip() && !obj->style()->width().isIntrinsicOrAuto() && !obj->style()->height().isIntrinsicOrAuto()
                && !obj->style()->height().isPercent() && !obj->isTableCell() )
#if ENABLE(SVG)
           || obj->isSVGRoot()
#endif
           ;
