...
IntRect RenderTableCell::clippedOverflowRectForRepaint( RenderBoxModelObject *repaintContainer )
{
    ...
    IntRect r( -left, - top, left + max( width() + right, maxXVisualOverflow() ), top + max( height() + bottom,
               maxYVisualOverflow() ) );
...
CollapsedBorderValue RenderTableCell::collapsedStartBorder() const
{
    ...
    // (1) Our start border.
    int start = CSSProperty::resolveDirectionAwareProperty( CSSPropertyWebkitBorderStartColor, table->style()->direction(),
                table->style()->writingMode() );
    int end = CSSProperty::resolveDirectionAwareProperty( CSSPropertyWebkitBorderEndColor, table->style()->direction(),
              table->style()->writingMode() );
    ...
    {
        CollapsedBorderValue prevCellBorder = CollapsedBorderValue( &prevCell->style()->borderEnd(),
                                              prevCell->style()->visitedDependentColor( end ), BCELL );
    ...
    else if ( isStartColumn )
    {
        ...
        result = chooseBorder( result, CollapsedBorderValue( &parent()->style()->borderStart(),
                               parent()->style()->visitedDependentColor( start ), BROW ) );
        ...
        result = chooseBorder( result, CollapsedBorderValue( &section()->style()->borderStart(),
                               section()->style()->visitedDependentColor( start ), BROWGROUP ) );
    ...
    {
        result = chooseBorder( result, CollapsedBorderValue( &colElt->style()->borderStart(),
                               colElt->style()->visitedDependentColor( start ), BCOL ) );
        ...
        {
            result = chooseBorder( result, CollapsedBorderValue( &colElt->parent()->style()->borderStart(),
                                   colElt->parent()->style()->visitedDependentColor( start ), BCOLGROUP ) );
    ...
    if ( !isStartColumn )
    {
        ...
        {
            CollapsedBorderValue endBorder = CollapsedBorderValue( &colElt->style()->borderEnd(),
                                             colElt->style()->visitedDependentColor( end ), BCOL );
    ...
    else
    {
        ...
        result = chooseBorder( result, CollapsedBorderValue( &table->style()->borderStart(),
                               table->style()->visitedDependentColor( start ), BTABLE ) );
...
CollapsedBorderValue RenderTableCell::collapsedEndBorder() const
{
    ...
    if ( !isEndColumn )
    {
        ...
        {
            CollapsedBorderValue startBorder = CollapsedBorderValue( &nextCell->style()->borderStart(),
                                               nextCell->style()->visitedDependentColor( start ), BCELL );
    ...
    else
    {
        ...
        result = chooseBorder( result, CollapsedBorderValue( &parent()->style()->borderEnd(),
                               parent()->style()->visitedDependentColor( end ), BROW ) );
        ...
        result = chooseBorder( result, CollapsedBorderValue( &section()->style()->borderEnd(),
                               section()->style()->visitedDependentColor( end ), BROWGROUP ) );
    ...
    if ( colElt && endColEdge )
    {
        result = chooseBorder( result, CollapsedBorderValue( &colElt->style()->borderEnd(), colElt->style()->visitedDependentColor( end ),
                               BCOL ) );
        ...
        {
            result = chooseBorder( result, CollapsedBorderValue( &colElt->parent()->style()->borderEnd(),
                                   colElt->parent()->style()->visitedDependentColor( end ), BCOLGROUP ) );
    ...
    if ( !isEndColumn )
    {
        ...
        if ( colElt && startColEdge )
        {
            CollapsedBorderValue startBorder = CollapsedBorderValue( &colElt->style()->borderStart(),
                                               colElt->style()->visitedDependentColor( start ), BCOL );
            result = chooseBorder( result, startBorder );
    ...
    else
    {
        ...
        result = chooseBorder( result, CollapsedBorderValue( &table->style()->borderEnd(), table->style()->visitedDependentColor( end ),
                               BTABLE ) );
...
CollapsedBorderValue RenderTableCell::collapsedBeforeBorder() const
{
    ...
    // (1) Our before border.
    int before = CSSProperty::resolveDirectionAwareProperty( CSSPropertyWebkitBorderBeforeColor, table->style()->direction(),
                 table->style()->writingMode() );
    int after = CSSProperty::resolveDirectionAwareProperty( CSSPropertyWebkitBorderAfterColor, table->style()->direction(),
                table->style()->writingMode() );
    ...
    if ( prevCell )
    {
        ...
        result = chooseBorder( CollapsedBorderValue( &prevCell->style()->borderAfter(), prevCell->style()->visitedDependentColor( after ),
                               BCELL ), result );
    ...
    result = chooseBorder( result, CollapsedBorderValue( &parent()->style()->borderBefore(),
                           parent()->style()->visitedDependentColor( before ), BROW ) );
    ...
    if ( prevCell )
    {
        ...
        if ( prevRow )
        {
            result = chooseBorder( CollapsedBorderValue( &prevRow->style()->borderAfter(), prevRow->style()->visitedDependentColor( after ),
                                   BROW ), result );
    ...
    if ( !row() )
    {
        ...
        result = chooseBorder( result, CollapsedBorderValue( &currSection->style()->borderBefore(),
                               currSection->style()->visitedDependentColor( before ), BROWGROUP ) );
        ...
        if ( currSection )
        {
            result = chooseBorder( CollapsedBorderValue( &currSection->style()->borderAfter(),
                                   currSection->style()->visitedDependentColor( after ), BROWGROUP ), result );
    ...
    if ( !currSection )
    {
        ...
        if ( colElt )
        {
            result = chooseBorder( result, CollapsedBorderValue( &colElt->style()->borderBefore(),
                                   colElt->style()->visitedDependentColor( before ), BCOL ) );
            ...
            {
                result = chooseBorder( result, CollapsedBorderValue( &colElt->parent()->style()->borderBefore(),
                                       colElt->parent()->style()->visitedDependentColor( before ), BCOLGROUP ) );
        ...
        result = chooseBorder( result, CollapsedBorderValue( &table->style()->borderBefore(),
                               table->style()->visitedDependentColor( before ), BTABLE ) );
...
CollapsedBorderValue RenderTableCell::collapsedAfterBorder() const
{
    ...
    if ( nextCell )
    {
        ...
        result = chooseBorder( result, CollapsedBorderValue( &nextCell->style()->borderBefore(),
                               nextCell->style()->visitedDependentColor( before ), BCELL ) );
    ...
    result = chooseBorder( result, CollapsedBorderValue( &parent()->style()->borderAfter(),
                           parent()->style()->visitedDependentColor( after ), BROW ) );
    ...
    if ( nextCell )
    {
        result = chooseBorder( result, CollapsedBorderValue( &nextCell->parent()->style()->borderBefore(),
                               nextCell->parent()->style()->visitedDependentColor( before ), BROW ) );
    ...
    if ( row() + rowSpan() >= currSection->numRows() )
    {
        ...
        result = chooseBorder( result, CollapsedBorderValue( &currSection->style()->borderAfter(),
                               currSection->style()->visitedDependentColor( after ), BROWGROUP ) );
    ...
    if ( !currSection )
    {
        ...
        if ( colElt )
        {
            result = chooseBorder( result, CollapsedBorderValue( &colElt->style()->borderAfter(),
                                   colElt->style()->visitedDependentColor( after ), BCOL ) );
            ...
            if ( colElt->parent()->isTableCol() )
            {
                result = chooseBorder( result, CollapsedBorderValue( &colElt->parent()->style()->borderAfter(),
                                       colElt->parent()->style()->visitedDependentColor( after ), BCOLGROUP ) );
        ...
        result = chooseBorder( result, CollapsedBorderValue( &table->style()->borderAfter(),
                               table->style()->visitedDependentColor( after ), BTABLE ) );
...
int RenderTableCell::borderHalfStart( bool outer ) const
{
    ...
    if ( border.exists() )
    {
        return ( border.width() + ( ( table()->style()->isLeftToRightDirection() ^ outer ) ? 1 : 0 ) ) /
...
int RenderTableCell::borderHalfBefore( bool outer ) const
{
    ...
    if ( border.exists() )
    {
        return ( border.width() + ( ( table()->style()->isFlippedBlocksWritingMode() ^ outer ) ? 0 : 1 ) ) /
               2;    // Give the extra pixel to top and left.
    }
...
void RenderTableCell::paintBackgroundsBehindCell( PaintInfo &paintInfo, int tx, int ty, RenderObject *backgroundObject )
{
    ...
    if ( bgLayer->hasImage() || c.isValid() )
    {
        ...
        bool shouldClip = backgroundObject->hasLayer() && ( backgroundObject == this || backgroundObject == parent() )
