...
public:
    ...
    HitTestResult( const IntPoint &centerPoint, unsigned topPadding, unsigned rightPadding, unsigned bottomPadding,
    ...
    {
        return m_innerNonSharedNode.get();
    }
    ...
    {
        return m_isRectBased;
    }
    IntRect rectForPoint( int x, int y ) const;
    IntRect rectForPoint( const IntPoint & ) const;
    static IntRect rectForPoint( const IntPoint &, unsigned topPadding, unsigned rightPadding, unsigned bottomPadding,
                                 unsigned leftPadding );
