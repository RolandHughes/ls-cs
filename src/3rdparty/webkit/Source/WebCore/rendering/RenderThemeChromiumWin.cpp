...
public:
    ...
    const IntRect &drawRect()
    {
        return m_helper.drawRect();
    }
...
unsigned RenderThemeChromiumWin::determineState( RenderObject *o, ControlSubPart subPart )
{
    ...
    {
        result = ( appearance == TextFieldPart || appearance == TextAreaPart
                   || appearance == SearchFieldPart ) ? ETS_READONLY : TS_DISABLED;
    }
...
bool RenderThemeChromiumWin::paintProgressBar( RenderObject *o, const PaintInfo &i, const IntRect &r )
{
    ...
    IntRect valueRect = renderProgress->isDeterminate() ? determinateProgressValueRectFor( renderProgress, r ) : IntRect( 0, 0, 0,
                        0 );
