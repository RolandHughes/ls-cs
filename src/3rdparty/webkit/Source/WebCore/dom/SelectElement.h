...
public:
    ...
    virtual void setSelectedIndexByUser( int index, bool deselect = true, bool fireOnChangeNow = false,
                                         bool allowMultipleSelection = false ) = 0;
...
protected:
    ...
    static void setSelectedIndex( SelectElementData &, Element *, int optionIndex, bool deselect = true, bool fireOnChangeNow = false,
                                  bool userDrivenChange = true );
...
public:
    ...
    int lastOnChangeIndex() const
    {
        return m_lastOnChangeIndex;
    }
    void setLastOnChangeIndex( int value )
    {
        m_lastOnChangeIndex = value;
    }

    bool userDrivenChange() const
    {
        return m_userDrivenChange;
    }
    void setUserDrivenChange( bool value )
    {
        m_userDrivenChange = value;
    }

    Vector<bool> &lastOnChangeSelection()
    {
        return m_lastOnChangeSelection;
    }

    bool activeSelectionState() const
    {
        return m_activeSelectionState;
    }
    ...
    bool shouldRecalcListItems() const
    {
        return m_recalcListItems;
    }
    void setShouldRecalcListItems( bool value )
    {
        m_recalcListItems = value;
    }

    Vector<Element *> &rawListItems()
    {
        return m_listItems;
    }
    ...
    UChar repeatingChar() const
    {
        return m_repeatingChar;
    }
    void setRepeatingChar( const UChar &value )
    {
        m_repeatingChar = value;
    }

    DOMTimeStamp lastCharTime() const
    {
        return m_lastCharTime;
    }
    void setLastCharTime( const DOMTimeStamp &value )
    {
        m_lastCharTime = value;
    }
    ...
    void setTypedString( const String &value )
    {
        m_typedString = value;
    }
