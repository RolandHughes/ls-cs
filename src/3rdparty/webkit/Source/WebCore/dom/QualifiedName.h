...
public:
    ...
    {
    public:
        static PassRefPtr<QualifiedNameImpl> create( const AtomicString &prefix, const AtomicString &localName,
    ...
    {
        return m_impl->m_prefix != nullAtom;
    }
    ...
    {
        return m_impl->m_localName;
    }
    const AtomicString &namespaceURI() const
    {
        return m_impl->m_namespace;
    }
...
private:
    ...
    static QualifiedNameImpl *hashTableDeletedValue()
    {
        return RefPtr<QualifiedNameImpl>::hashTableDeletedValue();
    }
...
template<> struct HashTraits<WebCore::QualifiedName> : SimpleClassHashTraits<WebCore::QualifiedName>
{
    ...
    static WebCore::QualifiedName emptyValue()
    {
        return WebCore::QualifiedName( nullAtom, nullAtom, nullAtom );
    }
};
}
