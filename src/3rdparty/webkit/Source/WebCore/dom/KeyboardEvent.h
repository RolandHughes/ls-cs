...
public:
    ...
    {
        return m_altGraphKey;
    }

    const PlatformKeyboardEvent *keyEvent() const
    {
        return m_keyEvent.get();
    }
    ...
    Vector<KeypressCommand> &keypressCommands()
    {
        return m_keypressCommands;
    }
#endif
