...
{
    return TextPosition0( WTF::ZeroBasedNumber::fromZeroBasedInt( lineNumber() ),
                          WTF::ZeroBasedNumber::fromZeroBasedInt( columnNumber() ) );
}
...
{
    return TextPosition1( WTF::OneBasedNumber::fromOneBasedInt( lineNumber() ),
