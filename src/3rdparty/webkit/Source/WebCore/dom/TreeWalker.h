...
public:
    ...
    Node *parentNode()
    {
        return parentNode( scriptStateFromNode( mainThreadNormalWorld(), m_current.get() ) );
    }
    Node *firstChild()
    {
        return firstChild( scriptStateFromNode( mainThreadNormalWorld(), m_current.get() ) );
    }
    Node *lastChild()
    {
        return lastChild( scriptStateFromNode( mainThreadNormalWorld(), m_current.get() ) );
    }
    Node *previousSibling()
    {
        return previousSibling( scriptStateFromNode( mainThreadNormalWorld(), m_current.get() ) );
    }
    Node *nextSibling()
    {
        return nextSibling( scriptStateFromNode( mainThreadNormalWorld(), m_current.get() ) );
    }
    Node *previousNode()
    {
        return previousNode( scriptStateFromNode( mainThreadNormalWorld(), m_current.get() ) );
    }
    Node *nextNode()
    {
        return nextNode( scriptStateFromNode( mainThreadNormalWorld(), m_current.get() ) );
    }
