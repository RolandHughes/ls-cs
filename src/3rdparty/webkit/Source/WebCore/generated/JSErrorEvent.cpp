    ...
    : DOMConstructorObject( structure, globalObject )
{
    ...
    putDirect( exec->globalData(), exec->propertyNames().prototype, JSErrorEventPrototype::self( exec, globalObject ),
               DontDelete | ReadOnly );
}
...
bool JSErrorEventConstructor::getOwnPropertyDescriptor( ExecState *exec, const Identifier &propertyName,
        PropertyDescriptor &descriptor )
{
    return getStaticValueDescriptor<JSErrorEventConstructor, JSDOMWrapper>( exec, &JSErrorEventConstructorTable, this, propertyName,
            descriptor );
}
...
bool JSErrorEventPrototype::getOwnPropertyDescriptor( ExecState *exec, const Identifier &propertyName,
        PropertyDescriptor &descriptor )
{
...
{
    return new ( exec ) JSErrorEventPrototype( exec->globalData(), globalObject,
            JSErrorEventPrototype::createStructure( exec->globalData(), JSEventPrototype::self( exec, globalObject ) ) );
}
