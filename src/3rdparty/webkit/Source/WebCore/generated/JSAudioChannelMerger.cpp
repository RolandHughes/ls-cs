...
JSAudioChannelMergerConstructor::JSAudioChannelMergerConstructor( ExecState *exec, Structure *structure,
        JSDOMGlobalObject *globalObject )
    : DOMConstructorObject( structure, globalObject )
{
    ASSERT( inherits( &s_info ) );
    putDirect( exec->globalData(), exec->propertyNames().prototype, JSAudioChannelMergerPrototype::self( exec, globalObject ),
               DontDelete | ReadOnly );
}

bool JSAudioChannelMergerConstructor::getOwnPropertySlot( ExecState *exec, const Identifier &propertyName, PropertySlot &slot )
{
    return getStaticValueSlot<JSAudioChannelMergerConstructor, JSDOMWrapper>( exec, &JSAudioChannelMergerConstructorTable, this,
            propertyName, slot );
}

bool JSAudioChannelMergerConstructor::getOwnPropertyDescriptor( ExecState *exec, const Identifier &propertyName,
        PropertyDescriptor &descriptor )
{
    return getStaticValueDescriptor<JSAudioChannelMergerConstructor, JSDOMWrapper>( exec, &JSAudioChannelMergerConstructorTable, this,
...
JSAudioChannelMerger::JSAudioChannelMerger( Structure *structure, JSDOMGlobalObject *globalObject,
        PassRefPtr<AudioChannelMerger> impl )
...
{
    return new ( exec ) JSAudioChannelMergerPrototype( exec->globalData(), globalObject,
            JSAudioChannelMergerPrototype::createStructure( exec->globalData(), JSAudioNodePrototype::self( exec, globalObject ) ) );
}
...
bool JSAudioChannelMerger::getOwnPropertyDescriptor( ExecState *exec, const Identifier &propertyName,
        PropertyDescriptor &descriptor )
{
