    ...
    : DOMConstructorObject( structure, globalObject )
{
    ...
    putDirect( exec->globalData(), exec->propertyNames().prototype, JSTimeRangesPrototype::self( exec, globalObject ),
               DontDelete | ReadOnly );
}
...
bool JSTimeRangesConstructor::getOwnPropertyDescriptor( ExecState *exec, const Identifier &propertyName,
        PropertyDescriptor &descriptor )
{
    return getStaticValueDescriptor<JSTimeRangesConstructor, JSDOMWrapper>( exec, &JSTimeRangesConstructorTable, this, propertyName,
            descriptor );
}
...
bool JSTimeRangesPrototype::getOwnPropertyDescriptor( ExecState *exec, const Identifier &propertyName,
        PropertyDescriptor &descriptor )
{
...
{
    return new ( exec ) JSTimeRangesPrototype( exec->globalData(), globalObject,
            JSTimeRangesPrototype::createStructure( globalObject->globalData(), globalObject->objectPrototype() ) );
}
