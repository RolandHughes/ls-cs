    ...
    : DOMConstructorObject( structure, globalObject )
{
    ...
    putDirect( exec->globalData(), exec->propertyNames().prototype, JSIDBObjectStorePrototype::self( exec, globalObject ),
               DontDelete | ReadOnly );
}

bool JSIDBObjectStoreConstructor::getOwnPropertySlot( ExecState *exec, const Identifier &propertyName, PropertySlot &slot )
{
    return getStaticValueSlot<JSIDBObjectStoreConstructor, JSDOMWrapper>( exec, &JSIDBObjectStoreConstructorTable, this, propertyName,
            slot );
}

bool JSIDBObjectStoreConstructor::getOwnPropertyDescriptor( ExecState *exec, const Identifier &propertyName,
        PropertyDescriptor &descriptor )
{
    return getStaticValueDescriptor<JSIDBObjectStoreConstructor, JSDOMWrapper>( exec, &JSIDBObjectStoreConstructorTable, this,
...
bool JSIDBObjectStorePrototype::getOwnPropertyDescriptor( ExecState *exec, const Identifier &propertyName,
        PropertyDescriptor &descriptor )
{
...
{
    return new ( exec ) JSIDBObjectStorePrototype( exec->globalData(), globalObject,
            JSIDBObjectStorePrototype::createStructure( globalObject->globalData(), globalObject->objectPrototype() ) );
}
