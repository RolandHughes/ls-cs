...
JSWebGLRenderingContextConstructor::JSWebGLRenderingContextConstructor( ExecState *exec, Structure *structure,
        JSDOMGlobalObject *globalObject )
    : DOMConstructorObject( structure, globalObject )
{
    ASSERT( inherits( &s_info ) );
    putDirect( exec->globalData(), exec->propertyNames().prototype, JSWebGLRenderingContextPrototype::self( exec, globalObject ),
               DontDelete | ReadOnly );
}
...
{
    return getStaticValueSlot<JSWebGLRenderingContextConstructor, JSDOMWrapper>( exec, &JSWebGLRenderingContextConstructorTable, this,
            propertyName, slot );
}

bool JSWebGLRenderingContextConstructor::getOwnPropertyDescriptor( ExecState *exec, const Identifier &propertyName,
        PropertyDescriptor &descriptor )
{
    return getStaticValueDescriptor<JSWebGLRenderingContextConstructor, JSDOMWrapper>( exec, &JSWebGLRenderingContextConstructorTable,
...
{
    return getStaticPropertySlot<JSWebGLRenderingContextPrototype, JSObject>( exec, &JSWebGLRenderingContextPrototypeTable, this,
            propertyName, slot );
}

bool JSWebGLRenderingContextPrototype::getOwnPropertyDescriptor( ExecState *exec, const Identifier &propertyName,
        PropertyDescriptor &descriptor )
{
    return getStaticPropertyDescriptor<JSWebGLRenderingContextPrototype, JSObject>( exec, &JSWebGLRenderingContextPrototypeTable,
            this, propertyName, descriptor );
}
...
JSWebGLRenderingContext::JSWebGLRenderingContext( Structure *structure, JSDOMGlobalObject *globalObject,
        PassRefPtr<WebGLRenderingContext> impl )
...
{
    return new ( exec ) JSWebGLRenderingContextPrototype( exec->globalData(), globalObject,
            JSWebGLRenderingContextPrototype::createStructure( exec->globalData(), JSCanvasRenderingContextPrototype::self( exec,
                    globalObject ) ) );
}
...
bool JSWebGLRenderingContext::getOwnPropertyDescriptor( ExecState *exec, const Identifier &propertyName,
        PropertyDescriptor &descriptor )
{
    return getStaticValueDescriptor<JSWebGLRenderingContext, Base>( exec, &JSWebGLRenderingContextTable, this, propertyName,
            descriptor );
}
...
EncodedJSValue JSC_HOST_CALL jsWebGLRenderingContextPrototypeFunctionAttachShader( ExecState *exec )
{
    ...
    if ( exec->argumentCount() > 1 && !exec->argument( 1 ).isUndefinedOrNull()
            && !exec->argument( 1 ).inherits( &JSWebGLShader::s_info ) )
    {
        return throwVMTypeError( exec );
    }
...
EncodedJSValue JSC_HOST_CALL jsWebGLRenderingContextPrototypeFunctionBindBuffer( ExecState *exec )
{
    ...
    if ( exec->argumentCount() > 1 && !exec->argument( 1 ).isUndefinedOrNull()
            && !exec->argument( 1 ).inherits( &JSWebGLBuffer::s_info ) )
    {
        return throwVMTypeError( exec );
    }
...
EncodedJSValue JSC_HOST_CALL jsWebGLRenderingContextPrototypeFunctionBindFramebuffer( ExecState *exec )
{
    ...
    if ( exec->argumentCount() > 1 && !exec->argument( 1 ).isUndefinedOrNull()
            && !exec->argument( 1 ).inherits( &JSWebGLFramebuffer::s_info ) )
    {
        return throwVMTypeError( exec );
    }
...
EncodedJSValue JSC_HOST_CALL jsWebGLRenderingContextPrototypeFunctionBindRenderbuffer( ExecState *exec )
{
    ...
    if ( exec->argumentCount() > 1 && !exec->argument( 1 ).isUndefinedOrNull()
            && !exec->argument( 1 ).inherits( &JSWebGLRenderbuffer::s_info ) )
    {
        return throwVMTypeError( exec );
    }
...
EncodedJSValue JSC_HOST_CALL jsWebGLRenderingContextPrototypeFunctionBindTexture( ExecState *exec )
{
    ...
    if ( exec->argumentCount() > 1 && !exec->argument( 1 ).isUndefinedOrNull()
            && !exec->argument( 1 ).inherits( &JSWebGLTexture::s_info ) )
    {
        return throwVMTypeError( exec );
    }
...
static EncodedJSValue JSC_HOST_CALL jsWebGLRenderingContextPrototypeFunctionBufferData1( ExecState *exec )
{
    ...
    if ( exec->argumentCount() > 1 && !exec->argument( 1 ).isUndefinedOrNull()
            && !exec->argument( 1 ).inherits( &JSArrayBuffer::s_info ) )
    {
        return throwVMTypeError( exec );
    }
...
static EncodedJSValue JSC_HOST_CALL jsWebGLRenderingContextPrototypeFunctionBufferData2( ExecState *exec )
{
    ...
    if ( exec->argumentCount() > 1 && !exec->argument( 1 ).isUndefinedOrNull()
            && !exec->argument( 1 ).inherits( &JSArrayBufferView::s_info ) )
    {
        return throwVMTypeError( exec );
    }
...
{
    if ( ( exec->argumentCount() == 3 && ( exec->argument( 1 ).isNull() || ( exec->argument( 1 ).isObject()
                                           && asObject( exec->argument( 1 ) )->inherits( &JSArrayBuffer::s_info ) ) ) ) )
    {
        return jsWebGLRenderingContextPrototypeFunctionBufferData1( exec );
    }

    if ( ( exec->argumentCount() == 3 && ( exec->argument( 1 ).isNull() || ( exec->argument( 1 ).isObject()
                                           && asObject( exec->argument( 1 ) )->inherits( &JSArrayBufferView::s_info ) ) ) ) )
    {
...
static EncodedJSValue JSC_HOST_CALL jsWebGLRenderingContextPrototypeFunctionBufferSubData1( ExecState *exec )
{
    ...
    if ( exec->argumentCount() > 2 && !exec->argument( 2 ).isUndefinedOrNull()
            && !exec->argument( 2 ).inherits( &JSArrayBuffer::s_info ) )
    {
        return throwVMTypeError( exec );
    }
...
static EncodedJSValue JSC_HOST_CALL jsWebGLRenderingContextPrototypeFunctionBufferSubData2( ExecState *exec )
{
    ...
    if ( exec->argumentCount() > 2 && !exec->argument( 2 ).isUndefinedOrNull()
            && !exec->argument( 2 ).inherits( &JSArrayBufferView::s_info ) )
    {
        return throwVMTypeError( exec );
    }
...
{
    if ( ( exec->argumentCount() == 3 && ( exec->argument( 2 ).isNull() || ( exec->argument( 2 ).isObject()
                                           && asObject( exec->argument( 2 ) )->inherits( &JSArrayBuffer::s_info ) ) ) ) )
    {
        return jsWebGLRenderingContextPrototypeFunctionBufferSubData1( exec );
    }

    if ( ( exec->argumentCount() == 3 && ( exec->argument( 2 ).isNull() || ( exec->argument( 2 ).isObject()
                                           && asObject( exec->argument( 2 ) )->inherits( &JSArrayBufferView::s_info ) ) ) ) )
    {
...
EncodedJSValue JSC_HOST_CALL jsWebGLRenderingContextPrototypeFunctionDeleteBuffer( ExecState *exec )
{
    ...
    if ( exec->argumentCount() > 0 && !exec->argument( 0 ).isUndefinedOrNull()
            && !exec->argument( 0 ).inherits( &JSWebGLBuffer::s_info ) )
    {
        return throwVMTypeError( exec );
    }
...
EncodedJSValue JSC_HOST_CALL jsWebGLRenderingContextPrototypeFunctionDeleteFramebuffer( ExecState *exec )
{
    ...
    if ( exec->argumentCount() > 0 && !exec->argument( 0 ).isUndefinedOrNull()
            && !exec->argument( 0 ).inherits( &JSWebGLFramebuffer::s_info ) )
    {
        return throwVMTypeError( exec );
    }
...
EncodedJSValue JSC_HOST_CALL jsWebGLRenderingContextPrototypeFunctionDeleteRenderbuffer( ExecState *exec )
{
    ...
    if ( exec->argumentCount() > 0 && !exec->argument( 0 ).isUndefinedOrNull()
            && !exec->argument( 0 ).inherits( &JSWebGLRenderbuffer::s_info ) )
    {
        return throwVMTypeError( exec );
    }
...
EncodedJSValue JSC_HOST_CALL jsWebGLRenderingContextPrototypeFunctionDeleteTexture( ExecState *exec )
{
    ...
    if ( exec->argumentCount() > 0 && !exec->argument( 0 ).isUndefinedOrNull()
            && !exec->argument( 0 ).inherits( &JSWebGLTexture::s_info ) )
    {
        return throwVMTypeError( exec );
    }
...
EncodedJSValue JSC_HOST_CALL jsWebGLRenderingContextPrototypeFunctionFramebufferRenderbuffer( ExecState *exec )
{
    ...
    if ( exec->argumentCount() > 3 && !exec->argument( 3 ).isUndefinedOrNull()
            && !exec->argument( 3 ).inherits( &JSWebGLRenderbuffer::s_info ) )
    {
        return throwVMTypeError( exec );
    }
...
EncodedJSValue JSC_HOST_CALL jsWebGLRenderingContextPrototypeFunctionFramebufferTexture2D( ExecState *exec )
{
    ...
    if ( exec->argumentCount() > 3 && !exec->argument( 3 ).isUndefinedOrNull()
            && !exec->argument( 3 ).inherits( &JSWebGLTexture::s_info ) )
    {
        return throwVMTypeError( exec );
    }
...
EncodedJSValue JSC_HOST_CALL jsWebGLRenderingContextPrototypeFunctionReadPixels( ExecState *exec )
{
    ...
    if ( exec->argumentCount() > 6 && !exec->argument( 6 ).isUndefinedOrNull()
            && !exec->argument( 6 ).inherits( &JSArrayBufferView::s_info ) )
    {
        return throwVMTypeError( exec );
    }
...
static EncodedJSValue JSC_HOST_CALL jsWebGLRenderingContextPrototypeFunctionTexImage2D1( ExecState *exec )
{
    ...
    if ( exec->argumentCount() > 8 && !exec->argument( 8 ).isUndefinedOrNull()
            && !exec->argument( 8 ).inherits( &JSArrayBufferView::s_info ) )
    {
        return throwVMTypeError( exec );
    }
...
static EncodedJSValue JSC_HOST_CALL jsWebGLRenderingContextPrototypeFunctionTexImage2D2( ExecState *exec )
{
    ...
    if ( exec->argumentCount() > 5 && !exec->argument( 5 ).isUndefinedOrNull()
            && !exec->argument( 5 ).inherits( &JSImageData::s_info ) )
    {
        return throwVMTypeError( exec );
    }
...
static EncodedJSValue JSC_HOST_CALL jsWebGLRenderingContextPrototypeFunctionTexImage2D3( ExecState *exec )
{
    ...
    if ( exec->argumentCount() > 5 && !exec->argument( 5 ).isUndefinedOrNull()
            && !exec->argument( 5 ).inherits( &JSHTMLImageElement::s_info ) )
    {
        return throwVMTypeError( exec );
    }
...
static EncodedJSValue JSC_HOST_CALL jsWebGLRenderingContextPrototypeFunctionTexImage2D4( ExecState *exec )
{
    ...
    if ( exec->argumentCount() > 5 && !exec->argument( 5 ).isUndefinedOrNull()
            && !exec->argument( 5 ).inherits( &JSHTMLCanvasElement::s_info ) )
    {
        return throwVMTypeError( exec );
    }
...
static EncodedJSValue JSC_HOST_CALL jsWebGLRenderingContextPrototypeFunctionTexImage2D5( ExecState *exec )
{
    ...
    if ( exec->argumentCount() > 5 && !exec->argument( 5 ).isUndefinedOrNull()
            && !exec->argument( 5 ).inherits( &JSHTMLVideoElement::s_info ) )
    {
        return throwVMTypeError( exec );
    }
...
{
    if ( ( exec->argumentCount() == 9 && ( exec->argument( 8 ).isNull() || ( exec->argument( 8 ).isObject()
                                           && asObject( exec->argument( 8 ) )->inherits( &JSArrayBufferView::s_info ) ) ) ) )
    {
        return jsWebGLRenderingContextPrototypeFunctionTexImage2D1( exec );
    }

    if ( ( exec->argumentCount() == 6 && ( exec->argument( 5 ).isNull() || ( exec->argument( 5 ).isObject()
                                           && asObject( exec->argument( 5 ) )->inherits( &JSImageData::s_info ) ) ) ) )
    {
        return jsWebGLRenderingContextPrototypeFunctionTexImage2D2( exec );
    }

    if ( ( exec->argumentCount() == 6 && ( exec->argument( 5 ).isNull() || ( exec->argument( 5 ).isObject()
                                           && asObject( exec->argument( 5 ) )->inherits( &JSHTMLImageElement::s_info ) ) ) ) )
    {
        return jsWebGLRenderingContextPrototypeFunctionTexImage2D3( exec );
    }

    if ( ( exec->argumentCount() == 6 && ( exec->argument( 5 ).isNull() || ( exec->argument( 5 ).isObject()
                                           && asObject( exec->argument( 5 ) )->inherits( &JSHTMLCanvasElement::s_info ) ) ) ) )
    {
        return jsWebGLRenderingContextPrototypeFunctionTexImage2D4( exec );
    }

    if ( ( exec->argumentCount() == 6 && ( exec->argument( 5 ).isNull() || ( exec->argument( 5 ).isObject()
                                           && asObject( exec->argument( 5 ) )->inherits( &JSHTMLVideoElement::s_info ) ) ) ) )
    {
...
static EncodedJSValue JSC_HOST_CALL jsWebGLRenderingContextPrototypeFunctionTexSubImage2D2( ExecState *exec )
{
    ...
    if ( exec->argumentCount() > 6 && !exec->argument( 6 ).isUndefinedOrNull()
            && !exec->argument( 6 ).inherits( &JSImageData::s_info ) )
    {
        return throwVMTypeError( exec );
    }
...
static EncodedJSValue JSC_HOST_CALL jsWebGLRenderingContextPrototypeFunctionTexSubImage2D3( ExecState *exec )
{
    ...
    if ( exec->argumentCount() > 6 && !exec->argument( 6 ).isUndefinedOrNull()
            && !exec->argument( 6 ).inherits( &JSHTMLImageElement::s_info ) )
    {
        return throwVMTypeError( exec );
    }
...
static EncodedJSValue JSC_HOST_CALL jsWebGLRenderingContextPrototypeFunctionTexSubImage2D4( ExecState *exec )
{
    ...
    if ( exec->argumentCount() > 6 && !exec->argument( 6 ).isUndefinedOrNull()
            && !exec->argument( 6 ).inherits( &JSHTMLCanvasElement::s_info ) )
    {
        return throwVMTypeError( exec );
    }
...
static EncodedJSValue JSC_HOST_CALL jsWebGLRenderingContextPrototypeFunctionTexSubImage2D5( ExecState *exec )
{
    ...
    if ( exec->argumentCount() > 6 && !exec->argument( 6 ).isUndefinedOrNull()
            && !exec->argument( 6 ).inherits( &JSHTMLVideoElement::s_info ) )
    {
        return throwVMTypeError( exec );
    }
...
EncodedJSValue JSC_HOST_CALL jsWebGLRenderingContextPrototypeFunctionTexSubImage2D( ExecState *exec )
{
    ...
    if ( ( exec->argumentCount() == 7 && ( exec->argument( 6 ).isNull() || ( exec->argument( 6 ).isObject()
                                           && asObject( exec->argument( 6 ) )->inherits( &JSImageData::s_info ) ) ) ) )
    {
        return jsWebGLRenderingContextPrototypeFunctionTexSubImage2D2( exec );
    }

    if ( ( exec->argumentCount() == 7 && ( exec->argument( 6 ).isNull() || ( exec->argument( 6 ).isObject()
                                           && asObject( exec->argument( 6 ) )->inherits( &JSHTMLImageElement::s_info ) ) ) ) )
    {
        return jsWebGLRenderingContextPrototypeFunctionTexSubImage2D3( exec );
    }

    if ( ( exec->argumentCount() == 7 && ( exec->argument( 6 ).isNull() || ( exec->argument( 6 ).isObject()
                                           && asObject( exec->argument( 6 ) )->inherits( &JSHTMLCanvasElement::s_info ) ) ) ) )
    {
        return jsWebGLRenderingContextPrototypeFunctionTexSubImage2D4( exec );
    }

    if ( ( exec->argumentCount() == 7 && ( exec->argument( 6 ).isNull() || ( exec->argument( 6 ).isObject()
                                           && asObject( exec->argument( 6 ) )->inherits( &JSHTMLVideoElement::s_info ) ) ) ) )
    {
