...
JSSVGFEFuncAElementConstructor::JSSVGFEFuncAElementConstructor( ExecState *exec, Structure *structure,
        JSDOMGlobalObject *globalObject )
    : DOMConstructorObject( structure, globalObject )
{
    ASSERT( inherits( &s_info ) );
    putDirect( exec->globalData(), exec->propertyNames().prototype, JSSVGFEFuncAElementPrototype::self( exec, globalObject ),
               DontDelete | ReadOnly );
}

bool JSSVGFEFuncAElementConstructor::getOwnPropertySlot( ExecState *exec, const Identifier &propertyName, PropertySlot &slot )
{
    return getStaticValueSlot<JSSVGFEFuncAElementConstructor, JSDOMWrapper>( exec, &JSSVGFEFuncAElementConstructorTable, this,
            propertyName, slot );
}

bool JSSVGFEFuncAElementConstructor::getOwnPropertyDescriptor( ExecState *exec, const Identifier &propertyName,
        PropertyDescriptor &descriptor )
{
    return getStaticValueDescriptor<JSSVGFEFuncAElementConstructor, JSDOMWrapper>( exec, &JSSVGFEFuncAElementConstructorTable, this,
...
JSSVGFEFuncAElement::JSSVGFEFuncAElement( Structure *structure, JSDOMGlobalObject *globalObject,
        PassRefPtr<SVGFEFuncAElement> impl )
...
{
    return new ( exec ) JSSVGFEFuncAElementPrototype( exec->globalData(), globalObject,
            JSSVGFEFuncAElementPrototype::createStructure( exec->globalData(), JSSVGComponentTransferFunctionElementPrototype::self( exec,
                    globalObject ) ) );
}
...
bool JSSVGFEFuncAElement::getOwnPropertyDescriptor( ExecState *exec, const Identifier &propertyName,
        PropertyDescriptor &descriptor )
{
