...
JSSpeechInputEventConstructor::JSSpeechInputEventConstructor( ExecState *exec, Structure *structure,
        JSDOMGlobalObject *globalObject )
    : DOMConstructorObject( structure, globalObject )
{
    ASSERT( inherits( &s_info ) );
    putDirect( exec->globalData(), exec->propertyNames().prototype, JSSpeechInputEventPrototype::self( exec, globalObject ),
               DontDelete | ReadOnly );
}

bool JSSpeechInputEventConstructor::getOwnPropertySlot( ExecState *exec, const Identifier &propertyName, PropertySlot &slot )
{
    return getStaticValueSlot<JSSpeechInputEventConstructor, JSDOMWrapper>( exec, &JSSpeechInputEventConstructorTable, this,
            propertyName, slot );
}

bool JSSpeechInputEventConstructor::getOwnPropertyDescriptor( ExecState *exec, const Identifier &propertyName,
        PropertyDescriptor &descriptor )
{
    return getStaticValueDescriptor<JSSpeechInputEventConstructor, JSDOMWrapper>( exec, &JSSpeechInputEventConstructorTable, this,
...
{
    return new ( exec ) JSSpeechInputEventPrototype( exec->globalData(), globalObject,
            JSSpeechInputEventPrototype::createStructure( exec->globalData(), JSEventPrototype::self( exec, globalObject ) ) );
}
...
bool JSSpeechInputEvent::getOwnPropertyDescriptor( ExecState *exec, const Identifier &propertyName,
        PropertyDescriptor &descriptor )
{
