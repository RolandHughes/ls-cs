...
void InspectorFrontend::Network::requestWillBeSent( int identifier, const String &frameId, const String &loaderId,
        const String &documentURL, PassRefPtr<InspectorObject> request, double timestamp, PassRefPtr<InspectorArray> stackTrace,
        PassRefPtr<InspectorObject> redirectResponse )
{
...
void InspectorFrontend::Network::responseReceived( int identifier, double timestamp, const String &type,
        PassRefPtr<InspectorObject> response )
{
...
void InspectorFrontend::Network::resourceLoadedFromMemoryCache( const String &frameId, const String &loaderId,
        const String &documentURL, double timestamp, PassRefPtr<InspectorObject> resource )
{
...
void InspectorFrontend::Network::webSocketWillSendHandshakeRequest( int identifier, double timestamp,
        PassRefPtr<InspectorObject> request )
{
...
void InspectorFrontend::Network::webSocketHandshakeResponseReceived( int identifier, double timestamp,
        PassRefPtr<InspectorObject> response )
{
...
void InspectorFrontend::Database::sqlTransactionSucceeded( int transactionId, PassRefPtr<InspectorArray> columnNames,
        PassRefPtr<InspectorArray> values )
{
...
void InspectorFrontend::Debugger::scriptParsed( const String &sourceID, const String &url, int startLine, int startColumn,
...
void InspectorFrontend::Debugger::scriptFailedToParse( const String &url, const String &data, int firstLine, int errorLine,
