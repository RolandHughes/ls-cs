    ...
    : DOMConstructorObject( structure, globalObject )
{
    ...
    putDirect( exec->globalData(), exec->propertyNames().prototype, JSDOMPluginPrototype::self( exec, globalObject ),
               DontDelete | ReadOnly );
}
...
bool JSDOMPluginConstructor::getOwnPropertyDescriptor( ExecState *exec, const Identifier &propertyName,
        PropertyDescriptor &descriptor )
{
    return getStaticValueDescriptor<JSDOMPluginConstructor, JSDOMWrapper>( exec, &JSDOMPluginConstructorTable, this, propertyName,
            descriptor );
}
...
bool JSDOMPluginPrototype::getOwnPropertyDescriptor( ExecState *exec, const Identifier &propertyName,
        PropertyDescriptor &descriptor )
{
...
{
    return new ( exec ) JSDOMPluginPrototype( exec->globalData(), globalObject,
            JSDOMPluginPrototype::createStructure( globalObject->globalData(), globalObject->objectPrototype() ) );
}
