...
JSSVGAnimatedLengthConstructor::JSSVGAnimatedLengthConstructor( ExecState *exec, Structure *structure,
        JSDOMGlobalObject *globalObject )
    : DOMConstructorObject( structure, globalObject )
{
    ASSERT( inherits( &s_info ) );
    putDirect( exec->globalData(), exec->propertyNames().prototype, JSSVGAnimatedLengthPrototype::self( exec, globalObject ),
               DontDelete | ReadOnly );
}

bool JSSVGAnimatedLengthConstructor::getOwnPropertySlot( ExecState *exec, const Identifier &propertyName, PropertySlot &slot )
{
    return getStaticValueSlot<JSSVGAnimatedLengthConstructor, JSDOMWrapper>( exec, &JSSVGAnimatedLengthConstructorTable, this,
            propertyName, slot );
}

bool JSSVGAnimatedLengthConstructor::getOwnPropertyDescriptor( ExecState *exec, const Identifier &propertyName,
        PropertyDescriptor &descriptor )
{
    return getStaticValueDescriptor<JSSVGAnimatedLengthConstructor, JSDOMWrapper>( exec, &JSSVGAnimatedLengthConstructorTable, this,
...
JSSVGAnimatedLength::JSSVGAnimatedLength( Structure *structure, JSDOMGlobalObject *globalObject,
        PassRefPtr<SVGAnimatedLength> impl )
...
{
    return new ( exec ) JSSVGAnimatedLengthPrototype( exec->globalData(), globalObject,
            JSSVGAnimatedLengthPrototype::createStructure( globalObject->globalData(), globalObject->objectPrototype() ) );
}
...
bool JSSVGAnimatedLength::getOwnPropertyDescriptor( ExecState *exec, const Identifier &propertyName,
        PropertyDescriptor &descriptor )
{
...
JSValue jsSVGAnimatedLengthBaseVal( ExecState *exec, JSValue slotBase, const Identifier & )
{
    ...
    JSValue result = toJS( exec, castedThis->globalObject(),
                           WTF::getPtr( static_cast<SVGPropertyTearOff<SVGLength>*>( imp->baseVal() ) ) );
    return result;
}
...
JSValue jsSVGAnimatedLengthAnimVal( ExecState *exec, JSValue slotBase, const Identifier & )
{
    ...
    SVGAnimatedLength *imp = static_cast<SVGAnimatedLength *>( castedThis->impl() );
    JSValue result = toJS( exec, castedThis->globalObject(),
                           WTF::getPtr( static_cast<SVGPropertyTearOff<SVGLength>*>( imp->animVal() ) ) );
    return result;
}
