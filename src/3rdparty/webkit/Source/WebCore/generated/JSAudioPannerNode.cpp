...
JSAudioPannerNodeConstructor::JSAudioPannerNodeConstructor( ExecState *exec, Structure *structure,
        JSDOMGlobalObject *globalObject )
    : DOMConstructorObject( structure, globalObject )
{
    ASSERT( inherits( &s_info ) );
    putDirect( exec->globalData(), exec->propertyNames().prototype, JSAudioPannerNodePrototype::self( exec, globalObject ),
               DontDelete | ReadOnly );
}

bool JSAudioPannerNodeConstructor::getOwnPropertySlot( ExecState *exec, const Identifier &propertyName, PropertySlot &slot )
{
    return getStaticValueSlot<JSAudioPannerNodeConstructor, JSDOMWrapper>( exec, &JSAudioPannerNodeConstructorTable, this,
            propertyName, slot );
}

bool JSAudioPannerNodeConstructor::getOwnPropertyDescriptor( ExecState *exec, const Identifier &propertyName,
        PropertyDescriptor &descriptor )
{
    return getStaticValueDescriptor<JSAudioPannerNodeConstructor, JSDOMWrapper>( exec, &JSAudioPannerNodeConstructorTable, this,
...
{
    return getStaticPropertySlot<JSAudioPannerNodePrototype, JSObject>( exec, &JSAudioPannerNodePrototypeTable, this, propertyName,
            slot );
}

bool JSAudioPannerNodePrototype::getOwnPropertyDescriptor( ExecState *exec, const Identifier &propertyName,
        PropertyDescriptor &descriptor )
{
    return getStaticPropertyDescriptor<JSAudioPannerNodePrototype, JSObject>( exec, &JSAudioPannerNodePrototypeTable, this,
            propertyName, descriptor );
}
...
{
    return new ( exec ) JSAudioPannerNodePrototype( exec->globalData(), globalObject,
            JSAudioPannerNodePrototype::createStructure( exec->globalData(), JSAudioNodePrototype::self( exec, globalObject ) ) );
}
...
bool JSAudioPannerNode::getOwnPropertyDescriptor( ExecState *exec, const Identifier &propertyName,
        PropertyDescriptor &descriptor )
{
