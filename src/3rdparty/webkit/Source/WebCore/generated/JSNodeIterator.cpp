    ...
    : DOMConstructorObject( structure, globalObject )
{
    ...
    putDirect( exec->globalData(), exec->propertyNames().prototype, JSNodeIteratorPrototype::self( exec, globalObject ),
               DontDelete | ReadOnly );
}

bool JSNodeIteratorConstructor::getOwnPropertySlot( ExecState *exec, const Identifier &propertyName, PropertySlot &slot )
{
    return getStaticValueSlot<JSNodeIteratorConstructor, JSDOMWrapper>( exec, &JSNodeIteratorConstructorTable, this, propertyName,
            slot );
}

bool JSNodeIteratorConstructor::getOwnPropertyDescriptor( ExecState *exec, const Identifier &propertyName,
        PropertyDescriptor &descriptor )
{
    return getStaticValueDescriptor<JSNodeIteratorConstructor, JSDOMWrapper>( exec, &JSNodeIteratorConstructorTable, this,
...
bool JSNodeIteratorPrototype::getOwnPropertyDescriptor( ExecState *exec, const Identifier &propertyName,
        PropertyDescriptor &descriptor )
{
...
{
    return new ( exec ) JSNodeIteratorPrototype( exec->globalData(), globalObject,
            JSNodeIteratorPrototype::createStructure( globalObject->globalData(), globalObject->objectPrototype() ) );
}
