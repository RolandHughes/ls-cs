...
JSDirectoryEntrySyncConstructor::JSDirectoryEntrySyncConstructor( ExecState *exec, Structure *structure,
        JSDOMGlobalObject *globalObject )
    : DOMConstructorObject( structure, globalObject )
{
    ASSERT( inherits( &s_info ) );
    putDirect( exec->globalData(), exec->propertyNames().prototype, JSDirectoryEntrySyncPrototype::self( exec, globalObject ),
               DontDelete | ReadOnly );
}

bool JSDirectoryEntrySyncConstructor::getOwnPropertySlot( ExecState *exec, const Identifier &propertyName, PropertySlot &slot )
{
    return getStaticValueSlot<JSDirectoryEntrySyncConstructor, JSDOMWrapper>( exec, &JSDirectoryEntrySyncConstructorTable, this,
            propertyName, slot );
}

bool JSDirectoryEntrySyncConstructor::getOwnPropertyDescriptor( ExecState *exec, const Identifier &propertyName,
        PropertyDescriptor &descriptor )
{
    return getStaticValueDescriptor<JSDirectoryEntrySyncConstructor, JSDOMWrapper>( exec, &JSDirectoryEntrySyncConstructorTable, this,
...
bool JSDirectoryEntrySyncPrototype::getOwnPropertyDescriptor( ExecState *exec, const Identifier &propertyName,
        PropertyDescriptor &descriptor )
{
    return getStaticFunctionDescriptor<JSObject>( exec, getJSDirectoryEntrySyncPrototypeTable( exec ), this, propertyName,
            descriptor );
}
...
JSDirectoryEntrySync::JSDirectoryEntrySync( Structure *structure, JSDOMGlobalObject *globalObject,
        PassRefPtr<DirectoryEntrySync> impl )
...
{
    return new ( exec ) JSDirectoryEntrySyncPrototype( exec->globalData(), globalObject,
            JSDirectoryEntrySyncPrototype::createStructure( exec->globalData(), JSEntrySyncPrototype::self( exec, globalObject ) ) );
}
...
bool JSDirectoryEntrySync::getOwnPropertyDescriptor( ExecState *exec, const Identifier &propertyName,
        PropertyDescriptor &descriptor )
{
    return getStaticValueDescriptor<JSDirectoryEntrySync, Base>( exec, getJSDirectoryEntrySyncTable( exec ), this, propertyName,
            descriptor );
}
