    ...
    : DOMConstructorObject( structure, globalObject )
{
    ...
    putDirect( exec->globalData(), exec->propertyNames().prototype, JSEventExceptionPrototype::self( exec, globalObject ),
               DontDelete | ReadOnly );
}

bool JSEventExceptionConstructor::getOwnPropertySlot( ExecState *exec, const Identifier &propertyName, PropertySlot &slot )
{
    return getStaticValueSlot<JSEventExceptionConstructor, JSDOMWrapper>( exec, &JSEventExceptionConstructorTable, this, propertyName,
            slot );
}

bool JSEventExceptionConstructor::getOwnPropertyDescriptor( ExecState *exec, const Identifier &propertyName,
        PropertyDescriptor &descriptor )
{
    return getStaticValueDescriptor<JSEventExceptionConstructor, JSDOMWrapper>( exec, &JSEventExceptionConstructorTable, this,
...
{
    return getStaticPropertySlot<JSEventExceptionPrototype, JSObject>( exec, getJSEventExceptionPrototypeTable( exec ), this,
            propertyName, slot );
}

bool JSEventExceptionPrototype::getOwnPropertyDescriptor( ExecState *exec, const Identifier &propertyName,
        PropertyDescriptor &descriptor )
{
    return getStaticPropertyDescriptor<JSEventExceptionPrototype, JSObject>( exec, getJSEventExceptionPrototypeTable( exec ), this,
            propertyName, descriptor );
}
...
{
    return new ( exec ) JSEventExceptionPrototype( exec->globalData(), globalObject,
            JSEventExceptionPrototype::createStructure( globalObject->globalData(), globalObject->objectPrototype() ) );
}
