...
JSSVGElementInstanceConstructor::JSSVGElementInstanceConstructor( ExecState *exec, Structure *structure,
        JSDOMGlobalObject *globalObject )
    : DOMConstructorObject( structure, globalObject )
{
    ASSERT( inherits( &s_info ) );
    putDirect( exec->globalData(), exec->propertyNames().prototype, JSSVGElementInstancePrototype::self( exec, globalObject ),
               DontDelete | ReadOnly );
}

bool JSSVGElementInstanceConstructor::getOwnPropertySlot( ExecState *exec, const Identifier &propertyName, PropertySlot &slot )
{
    return getStaticValueSlot<JSSVGElementInstanceConstructor, JSDOMWrapper>( exec, &JSSVGElementInstanceConstructorTable, this,
            propertyName, slot );
}

bool JSSVGElementInstanceConstructor::getOwnPropertyDescriptor( ExecState *exec, const Identifier &propertyName,
        PropertyDescriptor &descriptor )
{
    return getStaticValueDescriptor<JSSVGElementInstanceConstructor, JSDOMWrapper>( exec, &JSSVGElementInstanceConstructorTable, this,
...
bool JSSVGElementInstancePrototype::getOwnPropertyDescriptor( ExecState *exec, const Identifier &propertyName,
        PropertyDescriptor &descriptor )
{
...
JSSVGElementInstance::JSSVGElementInstance( Structure *structure, JSDOMGlobalObject *globalObject,
        PassRefPtr<SVGElementInstance> impl )
...
{
    return new ( exec ) JSSVGElementInstancePrototype( exec->globalData(), globalObject,
            JSSVGElementInstancePrototype::createStructure( globalObject->globalData(), globalObject->objectPrototype() ) );
}
...
bool JSSVGElementInstance::getOwnPropertyDescriptor( ExecState *exec, const Identifier &propertyName,
        PropertyDescriptor &descriptor )
{
...
EncodedJSValue JSC_HOST_CALL jsSVGElementInstancePrototypeFunctionAddEventListener( ExecState *exec )
{
    ...
    imp->addEventListener( ustringToAtomicString( exec->argument( 0 ).toString( exec ) ),
                           JSEventListener::create( asObject( listener ), asObject( correspondingElementWrapper ), false, currentWorld( exec ) ),
...
EncodedJSValue JSC_HOST_CALL jsSVGElementInstancePrototypeFunctionRemoveEventListener( ExecState *exec )
{
    ...
    imp->removeEventListener( ustringToAtomicString( exec->argument( 0 ).toString( exec ) ),
                              JSEventListener::create( asObject( listener ), asObject( correspondingElementWrapper ), false, currentWorld( exec ) ).get(),
                              exec->argument( 2 ).toBoolean( exec ) );
    return JSValue::encode( jsUndefined() );
}
