    ...
    : DOMConstructorObject( structure, globalObject )
{
    ...
    putDirect( exec->globalData(), exec->propertyNames().prototype, JSTreeWalkerPrototype::self( exec, globalObject ),
               DontDelete | ReadOnly );
}
...
bool JSTreeWalkerConstructor::getOwnPropertyDescriptor( ExecState *exec, const Identifier &propertyName,
        PropertyDescriptor &descriptor )
{
    return getStaticValueDescriptor<JSTreeWalkerConstructor, JSDOMWrapper>( exec, &JSTreeWalkerConstructorTable, this, propertyName,
            descriptor );
}
...
bool JSTreeWalkerPrototype::getOwnPropertyDescriptor( ExecState *exec, const Identifier &propertyName,
        PropertyDescriptor &descriptor )
{
...
{
    return new ( exec ) JSTreeWalkerPrototype( exec->globalData(), globalObject,
            JSTreeWalkerPrototype::createStructure( globalObject->globalData(), globalObject->objectPrototype() ) );
}
