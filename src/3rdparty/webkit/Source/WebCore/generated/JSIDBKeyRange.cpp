    ...
    : DOMConstructorObject( structure, globalObject )
{
    ...
    putDirect( exec->globalData(), exec->propertyNames().prototype, JSIDBKeyRangePrototype::self( exec, globalObject ),
               DontDelete | ReadOnly );
}

bool JSIDBKeyRangeConstructor::getOwnPropertySlot( ExecState *exec, const Identifier &propertyName, PropertySlot &slot )
{
    return getStaticValueSlot<JSIDBKeyRangeConstructor, JSDOMWrapper>( exec, &JSIDBKeyRangeConstructorTable, this, propertyName,
            slot );
}

bool JSIDBKeyRangeConstructor::getOwnPropertyDescriptor( ExecState *exec, const Identifier &propertyName,
        PropertyDescriptor &descriptor )
{
    return getStaticValueDescriptor<JSIDBKeyRangeConstructor, JSDOMWrapper>( exec, &JSIDBKeyRangeConstructorTable, this, propertyName,
            descriptor );
}
...
bool JSIDBKeyRangePrototype::getOwnPropertyDescriptor( ExecState *exec, const Identifier &propertyName,
        PropertyDescriptor &descriptor )
{
...
{
    return new ( exec ) JSIDBKeyRangePrototype( exec->globalData(), globalObject,
            JSIDBKeyRangePrototype::createStructure( globalObject->globalData(), globalObject->objectPrototype() ) );
}
