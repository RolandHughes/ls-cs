...
JSSVGLinearGradientElementConstructor::JSSVGLinearGradientElementConstructor( ExecState *exec, Structure *structure,
        JSDOMGlobalObject *globalObject )
    : DOMConstructorObject( structure, globalObject )
{
    ASSERT( inherits( &s_info ) );
    putDirect( exec->globalData(), exec->propertyNames().prototype, JSSVGLinearGradientElementPrototype::self( exec, globalObject ),
               DontDelete | ReadOnly );
}

bool JSSVGLinearGradientElementConstructor::getOwnPropertySlot( ExecState *exec, const Identifier &propertyName,
        PropertySlot &slot )
{
    return getStaticValueSlot<JSSVGLinearGradientElementConstructor, JSDOMWrapper>( exec, &JSSVGLinearGradientElementConstructorTable,
            this, propertyName, slot );
}

bool JSSVGLinearGradientElementConstructor::getOwnPropertyDescriptor( ExecState *exec, const Identifier &propertyName,
        PropertyDescriptor &descriptor )
{
    return getStaticValueDescriptor<JSSVGLinearGradientElementConstructor, JSDOMWrapper>( exec,
            &JSSVGLinearGradientElementConstructorTable, this, propertyName, descriptor );
}
...
JSSVGLinearGradientElement::JSSVGLinearGradientElement( Structure *structure, JSDOMGlobalObject *globalObject,
        PassRefPtr<SVGLinearGradientElement> impl )
...
{
    return new ( exec ) JSSVGLinearGradientElementPrototype( exec->globalData(), globalObject,
            JSSVGLinearGradientElementPrototype::createStructure( exec->globalData(), JSSVGGradientElementPrototype::self( exec,
                    globalObject ) ) );
}
...
bool JSSVGLinearGradientElement::getOwnPropertyDescriptor( ExecState *exec, const Identifier &propertyName,
        PropertyDescriptor &descriptor )
{
    return getStaticValueDescriptor<JSSVGLinearGradientElement, Base>( exec, &JSSVGLinearGradientElementTable, this, propertyName,
            descriptor );
}
