    ...
    : DOMConstructorObject( structure, globalObject )
{
    ...
    putDirect( exec->globalData(), exec->propertyNames().prototype, JSMediaListPrototype::self( exec, globalObject ),
               DontDelete | ReadOnly );
}
...
bool JSMediaListConstructor::getOwnPropertyDescriptor( ExecState *exec, const Identifier &propertyName,
        PropertyDescriptor &descriptor )
{
    return getStaticValueDescriptor<JSMediaListConstructor, JSDOMWrapper>( exec, &JSMediaListConstructorTable, this, propertyName,
            descriptor );
}
...
bool JSMediaListPrototype::getOwnPropertyDescriptor( ExecState *exec, const Identifier &propertyName,
        PropertyDescriptor &descriptor )
{
...
{
    return new ( exec ) JSMediaListPrototype( exec->globalData(), globalObject,
            JSMediaListPrototype::createStructure( globalObject->globalData(), globalObject->objectPrototype() ) );
}
