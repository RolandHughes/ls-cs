...
bool JSWorkerContextPrototype::getOwnPropertyDescriptor( ExecState *exec, const Identifier &propertyName,
...
EncodedJSValue JSC_HOST_CALL jsWorkerContextPrototypeFunctionOpenDatabaseSync( ExecState *exec )
{
    ...
    JSC::JSValue result = toJS( exec, castedThis->globalObject(), WTF::getPtr( imp->openDatabaseSync( name, version, displayName,
                                estimatedSize, creationCallback, ec ) ) );
    setDOMException( exec, ec );
    return JSValue::encode( result );
}
