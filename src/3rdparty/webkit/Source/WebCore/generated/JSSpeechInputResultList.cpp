...
JSSpeechInputResultListConstructor::JSSpeechInputResultListConstructor( ExecState *exec, Structure *structure,
        JSDOMGlobalObject *globalObject )
    : DOMConstructorObject( structure, globalObject )
{
    ASSERT( inherits( &s_info ) );
    putDirect( exec->globalData(), exec->propertyNames().prototype, JSSpeechInputResultListPrototype::self( exec, globalObject ),
               DontDelete | ReadOnly );
}
...
{
    return getStaticValueSlot<JSSpeechInputResultListConstructor, JSDOMWrapper>( exec, &JSSpeechInputResultListConstructorTable, this,
            propertyName, slot );
}

bool JSSpeechInputResultListConstructor::getOwnPropertyDescriptor( ExecState *exec, const Identifier &propertyName,
        PropertyDescriptor &descriptor )
{
    return getStaticValueDescriptor<JSSpeechInputResultListConstructor, JSDOMWrapper>( exec, &JSSpeechInputResultListConstructorTable,
...
bool JSSpeechInputResultListPrototype::getOwnPropertyDescriptor( ExecState *exec, const Identifier &propertyName,
        PropertyDescriptor &descriptor )
{
...
JSSpeechInputResultList::JSSpeechInputResultList( Structure *structure, JSDOMGlobalObject *globalObject,
        PassRefPtr<SpeechInputResultList> impl )
...
{
    return new ( exec ) JSSpeechInputResultListPrototype( exec->globalData(), globalObject,
            JSSpeechInputResultListPrototype::createStructure( globalObject->globalData(), globalObject->objectPrototype() ) );
}
...
bool JSSpeechInputResultList::getOwnPropertyDescriptor( ExecState *exec, const Identifier &propertyName,
        PropertyDescriptor &descriptor )
{
    const HashEntry *entry = JSSpeechInputResultListTable.entry( exec, propertyName );
    ...
    return getStaticValueDescriptor<JSSpeechInputResultList, Base>( exec, &JSSpeechInputResultListTable, this, propertyName,
            descriptor );
}
...
{
    return value.inherits( &JSSpeechInputResultList::s_info ) ? static_cast<JSSpeechInputResultList *>( asObject(
                value ) )->impl() : 0;
}
