    ...
    : DOMConstructorObject( structure, globalObject )
{
    ...
    putDirect( exec->globalData(), exec->propertyNames().prototype, JSNotationPrototype::self( exec, globalObject ),
               DontDelete | ReadOnly );
}
...
bool JSNotationConstructor::getOwnPropertyDescriptor( ExecState *exec, const Identifier &propertyName,
        PropertyDescriptor &descriptor )
{
    return getStaticValueDescriptor<JSNotationConstructor, JSDOMWrapper>( exec, &JSNotationConstructorTable, this, propertyName,
            descriptor );
}
...
{
    return new ( exec ) JSNotationPrototype( exec->globalData(), globalObject,
            JSNotationPrototype::createStructure( exec->globalData(), JSNodePrototype::self( exec, globalObject ) ) );
}
