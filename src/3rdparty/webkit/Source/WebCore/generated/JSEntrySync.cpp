    ...
    : DOMConstructorObject( structure, globalObject )
{
    ...
    putDirect( exec->globalData(), exec->propertyNames().prototype, JSEntrySyncPrototype::self( exec, globalObject ),
               DontDelete | ReadOnly );
}
...
bool JSEntrySyncConstructor::getOwnPropertyDescriptor( ExecState *exec, const Identifier &propertyName,
        PropertyDescriptor &descriptor )
{
    return getStaticValueDescriptor<JSEntrySyncConstructor, JSDOMWrapper>( exec, &JSEntrySyncConstructorTable, this, propertyName,
            descriptor );
}
...
bool JSEntrySyncPrototype::getOwnPropertyDescriptor( ExecState *exec, const Identifier &propertyName,
        PropertyDescriptor &descriptor )
{
...
{
    return new ( exec ) JSEntrySyncPrototype( exec->globalData(), globalObject,
            JSEntrySyncPrototype::createStructure( globalObject->globalData(), globalObject->objectPrototype() ) );
}
