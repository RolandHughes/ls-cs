    ...
    : DOMConstructorObject( structure, globalObject )
{
    ...
    putDirect( exec->globalData(), exec->propertyNames().prototype, JSConvolverNodePrototype::self( exec, globalObject ),
               DontDelete | ReadOnly );
}

bool JSConvolverNodeConstructor::getOwnPropertySlot( ExecState *exec, const Identifier &propertyName, PropertySlot &slot )
{
    return getStaticValueSlot<JSConvolverNodeConstructor, JSDOMWrapper>( exec, &JSConvolverNodeConstructorTable, this, propertyName,
            slot );
}

bool JSConvolverNodeConstructor::getOwnPropertyDescriptor( ExecState *exec, const Identifier &propertyName,
        PropertyDescriptor &descriptor )
{
    return getStaticValueDescriptor<JSConvolverNodeConstructor, JSDOMWrapper>( exec, &JSConvolverNodeConstructorTable, this,
...
{
    return new ( exec ) JSConvolverNodePrototype( exec->globalData(), globalObject,
            JSConvolverNodePrototype::createStructure( exec->globalData(), JSAudioNodePrototype::self( exec, globalObject ) ) );
}
