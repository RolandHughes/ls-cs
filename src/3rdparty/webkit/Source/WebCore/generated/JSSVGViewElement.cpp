    ...
    : DOMConstructorObject( structure, globalObject )
{
    ...
    putDirect( exec->globalData(), exec->propertyNames().prototype, JSSVGViewElementPrototype::self( exec, globalObject ),
               DontDelete | ReadOnly );
}

bool JSSVGViewElementConstructor::getOwnPropertySlot( ExecState *exec, const Identifier &propertyName, PropertySlot &slot )
{
    return getStaticValueSlot<JSSVGViewElementConstructor, JSDOMWrapper>( exec, &JSSVGViewElementConstructorTable, this, propertyName,
            slot );
}

bool JSSVGViewElementConstructor::getOwnPropertyDescriptor( ExecState *exec, const Identifier &propertyName,
        PropertyDescriptor &descriptor )
{
    return getStaticValueDescriptor<JSSVGViewElementConstructor, JSDOMWrapper>( exec, &JSSVGViewElementConstructorTable, this,
...
bool JSSVGViewElementPrototype::getOwnPropertyDescriptor( ExecState *exec, const Identifier &propertyName,
        PropertyDescriptor &descriptor )
{
    return getStaticValueDescriptor<JSSVGViewElementPrototype, JSObject>( exec, &JSSVGViewElementPrototypeTable, this, propertyName,
            descriptor );
}
...
{
    return new ( exec ) JSSVGViewElementPrototype( exec->globalData(), globalObject,
            JSSVGViewElementPrototype::createStructure( exec->globalData(), JSSVGElementPrototype::self( exec, globalObject ) ) );
}
...
JSValue jsSVGViewElementViewTarget( ExecState *exec, JSValue slotBase, const Identifier & )
{
    ...
    JSValue result = toJS( exec, castedThis->globalObject(),
                           WTF::getPtr( SVGStaticListPropertyTearOff<SVGStringList>::create(
                                            GetOwnerElementForType<SVGViewElement, IsDerivedFromSVGElement<SVGViewElement>::value>::ownerElement( imp ),
                                            imp->viewTarget() ) ) );
    return result;
}
