    ...
    : DOMConstructorObject( structure, globalObject )
{
    ...
    putDirect( exec->globalData(), exec->propertyNames().prototype, JSSVGPathSegListPrototype::self( exec, globalObject ),
               DontDelete | ReadOnly );
}

bool JSSVGPathSegListConstructor::getOwnPropertySlot( ExecState *exec, const Identifier &propertyName, PropertySlot &slot )
{
    return getStaticValueSlot<JSSVGPathSegListConstructor, JSDOMWrapper>( exec, &JSSVGPathSegListConstructorTable, this, propertyName,
            slot );
}

bool JSSVGPathSegListConstructor::getOwnPropertyDescriptor( ExecState *exec, const Identifier &propertyName,
        PropertyDescriptor &descriptor )
{
    return getStaticValueDescriptor<JSSVGPathSegListConstructor, JSDOMWrapper>( exec, &JSSVGPathSegListConstructorTable, this,
...
bool JSSVGPathSegListPrototype::getOwnPropertyDescriptor( ExecState *exec, const Identifier &propertyName,
        PropertyDescriptor &descriptor )
{
...
JSSVGPathSegList::JSSVGPathSegList( Structure *structure, JSDOMGlobalObject *globalObject,
                                    PassRefPtr<SVGPathSegListPropertyTearOff > impl )
...
{
    return new ( exec ) JSSVGPathSegListPrototype( exec->globalData(), globalObject,
            JSSVGPathSegListPrototype::createStructure( globalObject->globalData(), globalObject->objectPrototype() ) );
}
...
EncodedJSValue JSC_HOST_CALL jsSVGPathSegListPrototypeFunctionInitialize( ExecState *exec )
{
    ...
    if ( exec->argumentCount() > 0 && !exec->argument( 0 ).isUndefinedOrNull()
            && !exec->argument( 0 ).inherits( &JSSVGPathSeg::s_info ) )
    {
        return throwVMTypeError( exec );
    }
