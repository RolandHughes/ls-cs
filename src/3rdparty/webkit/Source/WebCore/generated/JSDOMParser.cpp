    ...
    : DOMConstructorObject( structure, globalObject )
{
    ...
    putDirect( exec->globalData(), exec->propertyNames().prototype, JSDOMParserPrototype::self( exec, globalObject ),
               DontDelete | ReadOnly );
}
...
bool JSDOMParserConstructor::getOwnPropertyDescriptor( ExecState *exec, const Identifier &propertyName,
        PropertyDescriptor &descriptor )
{
    return getStaticValueDescriptor<JSDOMParserConstructor, JSDOMWrapper>( exec, &JSDOMParserConstructorTable, this, propertyName,
            descriptor );
}

EncodedJSValue JSC_HOST_CALL JSDOMParserConstructor::constructJSDOMParser( ExecState *exec )
{
    return JSValue::encode( asObject( toJS( exec, static_cast<JSDOMParserConstructor *>( exec->callee() )->globalObject(),
                                            DOMParser::create() ) ) );
}
...
bool JSDOMParserPrototype::getOwnPropertyDescriptor( ExecState *exec, const Identifier &propertyName,
        PropertyDescriptor &descriptor )
{
...
{
    return new ( exec ) JSDOMParserPrototype( exec->globalData(), globalObject,
            JSDOMParserPrototype::createStructure( globalObject->globalData(), globalObject->objectPrototype() ) );
}
