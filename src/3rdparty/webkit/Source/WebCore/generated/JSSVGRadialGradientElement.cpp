...
JSSVGRadialGradientElementConstructor::JSSVGRadialGradientElementConstructor( ExecState *exec, Structure *structure,
        JSDOMGlobalObject *globalObject )
    : DOMConstructorObject( structure, globalObject )
{
    ASSERT( inherits( &s_info ) );
    putDirect( exec->globalData(), exec->propertyNames().prototype, JSSVGRadialGradientElementPrototype::self( exec, globalObject ),
               DontDelete | ReadOnly );
}

bool JSSVGRadialGradientElementConstructor::getOwnPropertySlot( ExecState *exec, const Identifier &propertyName,
        PropertySlot &slot )
{
    return getStaticValueSlot<JSSVGRadialGradientElementConstructor, JSDOMWrapper>( exec, &JSSVGRadialGradientElementConstructorTable,
            this, propertyName, slot );
}

bool JSSVGRadialGradientElementConstructor::getOwnPropertyDescriptor( ExecState *exec, const Identifier &propertyName,
        PropertyDescriptor &descriptor )
{
    return getStaticValueDescriptor<JSSVGRadialGradientElementConstructor, JSDOMWrapper>( exec,
            &JSSVGRadialGradientElementConstructorTable, this, propertyName, descriptor );
}
...
JSSVGRadialGradientElement::JSSVGRadialGradientElement( Structure *structure, JSDOMGlobalObject *globalObject,
        PassRefPtr<SVGRadialGradientElement> impl )
...
{
    return new ( exec ) JSSVGRadialGradientElementPrototype( exec->globalData(), globalObject,
            JSSVGRadialGradientElementPrototype::createStructure( exec->globalData(), JSSVGGradientElementPrototype::self( exec,
                    globalObject ) ) );
}
...
bool JSSVGRadialGradientElement::getOwnPropertyDescriptor( ExecState *exec, const Identifier &propertyName,
        PropertyDescriptor &descriptor )
{
    return getStaticValueDescriptor<JSSVGRadialGradientElement, Base>( exec, &JSSVGRadialGradientElementTable, this, propertyName,
            descriptor );
}
