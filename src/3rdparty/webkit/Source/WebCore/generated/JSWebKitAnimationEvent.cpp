...
JSWebKitAnimationEventConstructor::JSWebKitAnimationEventConstructor( ExecState *exec, Structure *structure,
        JSDOMGlobalObject *globalObject )
    : DOMConstructorObject( structure, globalObject )
{
    ASSERT( inherits( &s_info ) );
    putDirect( exec->globalData(), exec->propertyNames().prototype, JSWebKitAnimationEventPrototype::self( exec, globalObject ),
               DontDelete | ReadOnly );
}

bool JSWebKitAnimationEventConstructor::getOwnPropertySlot( ExecState *exec, const Identifier &propertyName, PropertySlot &slot )
{
    return getStaticValueSlot<JSWebKitAnimationEventConstructor, JSDOMWrapper>( exec, &JSWebKitAnimationEventConstructorTable, this,
            propertyName, slot );
}

bool JSWebKitAnimationEventConstructor::getOwnPropertyDescriptor( ExecState *exec, const Identifier &propertyName,
        PropertyDescriptor &descriptor )
{
    return getStaticValueDescriptor<JSWebKitAnimationEventConstructor, JSDOMWrapper>( exec, &JSWebKitAnimationEventConstructorTable,
...
bool JSWebKitAnimationEventPrototype::getOwnPropertyDescriptor( ExecState *exec, const Identifier &propertyName,
        PropertyDescriptor &descriptor )
{
...
JSWebKitAnimationEvent::JSWebKitAnimationEvent( Structure *structure, JSDOMGlobalObject *globalObject,
        PassRefPtr<WebKitAnimationEvent> impl )
...
{
    return new ( exec ) JSWebKitAnimationEventPrototype( exec->globalData(), globalObject,
            JSWebKitAnimationEventPrototype::createStructure( exec->globalData(), JSEventPrototype::self( exec, globalObject ) ) );
}
...
bool JSWebKitAnimationEvent::getOwnPropertyDescriptor( ExecState *exec, const Identifier &propertyName,
        PropertyDescriptor &descriptor )
{
    return getStaticValueDescriptor<JSWebKitAnimationEvent, Base>( exec, &JSWebKitAnimationEventTable, this, propertyName,
            descriptor );
}
