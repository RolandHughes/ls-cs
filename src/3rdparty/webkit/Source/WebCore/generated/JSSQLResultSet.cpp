...
{
    return new ( exec ) JSSQLResultSetPrototype( exec->globalData(), globalObject,
            JSSQLResultSetPrototype::createStructure( globalObject->globalData(), globalObject->objectPrototype() ) );
}
