    ...
    : DOMConstructorObject( structure, globalObject )
{
    ...
    putDirect( exec->globalData(), exec->propertyNames().prototype, JSStoragePrototype::self( exec, globalObject ),
               DontDelete | ReadOnly );
}
...
bool JSStorageConstructor::getOwnPropertyDescriptor( ExecState *exec, const Identifier &propertyName,
        PropertyDescriptor &descriptor )
{
    return getStaticValueDescriptor<JSStorageConstructor, JSDOMWrapper>( exec, &JSStorageConstructorTable, this, propertyName,
            descriptor );
}
...
bool JSStoragePrototype::getOwnPropertyDescriptor( ExecState *exec, const Identifier &propertyName,
        PropertyDescriptor &descriptor )
{
...
{
    return new ( exec ) JSStoragePrototype( exec->globalData(), globalObject,
                                            JSStoragePrototype::createStructure( globalObject->globalData(), globalObject->objectPrototype() ) );
}
