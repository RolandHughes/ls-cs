    ...
    : DOMConstructorObject( structure, globalObject )
{
    ...
    putDirect( exec->globalData(), exec->propertyNames().prototype, JSInt32ArrayPrototype::self( exec, globalObject ),
               DontDelete | ReadOnly );
}
...
bool JSInt32ArrayConstructor::getOwnPropertyDescriptor( ExecState *exec, const Identifier &propertyName,
        PropertyDescriptor &descriptor )
{
    return getStaticValueDescriptor<JSInt32ArrayConstructor, JSDOMWrapper>( exec, &JSInt32ArrayConstructorTable, this, propertyName,
            descriptor );
}
...
{
    return getStaticPropertySlot<JSInt32ArrayPrototype, JSObject>( exec, getJSInt32ArrayPrototypeTable( exec ), this, propertyName,
            slot );
}

bool JSInt32ArrayPrototype::getOwnPropertyDescriptor( ExecState *exec, const Identifier &propertyName,
        PropertyDescriptor &descriptor )
{
    return getStaticPropertyDescriptor<JSInt32ArrayPrototype, JSObject>( exec, getJSInt32ArrayPrototypeTable( exec ), this,
...
{
    return new ( exec ) JSInt32ArrayPrototype( exec->globalData(), globalObject,
            JSInt32ArrayPrototype::createStructure( exec->globalData(), JSArrayBufferViewPrototype::self( exec, globalObject ) ) );
}
