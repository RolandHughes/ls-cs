    ...
    : DOMConstructorObject( structure, globalObject )
{
    ...
    putDirect( exec->globalData(), exec->propertyNames().prototype, JSCSSRulePrototype::self( exec, globalObject ),
               DontDelete | ReadOnly );
}
...
bool JSCSSRuleConstructor::getOwnPropertyDescriptor( ExecState *exec, const Identifier &propertyName,
        PropertyDescriptor &descriptor )
{
    return getStaticValueDescriptor<JSCSSRuleConstructor, JSDOMWrapper>( exec, &JSCSSRuleConstructorTable, this, propertyName,
            descriptor );
}
...
bool JSCSSRulePrototype::getOwnPropertyDescriptor( ExecState *exec, const Identifier &propertyName,
        PropertyDescriptor &descriptor )
{
...
{
    return new ( exec ) JSCSSRulePrototype( exec->globalData(), globalObject,
                                            JSCSSRulePrototype::createStructure( globalObject->globalData(), globalObject->objectPrototype() ) );
}
