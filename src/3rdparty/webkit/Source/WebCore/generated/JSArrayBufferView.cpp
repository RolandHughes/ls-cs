...
{
    return new ( exec ) JSArrayBufferViewPrototype( exec->globalData(), globalObject,
            JSArrayBufferViewPrototype::createStructure( globalObject->globalData(), globalObject->objectPrototype() ) );
}
...
bool JSArrayBufferView::getOwnPropertyDescriptor( ExecState *exec, const Identifier &propertyName,
        PropertyDescriptor &descriptor )
{
    return getStaticValueDescriptor<JSArrayBufferView, Base>( exec, getJSArrayBufferViewTable( exec ), this, propertyName,
            descriptor );
}
