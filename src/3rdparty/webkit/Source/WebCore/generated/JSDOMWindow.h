...
protected:
    static const unsigned StructureFlags = JSC::OverridesGetPropertyNames | JSC::ImplementsHasInstance | JSC::NeedsThisConversion |
                                           JSC::OverridesGetOwnPropertySlot | JSC::OverridesVisitChildren | Base::StructureFlags;
};
...
public:
    ...
    JSDOMWindowPrototype( JSC::JSGlobalData &globalData, JSC::JSGlobalObject *globalObject,
