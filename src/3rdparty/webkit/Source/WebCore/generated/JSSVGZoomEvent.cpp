    ...
    : DOMConstructorObject( structure, globalObject )
{
    ...
    putDirect( exec->globalData(), exec->propertyNames().prototype, JSSVGZoomEventPrototype::self( exec, globalObject ),
               DontDelete | ReadOnly );
}

bool JSSVGZoomEventConstructor::getOwnPropertySlot( ExecState *exec, const Identifier &propertyName, PropertySlot &slot )
{
    return getStaticValueSlot<JSSVGZoomEventConstructor, JSDOMWrapper>( exec, &JSSVGZoomEventConstructorTable, this, propertyName,
            slot );
}

bool JSSVGZoomEventConstructor::getOwnPropertyDescriptor( ExecState *exec, const Identifier &propertyName,
        PropertyDescriptor &descriptor )
{
    return getStaticValueDescriptor<JSSVGZoomEventConstructor, JSDOMWrapper>( exec, &JSSVGZoomEventConstructorTable, this,
...
{
    return new ( exec ) JSSVGZoomEventPrototype( exec->globalData(), globalObject,
            JSSVGZoomEventPrototype::createStructure( exec->globalData(), JSUIEventPrototype::self( exec, globalObject ) ) );
}
...
JSValue jsSVGZoomEventZoomRectScreen( ExecState *exec, JSValue slotBase, const Identifier & )
{
    ...
    JSValue result = toJS( exec, castedThis->globalObject(),
                           WTF::getPtr( SVGPropertyTearOff<FloatRect>::create( imp->zoomRectScreen() ) ) );
    return result;
}
...
JSValue jsSVGZoomEventPreviousTranslate( ExecState *exec, JSValue slotBase, const Identifier & )
{
    ...
    SVGZoomEvent *imp = static_cast<SVGZoomEvent *>( castedThis->impl() );
    JSValue result = toJS( exec, castedThis->globalObject(),
                           WTF::getPtr( SVGPropertyTearOff<FloatPoint>::create( imp->previousTranslate() ) ) );
    return result;
}
...
JSValue jsSVGZoomEventNewTranslate( ExecState *exec, JSValue slotBase, const Identifier & )
{
    ...
    SVGZoomEvent *imp = static_cast<SVGZoomEvent *>( castedThis->impl() );
    JSValue result = toJS( exec, castedThis->globalObject(),
                           WTF::getPtr( SVGPropertyTearOff<FloatPoint>::create( imp->newTranslate() ) ) );
    return result;
}
