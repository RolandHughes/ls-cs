...
JSHighPass2FilterNodeConstructor::JSHighPass2FilterNodeConstructor( ExecState *exec, Structure *structure,
        JSDOMGlobalObject *globalObject )
    : DOMConstructorObject( structure, globalObject )
{
    ASSERT( inherits( &s_info ) );
    putDirect( exec->globalData(), exec->propertyNames().prototype, JSHighPass2FilterNodePrototype::self( exec, globalObject ),
               DontDelete | ReadOnly );
}

bool JSHighPass2FilterNodeConstructor::getOwnPropertySlot( ExecState *exec, const Identifier &propertyName, PropertySlot &slot )
{
    return getStaticValueSlot<JSHighPass2FilterNodeConstructor, JSDOMWrapper>( exec, &JSHighPass2FilterNodeConstructorTable, this,
            propertyName, slot );
}

bool JSHighPass2FilterNodeConstructor::getOwnPropertyDescriptor( ExecState *exec, const Identifier &propertyName,
        PropertyDescriptor &descriptor )
{
    return getStaticValueDescriptor<JSHighPass2FilterNodeConstructor, JSDOMWrapper>( exec, &JSHighPass2FilterNodeConstructorTable,
...
JSHighPass2FilterNode::JSHighPass2FilterNode( Structure *structure, JSDOMGlobalObject *globalObject,
        PassRefPtr<HighPass2FilterNode> impl )
...
{
    return new ( exec ) JSHighPass2FilterNodePrototype( exec->globalData(), globalObject,
            JSHighPass2FilterNodePrototype::createStructure( exec->globalData(), JSAudioNodePrototype::self( exec, globalObject ) ) );
}
...
bool JSHighPass2FilterNode::getOwnPropertyDescriptor( ExecState *exec, const Identifier &propertyName,
        PropertyDescriptor &descriptor )
{
