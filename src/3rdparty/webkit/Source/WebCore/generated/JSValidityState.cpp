...
{
    return new ( exec ) JSValidityStatePrototype( exec->globalData(), globalObject,
            JSValidityStatePrototype::createStructure( globalObject->globalData(), globalObject->objectPrototype() ) );
}
