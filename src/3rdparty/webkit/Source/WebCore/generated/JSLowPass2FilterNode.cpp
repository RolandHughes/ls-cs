...
JSLowPass2FilterNodeConstructor::JSLowPass2FilterNodeConstructor( ExecState *exec, Structure *structure,
        JSDOMGlobalObject *globalObject )
    : DOMConstructorObject( structure, globalObject )
{
    ASSERT( inherits( &s_info ) );
    putDirect( exec->globalData(), exec->propertyNames().prototype, JSLowPass2FilterNodePrototype::self( exec, globalObject ),
               DontDelete | ReadOnly );
}

bool JSLowPass2FilterNodeConstructor::getOwnPropertySlot( ExecState *exec, const Identifier &propertyName, PropertySlot &slot )
{
    return getStaticValueSlot<JSLowPass2FilterNodeConstructor, JSDOMWrapper>( exec, &JSLowPass2FilterNodeConstructorTable, this,
            propertyName, slot );
}

bool JSLowPass2FilterNodeConstructor::getOwnPropertyDescriptor( ExecState *exec, const Identifier &propertyName,
        PropertyDescriptor &descriptor )
{
    return getStaticValueDescriptor<JSLowPass2FilterNodeConstructor, JSDOMWrapper>( exec, &JSLowPass2FilterNodeConstructorTable, this,
...
JSLowPass2FilterNode::JSLowPass2FilterNode( Structure *structure, JSDOMGlobalObject *globalObject,
        PassRefPtr<LowPass2FilterNode> impl )
...
{
    return new ( exec ) JSLowPass2FilterNodePrototype( exec->globalData(), globalObject,
            JSLowPass2FilterNodePrototype::createStructure( exec->globalData(), JSAudioNodePrototype::self( exec, globalObject ) ) );
}
...
bool JSLowPass2FilterNode::getOwnPropertyDescriptor( ExecState *exec, const Identifier &propertyName,
        PropertyDescriptor &descriptor )
{
