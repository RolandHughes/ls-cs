...
JSWebKitCSSMatrixConstructor::JSWebKitCSSMatrixConstructor( ExecState *exec, Structure *structure,
        JSDOMGlobalObject *globalObject )
    : DOMConstructorObject( structure, globalObject )
{
    ASSERT( inherits( &s_info ) );
    putDirect( exec->globalData(), exec->propertyNames().prototype, JSWebKitCSSMatrixPrototype::self( exec, globalObject ),
               DontDelete | ReadOnly );
...
{
    return getStaticValueSlot<JSWebKitCSSMatrixConstructor, JSDOMWrapper>( exec, &JSWebKitCSSMatrixConstructorTable, this,
            propertyName, slot );
}

bool JSWebKitCSSMatrixConstructor::getOwnPropertyDescriptor( ExecState *exec, const Identifier &propertyName,
        PropertyDescriptor &descriptor )
{
    return getStaticValueDescriptor<JSWebKitCSSMatrixConstructor, JSDOMWrapper>( exec, &JSWebKitCSSMatrixConstructorTable, this,
...
bool JSWebKitCSSMatrixPrototype::getOwnPropertyDescriptor( ExecState *exec, const Identifier &propertyName,
        PropertyDescriptor &descriptor )
{
...
{
    return new ( exec ) JSWebKitCSSMatrixPrototype( exec->globalData(), globalObject,
            JSWebKitCSSMatrixPrototype::createStructure( globalObject->globalData(), globalObject->objectPrototype() ) );
}
...
bool JSWebKitCSSMatrix::getOwnPropertyDescriptor( ExecState *exec, const Identifier &propertyName,
        PropertyDescriptor &descriptor )
{
