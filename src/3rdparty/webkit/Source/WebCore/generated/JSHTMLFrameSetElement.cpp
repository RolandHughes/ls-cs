...
JSHTMLFrameSetElementConstructor::JSHTMLFrameSetElementConstructor( ExecState *exec, Structure *structure,
        JSDOMGlobalObject *globalObject )
    : DOMConstructorObject( structure, globalObject )
{
    ASSERT( inherits( &s_info ) );
    putDirect( exec->globalData(), exec->propertyNames().prototype, JSHTMLFrameSetElementPrototype::self( exec, globalObject ),
               DontDelete | ReadOnly );
}

bool JSHTMLFrameSetElementConstructor::getOwnPropertySlot( ExecState *exec, const Identifier &propertyName, PropertySlot &slot )
{
    return getStaticValueSlot<JSHTMLFrameSetElementConstructor, JSDOMWrapper>( exec, &JSHTMLFrameSetElementConstructorTable, this,
            propertyName, slot );
}

bool JSHTMLFrameSetElementConstructor::getOwnPropertyDescriptor( ExecState *exec, const Identifier &propertyName,
        PropertyDescriptor &descriptor )
{
    return getStaticValueDescriptor<JSHTMLFrameSetElementConstructor, JSDOMWrapper>( exec, &JSHTMLFrameSetElementConstructorTable,
...
JSHTMLFrameSetElement::JSHTMLFrameSetElement( Structure *structure, JSDOMGlobalObject *globalObject,
        PassRefPtr<HTMLFrameSetElement> impl )
...
{
    return new ( exec ) JSHTMLFrameSetElementPrototype( exec->globalData(), globalObject,
            JSHTMLFrameSetElementPrototype::createStructure( exec->globalData(), JSHTMLElementPrototype::self( exec, globalObject ) ) );
}
...
bool JSHTMLFrameSetElement::getOwnPropertyDescriptor( ExecState *exec, const Identifier &propertyName,
        PropertyDescriptor &descriptor )
{
    if ( canGetItemsForName( exec, static_cast<HTMLFrameSetElement *>( impl() ), propertyName ) )
    {
