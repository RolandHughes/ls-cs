...
public:
    ...
    JSSVGComponentTransferFunctionElementPrototype( JSC::JSGlobalData &globalData, JSC::JSGlobalObject *globalObject,
...
JSC::JSValue jsSVGComponentTransferFunctionElementSVG_FECOMPONENTTRANSFER_TYPE_UNKNOWN( JSC::ExecState *, JSC::JSValue,
        const JSC::Identifier & );
JSC::JSValue jsSVGComponentTransferFunctionElementSVG_FECOMPONENTTRANSFER_TYPE_IDENTITY( JSC::ExecState *, JSC::JSValue,
        const JSC::Identifier & );
JSC::JSValue jsSVGComponentTransferFunctionElementSVG_FECOMPONENTTRANSFER_TYPE_TABLE( JSC::ExecState *, JSC::JSValue,
        const JSC::Identifier & );
JSC::JSValue jsSVGComponentTransferFunctionElementSVG_FECOMPONENTTRANSFER_TYPE_DISCRETE( JSC::ExecState *, JSC::JSValue,
        const JSC::Identifier & );
JSC::JSValue jsSVGComponentTransferFunctionElementSVG_FECOMPONENTTRANSFER_TYPE_LINEAR( JSC::ExecState *, JSC::JSValue,
        const JSC::Identifier & );
JSC::JSValue jsSVGComponentTransferFunctionElementSVG_FECOMPONENTTRANSFER_TYPE_GAMMA( JSC::ExecState *, JSC::JSValue,
        const JSC::Identifier & );
