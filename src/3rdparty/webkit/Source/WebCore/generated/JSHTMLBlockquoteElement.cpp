...
JSHTMLBlockquoteElementConstructor::JSHTMLBlockquoteElementConstructor( ExecState *exec, Structure *structure,
        JSDOMGlobalObject *globalObject )
    : DOMConstructorObject( structure, globalObject )
{
    ASSERT( inherits( &s_info ) );
    putDirect( exec->globalData(), exec->propertyNames().prototype, JSHTMLBlockquoteElementPrototype::self( exec, globalObject ),
               DontDelete | ReadOnly );
}
...
{
    return getStaticValueSlot<JSHTMLBlockquoteElementConstructor, JSDOMWrapper>( exec, &JSHTMLBlockquoteElementConstructorTable, this,
            propertyName, slot );
}

bool JSHTMLBlockquoteElementConstructor::getOwnPropertyDescriptor( ExecState *exec, const Identifier &propertyName,
        PropertyDescriptor &descriptor )
{
    return getStaticValueDescriptor<JSHTMLBlockquoteElementConstructor, JSDOMWrapper>( exec, &JSHTMLBlockquoteElementConstructorTable,
...
JSHTMLBlockquoteElement::JSHTMLBlockquoteElement( Structure *structure, JSDOMGlobalObject *globalObject,
        PassRefPtr<HTMLBlockquoteElement> impl )
...
{
    return new ( exec ) JSHTMLBlockquoteElementPrototype( exec->globalData(), globalObject,
            JSHTMLBlockquoteElementPrototype::createStructure( exec->globalData(), JSHTMLElementPrototype::self( exec, globalObject ) ) );
}
...
bool JSHTMLBlockquoteElement::getOwnPropertyDescriptor( ExecState *exec, const Identifier &propertyName,
        PropertyDescriptor &descriptor )
{
    return getStaticValueDescriptor<JSHTMLBlockquoteElement, Base>( exec, &JSHTMLBlockquoteElementTable, this, propertyName,
            descriptor );
}
