...
public:
    ...
    JSWebGLRenderingContextPrototype( JSC::JSGlobalData &globalData, JSC::JSGlobalObject *globalObject,
...
JSC::JSValue jsWebGLRenderingContextFRAMEBUFFER_ATTACHMENT_TEXTURE_LEVEL( JSC::ExecState *, JSC::JSValue,
        const JSC::Identifier & );
JSC::JSValue jsWebGLRenderingContextFRAMEBUFFER_ATTACHMENT_TEXTURE_CUBE_MAP_FACE( JSC::ExecState *, JSC::JSValue,
        const JSC::Identifier & );
...
JSC::JSValue jsWebGLRenderingContextFRAMEBUFFER_INCOMPLETE_MISSING_ATTACHMENT( JSC::ExecState *, JSC::JSValue,
        const JSC::Identifier & );
