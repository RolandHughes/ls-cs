...
JSHTMLHeadingElementConstructor::JSHTMLHeadingElementConstructor( ExecState *exec, Structure *structure,
        JSDOMGlobalObject *globalObject )
    : DOMConstructorObject( structure, globalObject )
{
    ASSERT( inherits( &s_info ) );
    putDirect( exec->globalData(), exec->propertyNames().prototype, JSHTMLHeadingElementPrototype::self( exec, globalObject ),
               DontDelete | ReadOnly );
}

bool JSHTMLHeadingElementConstructor::getOwnPropertySlot( ExecState *exec, const Identifier &propertyName, PropertySlot &slot )
{
    return getStaticValueSlot<JSHTMLHeadingElementConstructor, JSDOMWrapper>( exec, &JSHTMLHeadingElementConstructorTable, this,
            propertyName, slot );
}

bool JSHTMLHeadingElementConstructor::getOwnPropertyDescriptor( ExecState *exec, const Identifier &propertyName,
        PropertyDescriptor &descriptor )
{
    return getStaticValueDescriptor<JSHTMLHeadingElementConstructor, JSDOMWrapper>( exec, &JSHTMLHeadingElementConstructorTable, this,
...
JSHTMLHeadingElement::JSHTMLHeadingElement( Structure *structure, JSDOMGlobalObject *globalObject,
        PassRefPtr<HTMLHeadingElement> impl )
...
{
    return new ( exec ) JSHTMLHeadingElementPrototype( exec->globalData(), globalObject,
            JSHTMLHeadingElementPrototype::createStructure( exec->globalData(), JSHTMLElementPrototype::self( exec, globalObject ) ) );
}
...
bool JSHTMLHeadingElement::getOwnPropertyDescriptor( ExecState *exec, const Identifier &propertyName,
        PropertyDescriptor &descriptor )
{
