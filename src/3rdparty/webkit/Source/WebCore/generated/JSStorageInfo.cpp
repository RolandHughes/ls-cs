...
bool JSStorageInfoPrototype::getOwnPropertyDescriptor( ExecState *exec, const Identifier &propertyName,
        PropertyDescriptor &descriptor )
{
    return getStaticPropertyDescriptor<JSStorageInfoPrototype, JSObject>( exec, &JSStorageInfoPrototypeTable, this, propertyName,
            descriptor );
}
...
{
    return new ( exec ) JSStorageInfoPrototype( exec->globalData(), globalObject,
            JSStorageInfoPrototype::createStructure( globalObject->globalData(), globalObject->objectPrototype() ) );
}
