    ...
    : DOMConstructorObject( structure, globalObject )
{
    ...
    putDirect( exec->globalData(), exec->propertyNames().prototype, JSIDBCursorPrototype::self( exec, globalObject ),
               DontDelete | ReadOnly );
}
...
bool JSIDBCursorConstructor::getOwnPropertyDescriptor( ExecState *exec, const Identifier &propertyName,
        PropertyDescriptor &descriptor )
{
    return getStaticValueDescriptor<JSIDBCursorConstructor, JSDOMWrapper>( exec, &JSIDBCursorConstructorTable, this, propertyName,
            descriptor );
}
...
bool JSIDBCursorPrototype::getOwnPropertyDescriptor( ExecState *exec, const Identifier &propertyName,
        PropertyDescriptor &descriptor )
{
    return getStaticPropertyDescriptor<JSIDBCursorPrototype, JSObject>( exec, &JSIDBCursorPrototypeTable, this, propertyName,
            descriptor );
}
...
{
    return new ( exec ) JSIDBCursorPrototype( exec->globalData(), globalObject,
            JSIDBCursorPrototype::createStructure( globalObject->globalData(), globalObject->objectPrototype() ) );
}
