...
JSAudioSourceNodeConstructor::JSAudioSourceNodeConstructor( ExecState *exec, Structure *structure,
        JSDOMGlobalObject *globalObject )
    : DOMConstructorObject( structure, globalObject )
{
    ASSERT( inherits( &s_info ) );
    putDirect( exec->globalData(), exec->propertyNames().prototype, JSAudioSourceNodePrototype::self( exec, globalObject ),
               DontDelete | ReadOnly );
}

bool JSAudioSourceNodeConstructor::getOwnPropertySlot( ExecState *exec, const Identifier &propertyName, PropertySlot &slot )
{
    return getStaticValueSlot<JSAudioSourceNodeConstructor, JSDOMWrapper>( exec, &JSAudioSourceNodeConstructorTable, this,
            propertyName, slot );
}

bool JSAudioSourceNodeConstructor::getOwnPropertyDescriptor( ExecState *exec, const Identifier &propertyName,
        PropertyDescriptor &descriptor )
{
    return getStaticValueDescriptor<JSAudioSourceNodeConstructor, JSDOMWrapper>( exec, &JSAudioSourceNodeConstructorTable, this,
...
{
    return new ( exec ) JSAudioSourceNodePrototype( exec->globalData(), globalObject,
            JSAudioSourceNodePrototype::createStructure( exec->globalData(), JSAudioNodePrototype::self( exec, globalObject ) ) );
}
...
bool JSAudioSourceNode::getOwnPropertyDescriptor( ExecState *exec, const Identifier &propertyName,
        PropertyDescriptor &descriptor )
{
