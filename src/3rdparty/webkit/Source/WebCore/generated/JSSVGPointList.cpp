    ...
    : DOMConstructorObject( structure, globalObject )
{
    ...
    putDirect( exec->globalData(), exec->propertyNames().prototype, JSSVGPointListPrototype::self( exec, globalObject ),
               DontDelete | ReadOnly );
}

bool JSSVGPointListConstructor::getOwnPropertySlot( ExecState *exec, const Identifier &propertyName, PropertySlot &slot )
{
    return getStaticValueSlot<JSSVGPointListConstructor, JSDOMWrapper>( exec, &JSSVGPointListConstructorTable, this, propertyName,
            slot );
}

bool JSSVGPointListConstructor::getOwnPropertyDescriptor( ExecState *exec, const Identifier &propertyName,
        PropertyDescriptor &descriptor )
{
    return getStaticValueDescriptor<JSSVGPointListConstructor, JSDOMWrapper>( exec, &JSSVGPointListConstructorTable, this,
...
bool JSSVGPointListPrototype::getOwnPropertyDescriptor( ExecState *exec, const Identifier &propertyName,
        PropertyDescriptor &descriptor )
{
...
JSSVGPointList::JSSVGPointList( Structure *structure, JSDOMGlobalObject *globalObject,
                                PassRefPtr<SVGListPropertyTearOff<SVGPointList> > impl )
...
{
    return new ( exec ) JSSVGPointListPrototype( exec->globalData(), globalObject,
            JSSVGPointListPrototype::createStructure( globalObject->globalData(), globalObject->objectPrototype() ) );
}
...
EncodedJSValue JSC_HOST_CALL jsSVGPointListPrototypeFunctionInitialize( ExecState *exec )
{
    ...
    if ( exec->argumentCount() > 0 && !exec->argument( 0 ).isUndefinedOrNull()
            && !exec->argument( 0 ).inherits( &JSSVGPoint::s_info ) )
    {
        return throwVMTypeError( exec );
    }
