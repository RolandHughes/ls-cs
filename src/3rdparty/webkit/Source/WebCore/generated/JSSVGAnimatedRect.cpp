...
JSSVGAnimatedRectConstructor::JSSVGAnimatedRectConstructor( ExecState *exec, Structure *structure,
        JSDOMGlobalObject *globalObject )
    : DOMConstructorObject( structure, globalObject )
{
    ASSERT( inherits( &s_info ) );
    putDirect( exec->globalData(), exec->propertyNames().prototype, JSSVGAnimatedRectPrototype::self( exec, globalObject ),
               DontDelete | ReadOnly );
}

bool JSSVGAnimatedRectConstructor::getOwnPropertySlot( ExecState *exec, const Identifier &propertyName, PropertySlot &slot )
{
    return getStaticValueSlot<JSSVGAnimatedRectConstructor, JSDOMWrapper>( exec, &JSSVGAnimatedRectConstructorTable, this,
            propertyName, slot );
}

bool JSSVGAnimatedRectConstructor::getOwnPropertyDescriptor( ExecState *exec, const Identifier &propertyName,
        PropertyDescriptor &descriptor )
{
    return getStaticValueDescriptor<JSSVGAnimatedRectConstructor, JSDOMWrapper>( exec, &JSSVGAnimatedRectConstructorTable, this,
...
{
    return new ( exec ) JSSVGAnimatedRectPrototype( exec->globalData(), globalObject,
            JSSVGAnimatedRectPrototype::createStructure( globalObject->globalData(), globalObject->objectPrototype() ) );
}
...
bool JSSVGAnimatedRect::getOwnPropertyDescriptor( ExecState *exec, const Identifier &propertyName,
        PropertyDescriptor &descriptor )
{
...
JSValue jsSVGAnimatedRectBaseVal( ExecState *exec, JSValue slotBase, const Identifier & )
{
    ...
    JSValue result = toJS( exec, castedThis->globalObject(),
                           WTF::getPtr( static_cast<SVGPropertyTearOff<FloatRect>*>( imp->baseVal() ) ) );
    return result;
}
...
JSValue jsSVGAnimatedRectAnimVal( ExecState *exec, JSValue slotBase, const Identifier & )
{
    ...
    SVGAnimatedRect *imp = static_cast<SVGAnimatedRect *>( castedThis->impl() );
    JSValue result = toJS( exec, castedThis->globalObject(),
                           WTF::getPtr( static_cast<SVGPropertyTearOff<FloatRect>*>( imp->animVal() ) ) );
    return result;
}
