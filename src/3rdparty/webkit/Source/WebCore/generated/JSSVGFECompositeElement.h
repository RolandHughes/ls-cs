...
public:
    ...
    JSSVGFECompositeElementPrototype( JSC::JSGlobalData &globalData, JSC::JSGlobalObject *globalObject,
...
JSC::JSValue jsSVGFECompositeElementSVG_FECOMPOSITE_OPERATOR_ARITHMETIC( JSC::ExecState *, JSC::JSValue,
