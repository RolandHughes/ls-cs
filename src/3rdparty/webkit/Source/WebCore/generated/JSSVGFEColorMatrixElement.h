...
public:
    ...
    JSSVGFEColorMatrixElementPrototype( JSC::JSGlobalData &globalData, JSC::JSGlobalObject *globalObject,
...
JSC::JSValue jsSVGFEColorMatrixElementSVG_FECOLORMATRIX_TYPE_LUMINANCETOALPHA( JSC::ExecState *, JSC::JSValue,
