...
JSScriptProfileNode::JSScriptProfileNode( Structure *structure, JSDOMGlobalObject *globalObject,
        PassRefPtr<ScriptProfileNode> impl )
...
{
    return new ( exec ) JSScriptProfileNodePrototype( exec->globalData(), globalObject,
            JSScriptProfileNodePrototype::createStructure( globalObject->globalData(), globalObject->objectPrototype() ) );
}
...
bool JSScriptProfileNode::getOwnPropertyDescriptor( ExecState *exec, const Identifier &propertyName,
