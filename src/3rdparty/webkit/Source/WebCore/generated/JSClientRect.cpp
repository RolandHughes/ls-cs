    ...
    : DOMConstructorObject( structure, globalObject )
{
    ...
    putDirect( exec->globalData(), exec->propertyNames().prototype, JSClientRectPrototype::self( exec, globalObject ),
               DontDelete | ReadOnly );
}
...
bool JSClientRectConstructor::getOwnPropertyDescriptor( ExecState *exec, const Identifier &propertyName,
        PropertyDescriptor &descriptor )
{
    return getStaticValueDescriptor<JSClientRectConstructor, JSDOMWrapper>( exec, &JSClientRectConstructorTable, this, propertyName,
            descriptor );
}
...
{
    return new ( exec ) JSClientRectPrototype( exec->globalData(), globalObject,
            JSClientRectPrototype::createStructure( globalObject->globalData(), globalObject->objectPrototype() ) );
}
