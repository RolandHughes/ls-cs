    ...
    : DOMConstructorObject( structure, globalObject )
{
    ...
    putDirect( exec->globalData(), exec->propertyNames().prototype, JSFileErrorPrototype::self( exec, globalObject ),
               DontDelete | ReadOnly );
}
...
bool JSFileErrorConstructor::getOwnPropertyDescriptor( ExecState *exec, const Identifier &propertyName,
        PropertyDescriptor &descriptor )
{
    return getStaticValueDescriptor<JSFileErrorConstructor, JSDOMWrapper>( exec, &JSFileErrorConstructorTable, this, propertyName,
            descriptor );
}
...
bool JSFileErrorPrototype::getOwnPropertyDescriptor( ExecState *exec, const Identifier &propertyName,
        PropertyDescriptor &descriptor )
{
    return getStaticValueDescriptor<JSFileErrorPrototype, JSObject>( exec, getJSFileErrorPrototypeTable( exec ), this, propertyName,
            descriptor );
}
...
{
    return new ( exec ) JSFileErrorPrototype( exec->globalData(), globalObject,
            JSFileErrorPrototype::createStructure( globalObject->globalData(), globalObject->objectPrototype() ) );
}
