...
const char *InspectorBackendDispatcher::DOMDebugger_removeEventListenerBreakpointCmd =
...
void InspectorBackendDispatcher::Debugger_setBreakpointByUrl( long callId, InspectorObject *requestMessageObject )
{
    ...
    if ( RefPtr<InspectorObject> paramsContainer = requestMessageObject->getObject( "params" ) )
    {
        ...
        if ( !protocolErrors->length() )
        {
            m_debuggerAgent->setBreakpointByUrl( &error, in_url, in_lineNumber, &in_columnNumber, &in_condition, &out_breakpointId,
                                                 &out_locations );
        }
    }
    else
...
void InspectorBackendDispatcher::Debugger_evaluateOnCallFrame( long callId, InspectorObject *requestMessageObject )
{
    ...
    if ( RefPtr<InspectorObject> paramsContainer = requestMessageObject->getObject( "params" ) )
    {
        ...
        if ( !protocolErrors->length() )
        {
            m_debuggerAgent->evaluateOnCallFrame( &error, in_callFrameId, in_expression, &in_objectGroup, &in_includeCommandLineAPI,
                                                  &out_result, &out_wasThrown );
        }
    }
    else
    {
...
void InspectorBackendDispatcher::dispatch( const String &message )
{
    ...
    if ( dispatchMap.isEmpty() )
    {
        ...
        dispatchMap.add( DOMDebugger_removeEventListenerBreakpointCmd,
...
void InspectorBackendDispatcher::reportProtocolError( const long *const callId, CommonErrorCode code,
...
void InspectorBackendDispatcher::reportProtocolError( const long *const callId, CommonErrorCode code,
        PassRefPtr<InspectorArray> data ) const
{
...
int InspectorBackendDispatcher::getInt( InspectorObject *object, const String &name, bool optional,
                                        InspectorArray *protocolErrors )
{
    ASSERT( object );
...
String InspectorBackendDispatcher::getString( InspectorObject *object, const String &name, bool optional,
        InspectorArray *protocolErrors )
{
    ASSERT( object );
    ASSERT( protocolErrors );
...
bool InspectorBackendDispatcher::getBoolean( InspectorObject *object, const String &name, bool optional,
        InspectorArray *protocolErrors )
{
    ASSERT( object );
    ASSERT( protocolErrors );
...
PassRefPtr<InspectorObject> InspectorBackendDispatcher::getObject( InspectorObject *object, const String &name, bool optional,
        InspectorArray *protocolErrors )
{
    ASSERT( object );
    ASSERT( protocolErrors );
...
PassRefPtr<InspectorArray> InspectorBackendDispatcher::getArray( InspectorObject *object, const String &name, bool optional,
        InspectorArray *protocolErrors )
{
    ASSERT( object );
    ASSERT( protocolErrors );
