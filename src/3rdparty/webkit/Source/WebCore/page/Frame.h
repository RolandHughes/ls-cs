...
public:
    ...
    MediaStreamFrameController *mediaStreamFrameController() const
    {
        return m_mediaStreamFrameController.get();
    }
#endif
...
public:
    TiledBackingStore *tiledBackingStore() const
    {
        return m_tiledBackingStore.get();
    }
