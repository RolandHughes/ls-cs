...
public:
    ...
    virtual void scrollRectIntoView( const IntRect &,
                                     const ScrollView * ) const = 0; // Currently only Mac has a non empty implementation.
    ...
    {
        return static_cast<CompositingTriggerFlags>( AllTriggers );
    }
#endif
