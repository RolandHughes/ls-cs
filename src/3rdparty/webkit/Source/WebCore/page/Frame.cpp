...
inline Frame::Frame( Page *page, HTMLFrameOwnerElement *ownerElement, FrameLoaderClient *frameLoaderClient )
    ...
    , m_mediaStreamFrameController( RuntimeEnabledFeatures::mediaStreamEnabled() ? adoptPtr( new MediaStreamFrameController(
                                        this ) ) : PassOwnPtr<MediaStreamFrameController>() )
#endif
{
    ASSERT( page );
    AtomicString::init();
...
String Frame::searchForLabelsBeforeElement( const Vector<String> &labels, Element *element, size_t *resultDistance,
...
void Frame::setPrinting( bool printing, const FloatSize &pageSize, float maximumShrinkRatio,
...
void Frame::injectUserScriptsForWorld( DOMWrapperWorld *world, const UserScriptVector &userScripts,
