...
public:
    ...
    {
        return m_valueMatchesRenderer;
    }
    virtual void setFormControlValueMatchesRenderer( bool b )
    {
        m_valueMatchesRenderer = b;
    }
...
protected:
    ...
    virtual void parseMappedAttribute( Attribute * );
    virtual void setTextAsOfLastFormControlChangeEvent( String text )
    {
...
private:
    ...
    virtual bool isEmptySuggestedValue() const
    {
        return true;
    }
