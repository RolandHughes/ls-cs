...
public:
    ...
    void stepUp( ExceptionCode &ec )
    {
        stepUp( 1, ec );
    }
    void stepDown( ExceptionCode &ec )
    {
        stepDown( 1, ec );
    }
    ...
    virtual void select()
    {
        HTMLTextFormControlElement::select();
    }
...
private:
    ...
    virtual bool supportsMaxLength() const
    {
        return isTextType();
    }
...
#if ENABLE(WCSS)
    virtual InputElementData data() const
    {
        return m_data;
    }
#endif
