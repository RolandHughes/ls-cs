...
static void reflectedIntegralAttrAttrSetter( v8::Local<v8::String> name, v8::Local<v8::Value> value,
...
static v8::Handle<v8::Value> reflectedUnsignedIntegralAttrAttrGetter( v8::Local<v8::String> name, const v8::AccessorInfo &info )
{
    ...
    TestObj *imp = V8TestObj::toNative( info.Holder() );
    return v8::Integer::NewFromUnsigned( std::max( 0,
                                         imp->getIntegralAttribute( WebCore::HTMLNames::reflectedunsignedintegralattrAttr ) ) );
}

static void reflectedUnsignedIntegralAttrAttrSetter( v8::Local<v8::String> name, v8::Local<v8::Value> value,
        const v8::AccessorInfo &info )
{
...
static void reflectedNonEmptyURLAttrAttrSetter( v8::Local<v8::String> name, v8::Local<v8::Value> value,
        const v8::AccessorInfo &info )
{
...
static void reflectedCustomIntegralAttrAttrSetter( v8::Local<v8::String> name, v8::Local<v8::Value> value,
        const v8::AccessorInfo &info )
{
...
static void reflectedCustomBooleanAttrAttrSetter( v8::Local<v8::String> name, v8::Local<v8::Value> value,
        const v8::AccessorInfo &info )
{
...
static void reflectedCustomURLAttrAttrSetter( v8::Local<v8::String> name, v8::Local<v8::Value> value,
        const v8::AccessorInfo &info )
{
...
static void reflectedCustomNonEmptyURLAttrAttrSetter( v8::Local<v8::String> name, v8::Local<v8::Value> value,
        const v8::AccessorInfo &info )
{
...
static void attrWithGetterExceptionAttrSetter( v8::Local<v8::String> name, v8::Local<v8::Value> value,
        const v8::AccessorInfo &info )
{
...
static void attrWithSetterExceptionAttrSetter( v8::Local<v8::String> name, v8::Local<v8::Value> value,
        const v8::AccessorInfo &info )
{
...
static void stringAttrWithGetterExceptionAttrSetter( v8::Local<v8::String> name, v8::Local<v8::Value> value,
        const v8::AccessorInfo &info )
{
...
static void stringAttrWithSetterExceptionAttrSetter( v8::Local<v8::String> name, v8::Local<v8::Value> value,
        const v8::AccessorInfo &info )
{
...
static void enabledAtRuntimeAttr1AttrSetter( v8::Local<v8::String> name, v8::Local<v8::Value> value,
        const v8::AccessorInfo &info )
{
...
static void enabledAtRuntimeAttr2AttrSetter( v8::Local<v8::String> name, v8::Local<v8::Value> value,
        const v8::AccessorInfo &info )
{
...
static v8::Handle<v8::Value> voidMethodWithArgsCallback( const v8::Arguments &args )
{
    ...
    EXCEPTION_BLOCK( TestObj *, objArg, V8TestObj::HasInstance( args[2] ) ? V8TestObj::toNative( v8::Handle<v8::Object>::Cast(
                         args[2] ) ) : 0 );
...
static v8::Handle<v8::Value> methodThatRequiresAllArgsCallback( const v8::Arguments &args )
{
    ...
    EXCEPTION_BLOCK( TestObj *, objArg, V8TestObj::HasInstance( args[1] ) ? V8TestObj::toNative( v8::Handle<v8::Object>::Cast(
                         args[1] ) ) : 0 );
...
static v8::Handle<v8::Value> addEventListenerCallback( const v8::Arguments &args )
{
    ...
    if ( listener )
    {
        V8TestObj::toNative( args.Holder() )->addEventListener( v8ValueToAtomicWebCoreString( args[0] ), listener,
                args[2]->BooleanValue() );
...
static v8::Handle<v8::Value> removeEventListenerCallback( const v8::Arguments &args )
{
    ...
    if ( listener )
    {
        V8TestObj::toNative( args.Holder() )->removeEventListener( v8ValueToAtomicWebCoreString( args[0] ), listener.get(),
                args[2]->BooleanValue() );
...
static v8::Handle<v8::Value> overloadedMethod1Callback( const v8::Arguments &args )
{
    ...
    TestObj *imp = V8TestObj::toNative( args.Holder() );
    EXCEPTION_BLOCK( TestObj *, objArg, V8TestObj::HasInstance( args[0] ) ? V8TestObj::toNative( v8::Handle<v8::Object>::Cast(
                         args[0] ) ) : 0 );
    STRING_TO_V8PARAMETER_EXCEPTION_BLOCK( V8Parameter<>, strArg, args[1] );
...
static v8::Handle<v8::Value> overloadedMethodCallback( const v8::Arguments &args )
{
    ...
    if ( ( args.Length() == 2 && ( args[0]->IsNull() || V8TestObj::HasInstance( args[0] ) ) && ( args[1]->IsNull()
            || args[1]->IsUndefined() || args[1]->IsString() || args[1]->IsObject() ) ) )
    {
        return overloadedMethod1Callback( args );
    }

    if ( ( args.Length() == 1 && ( args[0]->IsNull() || V8TestObj::HasInstance( args[0] ) ) ) || ( args.Length() == 2
            && ( args[0]->IsNull() || V8TestObj::HasInstance( args[0] ) ) ) )
    {
...
{
    v8::Local<v8::Signature> defaultSignature = configureTemplate( desc, "TestObj", v8::Persistent<v8::FunctionTemplate>(),
            V8TestObj::internalFieldCount,
    ...
    v8::Handle<v8::Signature> voidMethodWithArgsSignature = v8::Signature::New( desc, voidMethodWithArgsArgc,
            voidMethodWithArgsArgv );
    proto->Set( v8::String::New( "voidMethodWithArgs" ), v8::FunctionTemplate::New( TestObjInternal::voidMethodWithArgsCallback,
                v8::Handle<v8::Value>(), voidMethodWithArgsSignature ) );
    ...
    proto->Set( v8::String::New( "intMethodWithArgs" ), v8::FunctionTemplate::New( TestObjInternal::intMethodWithArgsCallback,
                v8::Handle<v8::Value>(), intMethodWithArgsSignature ) );
    ...
    proto->Set( v8::String::New( "objMethodWithArgs" ), v8::FunctionTemplate::New( TestObjInternal::objMethodWithArgsCallback,
                v8::Handle<v8::Value>(), objMethodWithArgsSignature ) );
    ...
    v8::Handle<v8::Signature> methodThatRequiresAllArgsSignature = v8::Signature::New( desc, methodThatRequiresAllArgsArgc,
            methodThatRequiresAllArgsArgv );
    proto->Set( v8::String::New( "methodThatRequiresAllArgs" ),
                v8::FunctionTemplate::New( TestObjInternal::methodThatRequiresAllArgsCallback, v8::Handle<v8::Value>(),
                                           methodThatRequiresAllArgsSignature ) );
    ...
    v8::Handle<v8::Signature> methodThatRequiresAllArgsAndThrowsSignature = v8::Signature::New( desc,
            methodThatRequiresAllArgsAndThrowsArgc, methodThatRequiresAllArgsAndThrowsArgv );
    proto->Set( v8::String::New( "methodThatRequiresAllArgsAndThrows" ),
                v8::FunctionTemplate::New( TestObjInternal::methodThatRequiresAllArgsAndThrowsCallback, v8::Handle<v8::Value>(),
                                           methodThatRequiresAllArgsAndThrowsSignature ) );
    ...
    v8::Handle<v8::Signature> customArgsAndExceptionSignature = v8::Signature::New( desc, customArgsAndExceptionArgc,
            customArgsAndExceptionArgv );
    proto->Set( v8::String::New( "customArgsAndException" ),
                v8::FunctionTemplate::New( TestObjInternal::customArgsAndExceptionCallback, v8::Handle<v8::Value>(),
                                           customArgsAndExceptionSignature ) );
    desc->Set( v8::String::New( "classMethod" ), v8::FunctionTemplate::New( TestObjInternal::classMethodCallback,
               v8::Handle<v8::Value>(), v8::Local<v8::Signature>() ) );
    desc->Set( v8::String::New( "classMethodWithOptional" ),
               v8::FunctionTemplate::New( TestObjInternal::classMethodWithOptionalCallback, v8::Handle<v8::Value>(),
                                          v8::Local<v8::Signature>() ) );

    if ( RuntimeEnabledFeatures::enabledAtRuntimeMethod1Enabled() )
    {
        proto->Set( v8::String::New( "enabledAtRuntimeMethod1" ),
                    v8::FunctionTemplate::New( TestObjInternal::enabledAtRuntimeMethod1Callback, v8::Handle<v8::Value>(), defaultSignature ) );
    }

    if ( RuntimeEnabledFeatures::featureNameEnabled() )
    {
        proto->Set( v8::String::New( "enabledAtRuntimeMethod2" ),
                    v8::FunctionTemplate::New( TestObjInternal::enabledAtRuntimeMethod2Callback, v8::Handle<v8::Value>(), defaultSignature ) );
    }
