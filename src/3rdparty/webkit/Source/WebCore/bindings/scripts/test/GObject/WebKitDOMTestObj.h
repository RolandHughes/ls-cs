...
WEBKIT_API void
webkit_dom_test_obj_void_method_with_args( WebKitDOMTestObj *self, glong int_arg, const gchar *str_arg,
...
WEBKIT_API glong
webkit_dom_test_obj_int_method_with_args( WebKitDOMTestObj *self, glong int_arg, const gchar *str_arg,
        WebKitDOMTestObj *obj_arg );
...
WEBKIT_API WebKitDOMTestObj *
webkit_dom_test_obj_obj_method_with_args( WebKitDOMTestObj *self, glong int_arg, const gchar *str_arg,
        WebKitDOMTestObj *obj_arg );
...
WEBKIT_API WebKitDOMTestObj *
webkit_dom_test_obj_method_that_requires_all_args_and_throws( WebKitDOMTestObj *self, const gchar *str_arg,
...
WEBKIT_API void
webkit_dom_test_obj_method_with_non_optional_arg_and_two_optional_args( WebKitDOMTestObj *self, glong non_opt, glong opt1,
        glong opt2 );
