...
JSValue JSCanvasRenderingContext2D::putImageData( ExecState *exec )
{
    ...
    if ( exec->argumentCount() >= 7 )
        context->putImageData( toImageData( exec->argument( 0 ) ), exec->argument( 1 ).toFloat( exec ),
                               exec->argument( 2 ).toFloat( exec ),
                               exec->argument( 3 ).toFloat( exec ), exec->argument( 4 ).toFloat( exec ), exec->argument( 5 ).toFloat( exec ),
                               exec->argument( 6 ).toFloat( exec ), ec );
    else
    {
        context->putImageData( toImageData( exec->argument( 0 ) ), exec->argument( 1 ).toFloat( exec ),
                               exec->argument( 2 ).toFloat( exec ), ec );
    }
...
JSValue JSCanvasRenderingContext2D::fillText( ExecState *exec )
{
    ...
    if ( exec->argumentCount() == 4 )
    {
        context->fillText( ustringToString( exec->argument( 0 ).toString( exec ) ), exec->argument( 1 ).toFloat( exec ),
                           exec->argument( 2 ).toFloat( exec ), exec->argument( 3 ).toFloat( exec ) );
    }
    else
    {
...
JSValue JSCanvasRenderingContext2D::strokeText( ExecState *exec )
{
    ...
    if ( exec->argumentCount() == 4 )
    {
        context->strokeText( ustringToString( exec->argument( 0 ).toString( exec ) ), exec->argument( 1 ).toFloat( exec ),
                             exec->argument( 2 ).toFloat( exec ), exec->argument( 3 ).toFloat( exec ) );
    }
    else
    {
