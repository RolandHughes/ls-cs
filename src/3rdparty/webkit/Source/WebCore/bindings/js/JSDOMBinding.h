...
template<class WrapperClass> inline JSC::Structure *getDOMStructure( JSC::ExecState *exec, JSDOMGlobalObject *globalObject )
{
    ...
    return cacheDOMStructure( globalObject, WrapperClass::createStructure( exec->globalData(), WrapperClass::createPrototype( exec,
                              globalObject ) ), &WrapperClass::s_info );
}
...
{
    return static_cast<JSC::JSObject *>( asObject( getDOMStructure<WrapperClass>( exec,
                                         static_cast<JSDOMGlobalObject *>( globalObject ) )->storedPrototype() ) );
}

// Overload these functions to provide a fast path for wrapper access.
inline JSDOMWrapper *getInlineCachedWrapper( DOMWrapperWorld *, void * )
{
    return 0;
}
inline bool setInlineCachedWrapper( DOMWrapperWorld *, void *, JSDOMWrapper * )
{
    return false;
}
inline bool clearInlineCachedWrapper( DOMWrapperWorld *, void *, JSDOMWrapper * )
{
    return false;
}

// Overload these functions to provide a custom WeakHandleOwner.
inline JSC::WeakHandleOwner *wrapperOwner( DOMWrapperWorld *world, void * )
{
    return world->defaultWrapperOwner();
}
...
template <typename DOMClass> inline void cacheWrapper( DOMWrapperWorld *world, DOMClass *domObject, JSDOMWrapper *wrapper )
{
    ...
    world->m_wrappers.set( domObject, JSC::Weak<JSDOMWrapper>( *world->globalData(), wrapper, wrapperOwner( world, domObject ),
                           wrapperContext( world, domObject ) ) );
}
...
template<class WrapperClass, class DOMClass> inline JSDOMWrapper *createWrapper( JSC::ExecState *exec,
        JSDOMGlobalObject *globalObject, DOMClass *node )
{
    ASSERT( node );
...
template<class WrapperClass, class DOMClass> inline JSC::JSValue wrap( JSC::ExecState *exec, JSDOMGlobalObject *globalObject,
        DOMClass *domObject )
{
    if ( !domObject )
    {
