...
{
    ASSERT( m_segment );
    ASSERT( m_segment->pathSegType() == PathSegCurveToQuadraticSmoothAbs
...
bool SVGPathSegListSource::parseArcToSegment( float &rx, float &ry, float &angle, bool &largeArc, bool &sweep,
