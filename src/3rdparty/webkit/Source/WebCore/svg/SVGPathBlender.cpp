...
bool SVGPathBlender::blendMoveToSegment()
{
    ...
    m_consumer->moveTo( blendAnimatedFloatPoint( fromTargetPoint, toTargetPoint ), false,
...
bool SVGPathBlender::blendLineToSegment()
{
    ...
    m_consumer->lineTo( blendAnimatedFloatPoint( fromTargetPoint, toTargetPoint ),
                        m_isInFirstHalfOfAnimation ? m_fromMode : m_toMode );
    m_fromCurrentPoint = m_fromMode == AbsoluteCoordinates ? fromTargetPoint : m_fromCurrentPoint + fromTargetPoint;
    m_toCurrentPoint = m_toMode == AbsoluteCoordinates ? toTargetPoint : m_toCurrentPoint + toTargetPoint;
    return true;
...
bool SVGPathBlender::blendLineToHorizontalSegment()
{
    ...
    m_consumer->lineToHorizontal( blendAnimatedDimensonalFloat( fromX, toX, BlendHorizontal ),
                                  m_isInFirstHalfOfAnimation ? m_fromMode : m_toMode );
...
bool SVGPathBlender::blendLineToVerticalSegment()
{
    ...
    m_consumer->lineToVertical( blendAnimatedDimensonalFloat( fromY, toY, BlendVertical ),
                                m_isInFirstHalfOfAnimation ? m_fromMode : m_toMode );
...
bool SVGPathBlender::blendCurveToQuadraticSmoothSegment()
{
    ...
    m_consumer->curveToQuadraticSmooth( blendAnimatedFloatPoint( fromTargetPoint, toTargetPoint ),
                                        m_isInFirstHalfOfAnimation ? m_fromMode : m_toMode );
    m_fromCurrentPoint = m_fromMode == AbsoluteCoordinates ? fromTargetPoint : m_fromCurrentPoint + fromTargetPoint;
    m_toCurrentPoint = m_toMode == AbsoluteCoordinates ? toTargetPoint : m_toCurrentPoint + toTargetPoint;
    return true;
...
static inline bool isSegmentEqual( const SVGPathSegType &fromType, const SVGPathSegType &toType,
                                   const PathCoordinateMode &fromMode, const PathCoordinateMode &toMode )
{
...
bool SVGPathBlender::blendAnimatedPath( float progress, SVGPathSource *fromSource, SVGPathSource *toSource,
