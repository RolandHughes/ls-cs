...
SVGTransformDistance::SVGTransformDistance( SVGTransform::SVGTransformType type, float angle, float cx, float cy,
...
SVGTransformDistance SVGTransformDistance::scaledDistance( float scaleFactor ) const
{
    switch ( m_type )
    {
        ...
        case SVGTransform::SVG_TRANSFORM_SCALE:
        case SVGTransform::SVG_TRANSFORM_MATRIX:
            return SVGTransformDistance( m_type, m_angle * scaleFactor, m_cx * scaleFactor, m_cy * scaleFactor,
                                         AffineTransform( m_transform ).scale( scaleFactor ) );
...
void SVGTransformDistance::addSVGTransform( const SVGTransform &transform, bool absoluteValue )
{
    ...
    switch ( m_type )
    {
        ...
        case SVGTransform::SVG_TRANSFORM_MATRIX:
            m_transform *=
                transform.matrix(); // FIXME: what does 'distance' between two transforms mean?  how should we respect 'absoluteValue' here?
            return;
