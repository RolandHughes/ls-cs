...
{
public:
    SVGPathSegArc( SVGPathElement *element, SVGPathSegRole role, float x, float y, float r1, float r2, float angle, bool largeArcFlag,
                   bool sweepFlag )
...
{
public:
    static PassRefPtr<SVGPathSegArcAbs> create( SVGPathElement *element, SVGPathSegRole role, float x, float y, float r1, float r2,
...
private:
    SVGPathSegArcAbs( SVGPathElement *element, SVGPathSegRole role, float x, float y, float r1, float r2, float angle,
...
{
public:
    static PassRefPtr<SVGPathSegArcRel> create( SVGPathElement *element, SVGPathSegRole role, float x, float y, float r1, float r2,
            float angle, bool largeArcFlag, bool sweepFlag )
    {
...
private:
    SVGPathSegArcRel( SVGPathElement *element, SVGPathSegRole role, float x, float y, float r1, float r2, float angle,
                      bool largeArcFlag, bool sweepFlag )
        : SVGPathSegArc( element, role, x, y, r1, r2, angle, largeArcFlag, sweepFlag )
    {
    }
