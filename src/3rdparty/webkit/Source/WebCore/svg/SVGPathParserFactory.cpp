...
bool SVGPathParserFactory::buildSVGPathByteStreamFromSVGPathSegList( const SVGPathSegList &list,
...
bool SVGPathParserFactory::buildSVGPathSegListFromByteStream( SVGPathByteStream *stream, SVGPathElement *element,
        SVGPathSegList &result, PathParsingMode parsingMode )
{
    ASSERT( stream );
    ...
    SVGPathSegListBuilder *builder = globalSVGPathSegListBuilder( element,
                                     parsingMode == NormalizedParsing ? PathSegNormalizedRole : PathSegUnalteredRole, result );
...
bool SVGPathParserFactory::buildAnimatedSVGPathByteStream( SVGPathByteStream *fromStream, SVGPathByteStream *toStream,
        OwnPtr<SVGPathByteStream> &result, float progress )
{
    ASSERT( fromStream );
    ASSERT( toStream );
    result = SVGPathByteStream::create();
...
bool SVGPathParserFactory::getSVGPathSegAtLengthFromSVGPathByteStream( SVGPathByteStream *stream, float length,
        unsigned long &pathSeg )
{
    ASSERT( stream );
