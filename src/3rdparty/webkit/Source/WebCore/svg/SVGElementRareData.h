...
public:
    ...
    HashSet<SVGElementInstance *> &elementInstances()
    {
        return m_elementInstances;
    }
    const HashSet<SVGElementInstance *> &elementInstances() const
    {
        return m_elementInstances;
    }
    ...
    {
        return m_instancesUpdatesBlocked;
    }
    ...
    {
        return m_hasPendingResources;
    }
    void setHasPendingResources( bool value )
    {
        m_hasPendingResources = value;
    }
    ...
    void setCursorImageValue( CSSCursorImageValue *cursorImageValue )
    {
