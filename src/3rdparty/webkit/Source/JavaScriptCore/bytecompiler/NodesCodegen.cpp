...
RegisterID *BracketAccessorNode::emitBytecode( BytecodeGenerator &generator, RegisterID *dst )
{
    ...
    RefPtr<RegisterID> base = generator.emitNodeForLeftHandSide( m_base, m_subscriptHasAssignments,
                              m_subscript->isPure( generator ) );
    RegisterID *property = generator.emitNode( m_subscript );
    generator.emitExpressionInfo( divot(), startOffset(), endOffset() );
...
RegisterID *NewExprNode::emitBytecode( BytecodeGenerator &generator, RegisterID *dst )
{
    ...
    return generator.emitConstruct( generator.finalDestinationOrIgnored( dst ), func.get(), callArguments, divot(), startOffset(),
                                    endOffset() );
}
...
RegisterID *EvalFunctionCallNode::emitBytecode( BytecodeGenerator &generator, RegisterID *dst )
{
    ...
    return generator.emitCallEval( generator.finalDestination( dst, func.get() ), func.get(), callArguments, divot(), startOffset(),
                                   endOffset() );
}
...
RegisterID *FunctionCallValueNode::emitBytecode( BytecodeGenerator &generator, RegisterID *dst )
{
    ...
    return generator.emitCall( generator.finalDestinationOrIgnored( dst, func.get() ), func.get(), callArguments, divot(),
...
RegisterID *FunctionCallResolveNode::emitBytecode( BytecodeGenerator &generator, RegisterID *dst )
{
    if ( RefPtr<RegisterID> local = generator.registerFor( m_ident ) )
    {
        CallArguments callArguments( generator, m_args );
        generator.emitLoad( callArguments.thisRegister(), jsUndefined() );
        return generator.emitCall( generator.finalDestinationOrIgnored( dst, callArguments.thisRegister() ), local.get(), callArguments,
    ...
    if ( generator.findScopedProperty( m_ident, index, depth, false, requiresDynamicChecks, globalObject )
            && index != missingSymbolMarker() && !requiresDynamicChecks )
    {
...
RegisterID *FunctionCallBracketNode::emitBytecode( BytecodeGenerator &generator, RegisterID *dst )
{
    ...
    RegisterID *property = generator.emitNode( m_subscript );
    generator.emitExpressionInfo( divot() - m_subexpressionDivotOffset, startOffset() - m_subexpressionDivotOffset,
                                  m_subexpressionEndOffset );
    RefPtr<RegisterID> function = generator.emitGetByVal( generator.tempDestination( dst ), base.get(), property );
    CallArguments callArguments( generator, m_args );
    generator.emitMove( callArguments.thisRegister(), base.get() );
    return generator.emitCall( generator.finalDestinationOrIgnored( dst, function.get() ), function.get(), callArguments, divot(),
                               startOffset(), endOffset() );
}
...
RegisterID *ApplyFunctionCallDotNode::emitBytecode( BytecodeGenerator &generator, RegisterID *dst )
{
    ...
    generator.emitJumpIfNotFunctionApply( function.get(), realCall.get() );
    {
        ...
        else
        {
            ...
            generator.emitCallVarargs( finalDestinationOrIgnored.get(), realFunction.get(), thisRegister.get(), argsCountRegister.get(),
                                       divot(), startOffset(), endOffset() );
        }
...
RegisterID *PostfixResolveNode::emitBytecode( BytecodeGenerator &generator, RegisterID *dst )
{
    ...
    if ( generator.findScopedProperty( m_ident, index, depth, true, requiresDynamicChecks, globalObject )
            && index != missingSymbolMarker() && !requiresDynamicChecks )
    {
...
RegisterID *PostfixBracketNode::emitBytecode( BytecodeGenerator &generator, RegisterID *dst )
{
    ...
    {
        oldValue = ( m_operator == OpPlusPlus ) ? generator.emitPostInc( generator.finalDestination( dst ),
                   value.get() ) : generator.emitPostDec( generator.finalDestination( dst ), value.get() );
    }
...
RegisterID *PrefixBracketNode::emitBytecode( BytecodeGenerator &generator, RegisterID *dst )
{
    ...
    generator.emitExpressionInfo( divot() + m_subexpressionDivotOffset, m_subexpressionStartOffset,
...
void LogicalNotNode::emitBytecodeInConditionContext( BytecodeGenerator &generator, Label *trueTarget, Label *falseTarget,
                                      ...
                                      ReadModifyResolveNode *emitExpressionInfoForMe )
{
    ...
    {
        generator.emitExpressionInfo( emitExpressionInfoForMe->divot(), emitExpressionInfoForMe->startOffset(),
                                      emitExpressionInfoForMe->endOffset() );
    }
    ...
    return generator.emitStrcat( generator.finalDestination( dst, temporaryRegisters[0].get() ), temporaryRegisters[0].get(),
                                 temporaryRegisters.size() );
}
...
RegisterID *BinaryOpNode::emitBytecode( BytecodeGenerator &generator, RegisterID *dst )
{
    ...
    return generator.emitBinaryOp( opcodeID, generator.finalDestination( dst, src1.get() ), src1.get(), src2,
                                   OperandTypes( m_expr1->resultDescriptor(), m_expr2->resultDescriptor() ) );
}
...
RegisterID *ReverseBinaryOpNode::emitBytecode( BytecodeGenerator &generator, RegisterID *dst )
{
    RefPtr<RegisterID> src1 = generator.emitNodeForLeftHandSide( m_expr1, m_rightHasAssignments, m_expr2->isPure( generator ) );
    RegisterID *src2 = generator.emitNode( m_expr2 );
    return generator.emitBinaryOp( opcodeID(), generator.finalDestination( dst, src1.get() ), src2, src1.get(),
                                   OperandTypes( m_expr2->resultDescriptor(), m_expr1->resultDescriptor() ) );
}
...
RegisterID *InstanceOfNode::emitBytecode( BytecodeGenerator &generator, RegisterID *dst )
{
    ...
    generator.emitExpressionInfo( divot(), startOffset(), endOffset() );
    RegisterID *src2Prototype = generator.emitGetById( generator.newTemporary(), src2.get(),
                                generator.globalData()->propertyNames->prototype );
...
void LogicalOpNode::emitBytecodeInConditionContext( BytecodeGenerator &generator, Label *trueTarget, Label *falseTarget,
        bool fallThroughMeansTrue )
{
...
static ALWAYS_INLINE RegisterID *emitReadModifyAssignment( BytecodeGenerator &generator, RegisterID *dst, RegisterID *src1,
        ExpressionNode *m_right, Operator oper, OperandTypes types, ReadModifyResolveNode *emitExpressionInfoForMe = 0 )
{
    OpcodeID opcodeID;
...
RegisterID *ReadModifyResolveNode::emitBytecode( BytecodeGenerator &generator, RegisterID *dst )
{
    if ( RegisterID *local = generator.registerFor( m_ident ) )
    {
        if ( generator.isLocalConstant( m_ident ) )
        {
            return emitReadModifyAssignment( generator, generator.finalDestination( dst ), local, m_right, m_operator,
        ...
        if ( generator.leftHandSideNeedsCopy( m_rightHasAssignments, m_right->isPure( generator ) ) )
        {
            ...
            emitReadModifyAssignment( generator, result.get(), result.get(), m_right, m_operator, OperandTypes( ResultType::unknownType(),
                                      m_right->resultDescriptor() ) );
            generator.emitMove( local, result.get() );
            return generator.moveToDestinationIfNeeded( dst, result.get() );
        }

        RegisterID *result = emitReadModifyAssignment( generator, local, local, m_right, m_operator,
                             OperandTypes( ResultType::unknownType(), m_right->resultDescriptor() ) );
            ...
            && index != missingSymbolMarker() && !requiresDynamicChecks )
    {
        ...
        RegisterID *result = emitReadModifyAssignment( generator, generator.finalDestination( dst, src1.get() ), src1.get(), m_right,
                             m_operator, OperandTypes( ResultType::unknownType(), m_right->resultDescriptor() ) );
    ...
    RegisterID *result = emitReadModifyAssignment( generator, generator.finalDestination( dst, src1.get() ), src1.get(), m_right,
                         m_operator, OperandTypes( ResultType::unknownType(), m_right->resultDescriptor() ), this );
...
RegisterID *ReadModifyDotNode::emitBytecode( BytecodeGenerator &generator, RegisterID *dst )
{
    ...
    RegisterID *updatedValue = emitReadModifyAssignment( generator, generator.finalDestination( dst, value.get() ), value.get(),
                               m_right, m_operator, OperandTypes( ResultType::unknownType(), m_right->resultDescriptor() ) );
...
{
    RefPtr<RegisterID> base = generator.emitNodeForLeftHandSide( m_base, m_subscriptHasAssignments
                              || m_rightHasAssignments, m_subscript->isPure( generator ) && m_right->isPure( generator ) );
    RefPtr<RegisterID> property = generator.emitNodeForLeftHandSide( m_subscript, m_rightHasAssignments,
                                  m_right->isPure( generator ) );
    RefPtr<RegisterID> value = generator.destinationForAssignResult( dst );
    RegisterID *result = generator.emitNode( value.get(), m_right );
...
RegisterID *ForInNode::emitBytecode( BytecodeGenerator &generator, RegisterID *dst )
{
    ...
    RefPtr<RegisterID> iter = generator.emitGetPropertyNames( generator.newTemporary(), base.get(), i.get(), size.get(),
                              scope->breakTarget() );
    generator.emitJump( scope->continueTarget() );
...
static void processClauseList( ClauseListNode *list, Vector<ExpressionNode *, 8> &literalVector, SwitchKind &typeForTable,
                               bool &singleCharacterSwitch, int32_t &min_num, int32_t &max_num )
{
...
SwitchInfo::SwitchType CaseBlockNode::tryOptimizedSwitch( Vector<ExpressionNode *, 8> &literalVector, int32_t &min_num,
        int32_t &max_num )
{
...
RegisterID *FunctionBodyNode::emitBytecode( BytecodeGenerator &generator, RegisterID * )
{
    ...
    if ( static_cast<BlockNode *>( singleStatement )->singleStatement() )
    {
        ...
        if ( returnValueExpression && returnValueExpression->isSubtract() )
        {
            ...
            {
                generator.setIsNumericCompareFunction( generator.argumentNumberFor( static_cast<ResolveNode *>
                                                       ( lhsExpression )->identifier() ) == 1
