...
public:
    ...
    {
        return Structure::create( globalData, proto, TypeInfo( StringType, OverridesGetOwnPropertySlot | NeedsThisConversion ),
...
private:
    ...
    unsigned fiberCount()
    {
        return m_fiberCount ? m_fiberCount : 1;
    }
...
inline JSString *jsSubstring( JSGlobalData *globalData, const UString &s, unsigned offset, unsigned length )
{
    ...
    return fixupVPtr( globalData, new ( globalData ) JSString( globalData, UString( StringImpl::create( s.impl(), offset, length ) ),
