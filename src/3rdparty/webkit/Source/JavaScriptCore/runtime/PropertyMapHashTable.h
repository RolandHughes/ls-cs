...
struct PropertyMapEntry
{
    ...
    PropertyMapEntry( JSGlobalData &globalData, JSCell *owner, StringImpl *key, unsigned offset, unsigned attributes,
...
inline PropertyTable::PropertyTable( JSGlobalData &globalData, JSCell *owner, unsigned initialCapacity,
...
inline unsigned PropertyTable::tableCapacity() const
{
    return m_indexSize >> 1;
}

inline unsigned PropertyTable::deletedEntryIndex() const
{
    return tableCapacity() + 1;
}
