...
{
    WTF_MAKE_NONCOPYABLE( ArgumentsData );
...
ALWAYS_INLINE void Arguments::getArgumentsData( CallFrame *callFrame, JSFunction *&function, ptrdiff_t &firstParameterIndex,
        Register *&argv, int &argc )
{
...
inline void JSActivation::copyRegisters( JSGlobalData &globalData )
{
    ...
    OwnArrayPtr<WriteBarrier<Unknown> > registerArray = copyRegisterArray( globalData, m_registers - registerOffset,
