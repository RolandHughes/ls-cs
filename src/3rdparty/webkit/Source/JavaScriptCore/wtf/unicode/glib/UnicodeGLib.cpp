...
static int convertCase( UChar *result, int resultLength, const UChar *src, int srcLength, bool *error,
                        UTF8CaseFunction caseFunction )
{
    *error = false;
    ...
    ConversionResult conversionResult = convertUTF16ToUTF8( &utf16Source, utf16Source + srcLength, &utf8Target,
                                        utf8Target + buffer.size(), true );
    ...
    conversionResult = convertUTF8ToUTF16( &utf8Source, utf8Source + utf8ResultLength, &utf16Target, utf16Target + resultLength,
                                           true );
