...
public:
    ...
    {
        return static_cast<AtomicStringImpl *>( m_string.impl() );
    }
    ...
    AtomicString upper() const
    {
        return AtomicString( impl()->upper() );
    }

    int toInt( bool *ok = nullptr ) const
    {
        return m_string.toInt( ok );
    }
    ...
    {
        return m_string.createCFString();
    }
#endif
#ifdef __OBJC__
