...
public:
    ...
    {
        return OBJECT_OFFSETOF( StringImpl, m_data );
    }
    ...
    {
        return m_refCountAndFlags & s_refCountFlagIsIdentifier;
    }
    ...
    bool hasTerminatingNullCharacter() const
    {
        return m_refCountAndFlags & s_refCountFlagHasTerminatingNullCharacter;
    }

    bool isAtomic() const
    {
        return m_refCountAndFlags & s_refCountFlagIsAtomic;
    }
    ...
    ALWAYS_INLINE void deref()
    {
        ...
        if ( !( m_refCountAndFlags & ( s_refCountMask | s_refCountFlagStatic ) ) )
        {
            delete this;
        }
    }
    ...
    {
        return ( m_refCountAndFlags & ( s_refCountMask | s_refCountFlagStatic ) ) == s_refCountIncrement;
    }
    ...
    {
        return ( caseSensitive ? reverseFind( str, 0 ) : reverseFindIgnoringCase( str, 0 ) ) == 0;
    }
...
private:
    ...
    {
        return static_cast<BufferOwnership>( m_refCountAndFlags & s_refCountMaskBufferOwnership );
    }
    bool isStatic() const
    {
        return m_refCountAndFlags & s_refCountFlagStatic;
    }
    const UChar *m_data;
    union
    {
