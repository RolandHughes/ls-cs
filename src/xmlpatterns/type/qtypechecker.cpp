...
bool TypeChecker::promotionPossible( const ItemType::Ptr &fromType, const ItemType::Ptr &toType,
...
Expression::Ptr TypeChecker::typeCheck( Expression *const op, const StaticContext::Ptr &context,
