...
void QScriptDebuggerCodeWidget: _q_onBreakpointsAboutToBeRemoved( const QModelIndex &un_named_arg1,int un_named_arg2,
        int un_named_arg3 )
{
    Q_D( QScriptDebuggerCodeWidget );
...
void QScriptDebuggerCodeWidget: _q_onToolTipRequest( const QPoint &un_named_arg1,int un_named_arg2,
