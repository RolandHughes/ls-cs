...
static QString numericEntity( int ch, bool makePhs )
{
    ...
    QString retval = QString( "<ph id=\"ph%1\" ctype=\"x-ch-%2\">\\%3</ph>" ).formatArg( ++id ).formatArg( name ).formatArg(
                         escapechar );
...
static void writeExtras( QTextStream &ts, int indent, const TranslatorMessage::ExtraData &extras,
