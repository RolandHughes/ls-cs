      ...
      m_fileActiveModel( -1 ), m_editActiveModel( -1 ), m_statistics( nullptr )
{
    ...
    connect( m_phraseView,                    &PhraseView::phraseSelected,                m_messageEditor,
             &MessageEditor::setTranslation );
...
void MainWindow::setupMenuBar()
{
    ...
    connect( m_ui.actionSettings,           &QAction::triggered, this, [this] ()
    {
        settingsDialog();
    } );
    ...
    connect( m_messageEditor,               &MessageEditor::beginFromSourceAvailable, m_ui.actionBeginFromSource,
             &QAction::setEnabled );
