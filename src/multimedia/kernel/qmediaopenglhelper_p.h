...
#if defined(Q_OS_WIN) && (defined(LSCS_OPENGL_ES_2) || defined(LSCS_OPENGL_DYNAMIC))
#include <EGL/egl.h>
#endif
...
#  ifdef LSCS_OPENGL_ES_2_ANGLE_STATIC
...
#  endif // LSCS_OPENGL_ES_2_ANGLE_STATIC

    }

# endif // Q_OS_WIN && (LSCS_OPENGL_ES_2 || LSCS_OPENGL_DYNAMIC)
