...
#ifndef LIB_LSCS_STRING_VIEW_H
#define LIB_LSCS_STRING_VIEW_H
...
template <typename S>
typename CsBasicStringView<S>::const_iterator CsBasicStringView<S>::rfind_fast( CsBasicStringView str,
