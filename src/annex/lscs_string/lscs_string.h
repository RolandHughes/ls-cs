...
#ifndef LIB_LSCS_STRING_H
#define LIB_LSCS_STRING_H
...
#include <lscs_char.h>
#include <lscs_string_iterator.h>
#include <lscs_encoding.h>
...
// constructors
template <typename E, typename A> CsBasicString<E, A>::CsBasicString( const CsBasicString &str, const A &a )
    : m_string( str.m_string, a )
{
}

template <typename E, typename A> CsBasicString<E, A>::CsBasicString( CsBasicString &&str, const A &a )
    : m_string( std::move( str.m_string ), a )
{
}

template <typename E, typename A>
template <typename T, typename> CsBasicString<E, A>::CsBasicString( const T &str, const A &a )
{
#ifndef LSCS_STRING_ALLOW_UNSAFE
...
template <typename E, typename A>
template <int N> CsBasicString<E, A>::CsBasicString( const char ( &str )[N], const A &a )
{
...
template <typename E, typename A>
template <typename T,  typename> CsBasicString<E, A>::CsBasicString( const T &str, size_type size, const A &a )
{
#ifndef LSCS_STRING_ALLOW_UNSAFE
    static_assert( ! std::is_same<E, E>::value, "Unsafe operations not allowed, unknown encoding for this operation" );
#endif
...
template <typename E, typename A>
template <int N> CsBasicString<E, A>::CsBasicString( const char ( &str )[N], size_type size, const A &a )
{
#if defined(Q_CC_MSVC)
    static_assert( "¿"[0] == static_cast<char>( 0xC2 ), "Compiler runtime encoding was not set to UTF-8" );
#endif
...
template <typename E, typename A> CsBasicString<E, A>::CsBasicString( const char16_t *str, const A &a )
{
    *this = CsBasicString::fromUtf16( str, -1, a );
}

template <typename E, typename A> CsBasicString<E, A>::CsBasicString( const char16_t *str, size_type size, const A &a )
{
    *this = CsBasicString::fromUtf16( str, size, a );
}

template <typename E, typename A> CsBasicString<E, A>::CsBasicString( const char32_t *str, const A &a )
    : m_string( 1, 0, a )
{
...
template <typename E, typename A> CsBasicString<E, A>::CsBasicString( const char32_t *str, size_type size, const A &a )
    : m_string( 1, 0, a )
{
    const char32_t *c = str;
...
template <typename E, typename A> CsBasicString<E, A>::CsBasicString( const CsBasicString &str, size_type indexStart, const A &a )
    : m_string( 1, 0, a )
{
...
template <typename E, typename A> CsBasicString<E, A>::CsBasicString( const CsBasicString &str, size_type indexStart,
        size_type size, const A &a )
    : m_string( 1, 0, a )
{
    const_iterator iter_begin = str.cbegin();
...
template <typename E, typename A> CsBasicString<E, A>::CsBasicString( size_type count, CsChar c, const A &a )
    : m_string( 1, 0, a )
{
...
template <typename E, typename A>
template <typename U, typename> CsBasicString<E, A>::CsBasicString( CsBasicStringView<U> str, const A &a )
...
template <typename E, typename A>
template <typename U,  typename> CsBasicString<E, A>::CsBasicString( CsBasicStringView<U> str, size_type indexStart,
        size_type size, const A &a )
    : m_string( 1, 0, a )
{
    static_assert( std::is_base_of<CsBasicString<E,A>, U>::value,
...
template <typename E, typename A>
template <typename Iterator> CsBasicString<E, A>::CsBasicString( Iterator begin, Iterator end, const A &a )
    : m_string( 1, 0, a )
{
...
template <typename E, typename A> CsBasicString<E, A>::CsBasicString( const_iterator begin, const_iterator end, const A &a )
...
template <typename E, typename A> CsBasicString<E, A>::CsBasicString( const char8_t *str, const A &a )
{
    *this = CsBasicString::fromUtf8( str, -1, a );
}

template <typename E, typename A> CsBasicString<E, A>::CsBasicString( const char8_t *str, size_type size, const A &a )
{
    *this = CsBasicString::fromUtf8( str, size, a );
}
#endif
