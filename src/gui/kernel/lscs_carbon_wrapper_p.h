...
#ifndef LSCS_CARBON_WRAPPER_P_H
#define LSCS_CARBON_WRAPPER_P_H
...
using LSCS_FontUIFontType             = uint32_t;
...
//OSStatus LSCS_ATSFontActivateFromFileSpecification(const FSSpec *spec, ATSFontContext context, ATSFontFormat format, void *reserved,
