...
{
    GUI_LSCS_OBJECT( QAbstractButton )
    ...
    GUI_LSCS_PROPERTY_READ( autoExclusive, autoExclusive )
    GUI_LSCS_PROPERTY_WRITE( autoExclusive, setAutoExclusive )

    GUI_LSCS_PROPERTY_READ( autoRepeatDelay, autoRepeatDelay )
    GUI_LSCS_PROPERTY_WRITE( autoRepeatDelay, setAutoRepeatDelay )

    GUI_LSCS_PROPERTY_READ( autoRepeatInterval, autoRepeatInterval )
    GUI_LSCS_PROPERTY_WRITE( autoRepeatInterval, setAutoRepeatInterval )

    GUI_LSCS_PROPERTY_READ( down, isDown )
    GUI_LSCS_PROPERTY_WRITE( down, setDown )
    GUI_LSCS_PROPERTY_DESIGNABLE( down, false )
...
public:
    ...
    GUI_LSCS_SLOT_1( Public, void setIconSize( const QSize &size ) )
    GUI_LSCS_SLOT_2( setIconSize )

    GUI_LSCS_SLOT_1( Public, void animateClick( int msec = 100 ) )
    GUI_LSCS_SLOT_2( animateClick )

    GUI_LSCS_SLOT_1( Public, void click() )
    GUI_LSCS_SLOT_2( click )
    ...
    GUI_LSCS_SIGNAL_1( Public, void pressed() )
    GUI_LSCS_SIGNAL_2( pressed )

    GUI_LSCS_SIGNAL_1( Public, void released() )
    GUI_LSCS_SIGNAL_2( released )

    GUI_LSCS_SIGNAL_1( Public, void clicked( bool checked = false ) )
    GUI_LSCS_SIGNAL_2( clicked, checked )

    GUI_LSCS_SIGNAL_1( Public, void toggled( bool checked ) )
    GUI_LSCS_SIGNAL_2( toggled, checked )
