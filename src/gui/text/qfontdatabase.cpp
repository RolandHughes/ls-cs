...
static int getFontWeight( const QString &weightString )
{
    ...
    if ( s1.compare( QCoreApplication::translate( "QFontDatabase", "Normal", "Normal or Regular font weight" ),
                                      ...
                                      QtFontFamily *family, QtFontFoundry *foundry, QtFontStyle *style, QtFontSize *size )
{
    ...
    if ( ! engine )
    {
        ...
        if ( style->key.stretch != 0 && request.stretch != 0 && ( request.styleName.isEmpty()
