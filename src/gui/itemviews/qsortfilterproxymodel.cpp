...
void QSortFilterProxyModel::setSourceModel( QAbstractItemModel *sourceModel )
{
    ...
    disconnect( d->model, &QAbstractItemModel::rowsAboutToBeInserted,    this,
                &QSortFilterProxyModel::_q_sourceRowsAboutToBeInserted );
    disconnect( d->model, &QAbstractItemModel::rowsInserted,             this, &QSortFilterProxyModel::_q_sourceRowsInserted );
    disconnect( d->model, &QAbstractItemModel::columnsAboutToBeInserted, this,
                &QSortFilterProxyModel::_q_sourceColumnsAboutToBeInserted );
    disconnect( d->model, &QAbstractItemModel::columnsInserted,          this, &QSortFilterProxyModel::_q_sourceColumnsInserted );

    disconnect( d->model, &QAbstractItemModel::rowsAboutToBeRemoved,     this,
                &QSortFilterProxyModel::_q_sourceRowsAboutToBeRemoved );
    disconnect( d->model, &QAbstractItemModel::rowsRemoved,              this, &QSortFilterProxyModel::_q_sourceRowsRemoved );
    disconnect( d->model, &QAbstractItemModel::columnsAboutToBeRemoved,  this,
                &QSortFilterProxyModel::_q_sourceColumnsAboutToBeRemoved );
    ...
    disconnect( d->model, &QAbstractItemModel::columnsAboutToBeMoved,    this,
                &QSortFilterProxyModel::_q_sourceColumnsAboutToBeMoved );
    disconnect( d->model, &QAbstractItemModel::columnsMoved,             this, &QSortFilterProxyModel::_q_sourceColumnsMoved );

    disconnect( d->model, &QAbstractItemModel::layoutAboutToBeChanged,   this,
                &QSortFilterProxyModel::_q_sourceLayoutAboutToBeChanged );
    ...
    connect( d->model, &QAbstractItemModel::columnsAboutToBeInserted, this,
             &QSortFilterProxyModel::_q_sourceColumnsAboutToBeInserted );
    ...
    connect( d->model, &QAbstractItemModel::columnsAboutToBeRemoved,  this,
             &QSortFilterProxyModel::_q_sourceColumnsAboutToBeRemoved );
