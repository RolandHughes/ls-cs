...
static void lscs_qimageScaleAARGBA_up_x_down_y( QImageScaleInfo *isi, unsigned int *dest,
        int dw, int dh, int dow, int sow );

static void lscs_qimageScaleAARGBA_down_x_up_y( QImageScaleInfo *isi, unsigned int *dest,
        int dw, int dh, int dow, int sow );

static void lscs_qimageScaleAARGBA_down_xy( QImageScaleInfo *isi, unsigned int *dest,
        int dw, int dh, int dow, int sow );

#if defined(LSCS_COMPILER_SUPPORTS_SSE4_1)

template <bool RGB>
void lscs_qimageScaleAARGBA_up_x_down_y_sse4( QImageScaleInfo *isi, unsigned int *dest,
        int dw, int dh, int dow, int sow );

template <bool RGB>
void lscs_qimageScaleAARGBA_down_x_up_y_sse4( QImageScaleInfo *isi, unsigned int *dest,
        int dw, int dh, int dow, int sow );
                                    ...
                                    int dw, int dh, int dow, int sow )
{
    ...
    if ( isi->xup_yup == 3 )
    {
        lscs_qimageScaleAARGBA_up_xy( isi, dest, dw, dh, dow, sow );
    }
    ...
    else if ( isi->xup_yup == 1 )
    {
        ...
        {
            lscs_qimageScaleAARGBA_up_x_down_y_sse4<false>( isi, dest, dw, dh, dow, sow );
        }
        else
#endif

            lscs_qimageScaleAARGBA_up_x_down_y( isi, dest, dw, dh, dow, sow );
    }
    ...
    else if ( isi->xup_yup == 2 )
    {
        ...
        if ( qCpuHasFeature( SSE4_1 ) )
        {
            lscs_qimageScaleAARGBA_down_x_up_y_sse4<false>( isi, dest, dw, dh, dow, sow );
        }
        else
#endif
            lscs_qimageScaleAARGBA_down_x_up_y( isi, dest, dw, dh, dow, sow );
    }
    ...
    else
    {
        ...
        if ( qCpuHasFeature( SSE4_1 ) )
        {
            lscs_qimageScaleAARGBA_down_xy_sse4<false>( isi, dest, dw, dh, dow, sow );
        }
        else
#endif
            lscs_qimageScaleAARGBA_down_xy( isi, dest, dw, dh, dow, sow );
    }
}

static inline void lscs_qimageScaleAARGBA_helper( const unsigned int *pix, int xyap, int Cxy,
        ...
        int dw, int dh, int dow, int sow )
{
    ...
    for ( int y = 0; y < dh; y++ )
    {
        ...
        for ( int x = 0; x < dw; x++ )
        {
            ...
            int r, g, b, a;
            lscs_qimageScaleAARGBA_helper( sptr, yap, Cy, sow, r, g, b, a );
            ...
            {
                int rr, gg, bb, aa;
                lscs_qimageScaleAARGBA_helper( sptr + 1, yap, Cy, sow, rr, gg, bb, aa );
        ...
        int dw, int dh, int dow, int sow )
{
    ...
    for ( int y = 0; y < dh; y++ )
    {
        ...
        for ( int x = 0; x < dw; x++ )
        {
            ...
            const unsigned int *sptr = ypoints[y] + xpoints[x];
            int r, g, b, a;
            lscs_qimageScaleAARGBA_helper( sptr, xap, Cx, 1, r, g, b, a );
            ...
            {
                int rr, gg, bb, aa;
                lscs_qimageScaleAARGBA_helper( sptr + sow, xap, Cx, 1, rr, gg, bb, aa );
        ...
        int dw, int dh, int dow, int sow )
{
    ...
    for ( int y = 0; y < dh; y++ )
    {
        ...
        for ( int x = 0; x < dw; x++ )
        {
            ...
            const unsigned int *sptr = ypoints[y] + xpoints[x];
            int rx, gx, bx, ax;
            lscs_qimageScaleAARGBA_helper( sptr, xap, Cx, 1, rx, gx, bx, ax );
...
static void lscs_qimageScaleAARGB_up_x_down_y( QImageScaleInfo *isi, unsigned int *dest,
        int dw, int dh, int dow, int sow );

static void lscs_qimageScaleAARGB_down_x_up_y( QImageScaleInfo *isi, unsigned int *dest,
        int dw, int dh, int dow, int sow );

static void lscs_qimageScaleAARGB_down_xy( QImageScaleInfo *isi, unsigned int *dest,
        int dw, int dh, int dow, int sow );
                                   ...
                                   int dw, int dh, int dow, int sow )
{
    ...
    else if ( isi->xup_yup == 1 )
    {
        ...
        if ( qCpuHasFeature( SSE4_1 ) )
        {
            lscs_qimageScaleAARGBA_up_x_down_y_sse4<true>( isi, dest, dw, dh, dow, sow );
        }
        else
#endif
            lscs_qimageScaleAARGB_up_x_down_y( isi, dest, dw, dh, dow, sow );
    }
    ...
    else if ( isi->xup_yup == 2 )
    {
        ...
        if ( qCpuHasFeature( SSE4_1 ) )
        {
            lscs_qimageScaleAARGBA_down_x_up_y_sse4<true>( isi, dest, dw, dh, dow, sow );
        }
        else
#endif
            lscs_qimageScaleAARGB_down_x_up_y( isi, dest, dw, dh, dow, sow );
    }
    ...
    else
    {
        ...
        if ( qCpuHasFeature( SSE4_1 ) )
        {
            lscs_qimageScaleAARGBA_down_xy_sse4<true>( isi, dest, dw, dh, dow, sow );
        }
        else
#endif
            lscs_qimageScaleAARGB_down_xy( isi, dest, dw, dh, dow, sow );
    }
}

static inline void lscs_qimageScaleAARGB_helper( const unsigned int *pix, int xyap, int Cxy,
        ...
        int dw, int dh, int dow, int sow )
{
    ...
    for ( int y = 0; y < dh; y++ )
    {
        ...
        for ( int x = 0; x < dw; x++ )
        {
            const unsigned int *sptr = ypoints[y] + xpoints[x];
            int r, g, b;
            lscs_qimageScaleAARGB_helper( sptr, yap, Cy, sow, r, g, b );
            ...
            {
                int rr, bb, gg;
                lscs_qimageScaleAARGB_helper( sptr + 1, yap, Cy, sow, rr, gg, bb );
        ...
        int dw, int dh, int dow, int sow )
{
    ...
    for ( int y = 0; y < dh; y++ )
    {
        ...
        for ( int x = 0; x < dw; x++ )
        {
            ...
            const unsigned int *sptr = ypoints[y] + xpoints[x];
            int r, g, b;
            lscs_qimageScaleAARGB_helper( sptr, xap, Cx, 1, r, g, b );
            ...
            {
                int rr, bb, gg;
                lscs_qimageScaleAARGB_helper( sptr + sow, xap, Cx, 1, rr, gg, bb );
        ...
        int dw, int dh, int dow, int sow )
{
    ...
    for ( int y = 0; y < dh; y++ )
    {
        ...
        for ( int x = 0; x < dw; x++ )
        {
            ...
            const unsigned int *sptr = ypoints[y] + xpoints[x];
            int rx, gx, bx;
            lscs_qimageScaleAARGB_helper( sptr, xap, Cx, 1, rx, gx, bx );
