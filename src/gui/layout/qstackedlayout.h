...
{
    GUI_LSCS_OBJECT( QStackedLayout )

    GUI_LSCS_ENUM( StackingMode )
    ...
    GUI_LSCS_PROPERTY_READ( stackingMode, stackingMode )
    GUI_LSCS_PROPERTY_WRITE( stackingMode, setStackingMode )
