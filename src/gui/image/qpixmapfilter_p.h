...
{
    GUI_LSCS_OBJECT( QPixmapConvolutionFilter )
...
{
    GUI_LSCS_OBJECT( QPixmapBlurFilter )
...
{
    GUI_LSCS_OBJECT( QPixmapColorizeFilter )
...
{
    GUI_LSCS_OBJECT( QPixmapDropShadowFilter )
