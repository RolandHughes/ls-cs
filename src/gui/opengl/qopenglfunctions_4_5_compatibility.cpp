...
QOpenGLFunctions_4_5_Compatibility::~QOpenGLFunctions_4_5_Compatibility()
{
    ...
    {
        QAbstractOpenGLFunctionsPrivate::removeFunctionsBackend( d_1_0_Deprecated->context,
    ...
    {
        QAbstractOpenGLFunctionsPrivate::removeFunctionsBackend( d_1_1_Deprecated->context,
    ...
    {
        QAbstractOpenGLFunctionsPrivate::removeFunctionsBackend( d_1_2_Deprecated->context,
    ...
    {
        QAbstractOpenGLFunctionsPrivate::removeFunctionsBackend( d_1_3_Deprecated->context,
    ...
    {
        QAbstractOpenGLFunctionsPrivate::removeFunctionsBackend( d_1_4_Deprecated->context,
    ...
    {
        QAbstractOpenGLFunctionsPrivate::removeFunctionsBackend( d_3_3_Deprecated->context,
    ...
    {
        QAbstractOpenGLFunctionsPrivate::removeFunctionsBackend( d_4_5_Deprecated->context,
                QOpenGLFunctions_4_5_DeprecatedBackend::versionStatus() );
