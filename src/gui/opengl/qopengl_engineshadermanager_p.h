...
static constexpr const GLuint LSCS_VERTEX_COORDS_ATTR  = 0;
static constexpr const GLuint LSCS_TEXTURE_COORDS_ATTR = 1;
static constexpr const GLuint LSCS_OPACITY_ATTR        = 2;
static constexpr const GLuint LSCS_PMV_MATRIX_1_ATTR   = 3;
static constexpr const GLuint LSCS_PMV_MATRIX_2_ATTR   = 4;
static constexpr const GLuint LSCS_PMV_MATRIX_3_ATTR   = 5;
