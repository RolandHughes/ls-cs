...
static const QGStreamerMetaDataKeys *qt_gstreamerMetaDataKeys()
{
    if ( metadataKeys()->isEmpty() )
    {
...
#if GST_CHECK_VERSION(0,10,30)
        // Photos
        metadataKeys()->append( QGStreamerMetaDataKey( QMediaMetaData::CameraManufacturer, GST_TAG_DEVICE_MANUFACTURER,
                                QVariant::String ) );
        ...
        metadataKeys()->append( QGStreamerMetaDataKey( QMediaMetaData::GPSTrack, GST_TAG_GEO_LOCATION_MOVEMENT_DIRECTION,
                                QVariant::Double ) );
        metadataKeys()->append( QGStreamerMetaDataKey( QMediaMetaData::GPSSpeed, GST_TAG_GEO_LOCATION_MOVEMENT_SPEED,
                                QVariant::Double ) );
        metadataKeys()->append( QGStreamerMetaDataKey( QMediaMetaData::GPSImgDirection, GST_TAG_GEO_LOCATION_CAPTURE_DIRECTION,
                                QVariant::Double ) );
#endif
    }
