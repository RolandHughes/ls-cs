    ...
    : QObject( parent ), m_resourceSet( NoResources ), m_releasingResources( false ), m_canCapture( false )
{
    ...
    connect( m_resource, &ResourcePolicy::ResourceSet::resourcesGranted,         this,
             &CamerabinResourcePolicy::handleResourcesGranted );
    connect( m_resource, &ResourcePolicy::ResourceSet::resourcesDenied,          this, &CamerabinResourcePolicy::resourcesDenied );
    connect( m_resource, &ResourcePolicy::ResourceSet::lostResources,            this,
             &CamerabinResourcePolicy::handleResourcesLost );
    connect( m_resource, &ResourcePolicy::ResourceSet::resourcesReleased,        this,
             &CamerabinResourcePolicy::handleResourcesReleased );
