    ...
    , m_pendingSeekPosition( -1 ), m_setMediaPending( false ), m_stream( nullptr )
{
    ...
    connect( m_resources, &QMediaPlayerResourceSetInterface::resourcesGranted, this,
             &QGstreamerPlayerControl::handleResourcesGranted );
    ...
    connect( m_resources, &QMediaPlayerResourceSetInterface::resourcesDenied,  this, &QGstreamerPlayerControl::handleResourcesDenied,
             Qt::QueuedConnection );
