...
static xcb_translate_coordinates_reply_t *translateCoordinates( QXcbConnection *c, xcb_window_t from, xcb_window_t to, int x,
        int y )
{
...
static bool windowInteractsWithPosition( xcb_connection_t *connection, const QPoint &pos, xcb_window_t w,
