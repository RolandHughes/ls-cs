...
QWindowsUser32DLL::QWindowsUser32DLL()
    : setLayeredWindowAttributes( nullptr ), updateLayeredWindow( nullptr ), updateLayeredWindowIndirect( nullptr ),
      ...
      getTouchInputInfo( nullptr ), closeTouchInputHandle( nullptr ), setProcessDPIAware( nullptr ),
      addClipboardFormatListener( nullptr ),
      removeClipboardFormatListener( nullptr ), getDisplayAutoRotationPreferences( nullptr ),
      setDisplayAutoRotationPreferences( nullptr )
{
}
