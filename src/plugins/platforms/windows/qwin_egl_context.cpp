...
bool QWindowsLibEGL::init()
{
    ...
    eglChooseConfig         = RESOLVE( ( EGLBoolean ( EGLAPIENTRY * )( EGLDisplay, const EGLint *, EGLConfig *, EGLint, EGLint * ) ),
                                       eglChooseConfig );
    eglGetConfigAttrib      = RESOLVE( ( EGLBoolean ( EGLAPIENTRY * )( EGLDisplay, EGLConfig, EGLint, EGLint * ) ),
                                       eglGetConfigAttrib );
    eglCreateWindowSurface  = RESOLVE( ( EGLSurface ( EGLAPIENTRY * )( EGLDisplay, EGLConfig, EGLNativeWindowType, const EGLint * ) ),
                                       eglCreateWindowSurface );
    eglCreatePbufferSurface = RESOLVE( ( EGLSurface ( EGLAPIENTRY * )( EGLDisplay, EGLConfig, const EGLint * ) ),
    ...
    eglCreateContext        = RESOLVE( ( EGLContext ( EGLAPIENTRY * )( EGLDisplay, EGLConfig, EGLContext, const EGLint * ) ),
                                       eglCreateContext );
    eglDestroyContext       = RESOLVE( ( EGLBoolean ( EGLAPIENTRY * )( EGLDisplay, EGLContext ) ), eglDestroyContext );
    eglMakeCurrent          = RESOLVE( ( EGLBoolean ( EGLAPIENTRY * )( EGLDisplay, EGLSurface, EGLSurface, EGLContext ) ),
                                       eglMakeCurrent );
...
bool QWindowsLibGLESv2::init()
{
    ...
    glCopyTexImage2D = RESOLVE( ( void ( APIENTRY * )( GLenum, GLint, GLenum, GLint, GLint, GLsizei, GLsizei, GLint ) ),
                                glCopyTexImage2D );
    glCopyTexSubImage2D = RESOLVE( ( void ( APIENTRY * )( GLenum, GLint, GLint, GLint, GLint, GLint, GLsizei, GLsizei ) ),
                                   glCopyTexSubImage2D );
    ...
    glBufferSubData = RESOLVE( ( void ( APIENTRY * )( GLenum, qopengl_GLintptr, qopengl_GLsizeiptr, const GLvoid * ) ),
                               glBufferSubData );
    ...
    glCompressedTexImage2D = RESOLVE( ( void ( APIENTRY * )( GLenum, GLint, GLenum, GLsizei, GLsizei, GLint, GLsizei,
                                        const GLvoid * ) ),
    ...
    glGetActiveAttrib = RESOLVE( ( void ( APIENTRY * )( GLuint, GLuint, GLsizei, GLsizei *, GLint *, GLenum *, GLchar * ) ),
                                 glGetActiveAttrib );
    ...
    : m_staticContext( staticContext ), m_eglDisplay( staticContext->display() ), m_api( EGL_OPENGL_ES_API ), m_swapInterval( -1 )
{
    ...
    m_eglContext = QWindowsEGLStaticContext::libEGL.eglCreateContext( m_eglDisplay, m_eglConfig, m_shareContext,
                   contextAttrs.constData() );
