...
#define QT_USE_APPROXIMATE_CURSORS
   ...
   switch (cursor->shape()) {
      ...
      case Qt::WaitCursor: {
         QPixmap pixmap = QPixmap(QLatin1String("/ls-cs/mac/cursors/images/spincursor.png"));
         return createCursorFromPixmap(pixmap, hotspot);
         break;
      }

      case Qt::SizeAllCursor: {
         QPixmap pixmap = QPixmap(QLatin1String("/ls-cs/mac/cursors/images/sizeallcursor.png"));
         return createCursorFromPixmap(pixmap, QPoint(8, 8));
         break;
      }

      case Qt::BusyCursor: {
         QPixmap pixmap = QPixmap(QLatin1String("/ls-cs/mac/cursors/images/waitcursor.png"));
         return createCursorFromPixmap(pixmap, hotspot);
         break;
      }

      case Qt::ForbiddenCursor: {
         QPixmap pixmap = QPixmap(QLatin1String("/ls-cs/mac/cursors/images/forbiddencursor.png"));
         return createCursorFromPixmap(pixmap, hotspot);
         break;
      }
