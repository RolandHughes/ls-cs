...
if(BUILD_PLATFORMS_COCOA_PLUGIN)
   ...
   target_link_libraries(LsCsGuiCocoa
      PRIVATE
      LsCsCore
      LsCsGui
      -lcups
   ...
   target_include_directories(LsCsGuiCocoa
      PRIVATE
   ...
   function_generate_resources(LsCsGuiCocoa)

   install(TARGETS LsCsGuiCocoa DESTINATION ${CMAKE_INSTALL_LIBDIR})
endif()
