...
#define XMLERR_OK                         lscs_mark_tr("QXml", "no error occurred")
#define XMLERR_ERRORBYCONSUMER            lscs_mark_tr("QXml", "error triggered by consumer")
#define XMLERR_UNEXPECTEDEOF              lscs_mark_tr("QXml", "unexpected end of file")
#define XMLERR_MORETHANONEDOCTYPE         lscs_mark_tr("QXml", "more than one document type definition")
#define XMLERR_ERRORPARSINGELEMENT        lscs_mark_tr("QXml", "error occurred while parsing element")
#define XMLERR_TAGMISMATCH                lscs_mark_tr("QXml", "tag mismatch")
#define XMLERR_ERRORPARSINGCONTENT        lscs_mark_tr("QXml", "error occurred while parsing content")
#define XMLERR_UNEXPECTEDCHARACTER        lscs_mark_tr("QXml", "unexpected character")
#define XMLERR_INVALIDNAMEFORPI           lscs_mark_tr("QXml", "invalid name for processing instruction")
#define XMLERR_VERSIONEXPECTED            lscs_mark_tr("QXml", "version expected while reading the XML declaration")
#define XMLERR_WRONGVALUEFORSDECL         lscs_mark_tr("QXml", "wrong value for standalone declaration")
#define XMLERR_EDECLORSDDECLEXPECTED      lscs_mark_tr("QXml", "encoding declaration or standalone declaration expected while reading the XML declaration")
#define XMLERR_SDDECLEXPECTED             lscs_mark_tr("QXml", "standalone declaration expected while reading the XML declaration")
#define XMLERR_ERRORPARSINGDOCTYPE        lscs_mark_tr("QXml", "error occurred while parsing document type definition")
#define XMLERR_LETTEREXPECTED             lscs_mark_tr("QXml", "letter is expected")
#define XMLERR_ERRORPARSINGCOMMENT        lscs_mark_tr("QXml", "error occurred while parsing comment")
#define XMLERR_ERRORPARSINGREFERENCE      lscs_mark_tr("QXml", "error occurred while parsing reference")
#define XMLERR_INTERNALGENERALENTITYINDTD lscs_mark_tr("QXml", "internal general entity reference not allowed in DTD")
#define XMLERR_EXTERNALGENERALENTITYINAV  lscs_mark_tr("QXml", "external parsed general entity reference not allowed in attribute value")
#define XMLERR_EXTERNALGENERALENTITYINDTD lscs_mark_tr("QXml", "external parsed general entity reference not allowed in DTD")
#define XMLERR_UNPARSEDENTITYREFERENCE    lscs_mark_tr("QXml", "unparsed entity reference in wrong context")
#define XMLERR_RECURSIVEENTITIES          lscs_mark_tr("QXml", "recursive entities")
#define XMLERR_ERRORINTEXTDECL            lscs_mark_tr("QXml", "error in the text declaration of an external entity")
...
#if defined(LSCS_SHOW_DEBUG_XML)
...
bool QXmlSimpleReaderPrivate::insertXmlRef( const QString &data, const QString &name, bool inLiteral )
{
    ...
    {
        QString tmp = data;
        xmlRefStack.push( XmlRef( name, tmp.replace( QChar( '\"' ), QString( "&quot;" ) ).replace( QChar( '\'' ),
                                  QString( "&apos;" ) ) ) );
    }
    else
    {
