...
QDeclarativeAbstractBinding *QDeclarativePropertyPrivate::binding( QObject *object, int coreIndex, int valueTypeIndex )
{
...
QDeclarativeAbstractBinding *QDeclarativePropertyPrivate::setBinding( QObject *object, int coreIndex, int valueTypeIndex,
...
QDeclarativeAbstractBinding *QDeclarativePropertyPrivate::setBindingNoEnable( QObject *object, int coreIndex, int valueTypeIndex,
        QDeclarativeAbstractBinding *newBinding )
{
    QDeclarativeData *data = QDeclarativeData::get( object, 0 != newBinding );
    QDeclarativeAbstractBinding *binding = 0;
...
QDeclarativeProperty QDeclarativePropertyPrivate::restore( const QByteArray &data, QObject *object,
