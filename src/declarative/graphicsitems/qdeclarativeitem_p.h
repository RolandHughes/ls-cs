...
{
    DECL_LSCS_OBJECT( QDeclarativeContents )
public:
...
public:
    DECL_LSCS_SIGNAL_1( Public, void rectChanged( QRectF un_named_arg1 ) )
    DECL_LSCS_SIGNAL_2( rectChanged, un_named_arg1 )
...
{
    DECL_LSCS_OBJECT( QDeclarativeKeyNavigationAttached )
    ...
    DECL_LSCS_PROPERTY_READ( *up, up )
    DECL_LSCS_PROPERTY_WRITE( *up, setUp )
    DECL_LSCS_PROPERTY_NOTIFY( *up, upChanged )
    DECL_LSCS_PROPERTY_READ( *down, down )
    DECL_LSCS_PROPERTY_WRITE( *down, setDown )
    DECL_LSCS_PROPERTY_NOTIFY( *down, downChanged )
    DECL_LSCS_PROPERTY_READ( *tab, tab )
    DECL_LSCS_PROPERTY_WRITE( *tab, setTab )
    DECL_LSCS_PROPERTY_NOTIFY( *tab, tabChanged )
    DECL_LSCS_PROPERTY_READ( *backtab, backtab )
    DECL_LSCS_PROPERTY_WRITE( *backtab, setBacktab )
    DECL_LSCS_PROPERTY_NOTIFY( *backtab, backtabChanged )
    DECL_LSCS_PROPERTY_READ( priority, priority )
    DECL_LSCS_PROPERTY_WRITE( priority, setPriority )
    DECL_LSCS_PROPERTY_NOTIFY( priority, priorityChanged )

    DECL_LSCS_ENUM( Priority )
...
public:
    ...
    DECL_LSCS_SIGNAL_1( Public, void upChanged() )
    DECL_LSCS_SIGNAL_2( upChanged )
    DECL_LSCS_SIGNAL_1( Public, void downChanged() )
    DECL_LSCS_SIGNAL_2( downChanged )
    DECL_LSCS_SIGNAL_1( Public, void tabChanged() )
    DECL_LSCS_SIGNAL_2( tabChanged )
    DECL_LSCS_SIGNAL_1( Public, void backtabChanged() )
    DECL_LSCS_SIGNAL_2( backtabChanged )
    DECL_LSCS_SIGNAL_1( Public, void priorityChanged() )
    DECL_LSCS_SIGNAL_2( priorityChanged )
...
{
    DECL_LSCS_OBJECT( QDeclarativeLayoutMirroringAttached )
    DECL_LSCS_PROPERTY_READ( enabled, enabled )
    DECL_LSCS_PROPERTY_WRITE( enabled, setEnabled )
    DECL_LSCS_PROPERTY_RESET( enabled, resetEnabled )
    DECL_LSCS_PROPERTY_NOTIFY( enabled, enabledChanged )
    DECL_LSCS_PROPERTY_READ( childrenInherit, childrenInherit )
    DECL_LSCS_PROPERTY_WRITE( childrenInherit, setChildrenInherit )
    DECL_LSCS_PROPERTY_NOTIFY( childrenInherit, childrenInheritChanged )
...
public:
    ...
    DECL_LSCS_SIGNAL_1( Public, void childrenInheritChanged() )
    DECL_LSCS_SIGNAL_2( childrenInheritChanged )
...
{
    DECL_LSCS_OBJECT( QDeclarativeKeysAttached )
    Q_DECLARE_PRIVATE( QDeclarativeKeysAttached )

    DECL_LSCS_PROPERTY_READ( enabled, enabled )
    DECL_LSCS_PROPERTY_WRITE( enabled, setEnabled )
    DECL_LSCS_PROPERTY_NOTIFY( enabled, enabledChanged )
    DECL_LSCS_PROPERTY_READ( forwardTo, forwardTo )
    DECL_LSCS_PROPERTY_READ( priority, priority )
    DECL_LSCS_PROPERTY_WRITE( priority, setPriority )
    DECL_LSCS_PROPERTY_NOTIFY( priority, priorityChanged )
...
public:
    ...
    DECL_LSCS_SIGNAL_1( Public, void priorityChanged() )
    DECL_LSCS_SIGNAL_2( priorityChanged )
    DECL_LSCS_SIGNAL_1( Public, void pressed( QDeclarativeKeyEvent *event ) )
    DECL_LSCS_SIGNAL_2( pressed, event )
    DECL_LSCS_SIGNAL_1( Public, void released( QDeclarativeKeyEvent *event ) )
    DECL_LSCS_SIGNAL_2( released, event )
    DECL_LSCS_SIGNAL_1( Public, void digit0Pressed( QDeclarativeKeyEvent *event ) )
    DECL_LSCS_SIGNAL_2( digit0Pressed, event )
    DECL_LSCS_SIGNAL_1( Public, void digit1Pressed( QDeclarativeKeyEvent *event ) )
    DECL_LSCS_SIGNAL_2( digit1Pressed, event )
    DECL_LSCS_SIGNAL_1( Public, void digit2Pressed( QDeclarativeKeyEvent *event ) )
    DECL_LSCS_SIGNAL_2( digit2Pressed, event )
    DECL_LSCS_SIGNAL_1( Public, void digit3Pressed( QDeclarativeKeyEvent *event ) )
    DECL_LSCS_SIGNAL_2( digit3Pressed, event )
    DECL_LSCS_SIGNAL_1( Public, void digit4Pressed( QDeclarativeKeyEvent *event ) )
    DECL_LSCS_SIGNAL_2( digit4Pressed, event )
    DECL_LSCS_SIGNAL_1( Public, void digit5Pressed( QDeclarativeKeyEvent *event ) )
    DECL_LSCS_SIGNAL_2( digit5Pressed, event )
    DECL_LSCS_SIGNAL_1( Public, void digit6Pressed( QDeclarativeKeyEvent *event ) )
    DECL_LSCS_SIGNAL_2( digit6Pressed, event )
    DECL_LSCS_SIGNAL_1( Public, void digit7Pressed( QDeclarativeKeyEvent *event ) )
    DECL_LSCS_SIGNAL_2( digit7Pressed, event )
    DECL_LSCS_SIGNAL_1( Public, void digit8Pressed( QDeclarativeKeyEvent *event ) )
    DECL_LSCS_SIGNAL_2( digit8Pressed, event )
    DECL_LSCS_SIGNAL_1( Public, void digit9Pressed( QDeclarativeKeyEvent *event ) )
    DECL_LSCS_SIGNAL_2( digit9Pressed, event )

    DECL_LSCS_SIGNAL_1( Public, void leftPressed( QDeclarativeKeyEvent *event ) )
    DECL_LSCS_SIGNAL_2( leftPressed, event )
    DECL_LSCS_SIGNAL_1( Public, void rightPressed( QDeclarativeKeyEvent *event ) )
    DECL_LSCS_SIGNAL_2( rightPressed, event )
    DECL_LSCS_SIGNAL_1( Public, void upPressed( QDeclarativeKeyEvent *event ) )
    DECL_LSCS_SIGNAL_2( upPressed, event )
    DECL_LSCS_SIGNAL_1( Public, void downPressed( QDeclarativeKeyEvent *event ) )
    DECL_LSCS_SIGNAL_2( downPressed, event )
    DECL_LSCS_SIGNAL_1( Public, void tabPressed( QDeclarativeKeyEvent *event ) )
    DECL_LSCS_SIGNAL_2( tabPressed, event )
    DECL_LSCS_SIGNAL_1( Public, void backtabPressed( QDeclarativeKeyEvent *event ) )
    DECL_LSCS_SIGNAL_2( backtabPressed, event )

    DECL_LSCS_SIGNAL_1( Public, void asteriskPressed( QDeclarativeKeyEvent *event ) )
    DECL_LSCS_SIGNAL_2( asteriskPressed, event )
    DECL_LSCS_SIGNAL_1( Public, void numberSignPressed( QDeclarativeKeyEvent *event ) )
    DECL_LSCS_SIGNAL_2( numberSignPressed, event )
    DECL_LSCS_SIGNAL_1( Public, void escapePressed( QDeclarativeKeyEvent *event ) )
    DECL_LSCS_SIGNAL_2( escapePressed, event )
    DECL_LSCS_SIGNAL_1( Public, void returnPressed( QDeclarativeKeyEvent *event ) )
    DECL_LSCS_SIGNAL_2( returnPressed, event )
    DECL_LSCS_SIGNAL_1( Public, void enterPressed( QDeclarativeKeyEvent *event ) )
    DECL_LSCS_SIGNAL_2( enterPressed, event )
    DECL_LSCS_SIGNAL_1( Public, void deletePressed( QDeclarativeKeyEvent *event ) )
    DECL_LSCS_SIGNAL_2( deletePressed, event )
    DECL_LSCS_SIGNAL_1( Public, void spacePressed( QDeclarativeKeyEvent *event ) )
    DECL_LSCS_SIGNAL_2( spacePressed, event )
    DECL_LSCS_SIGNAL_1( Public, void backPressed( QDeclarativeKeyEvent *event ) )
    DECL_LSCS_SIGNAL_2( backPressed, event )
    DECL_LSCS_SIGNAL_1( Public, void cancelPressed( QDeclarativeKeyEvent *event ) )
    DECL_LSCS_SIGNAL_2( cancelPressed, event )
    DECL_LSCS_SIGNAL_1( Public, void selectPressed( QDeclarativeKeyEvent *event ) )
    DECL_LSCS_SIGNAL_2( selectPressed, event )
    DECL_LSCS_SIGNAL_1( Public, void yesPressed( QDeclarativeKeyEvent *event ) )
    DECL_LSCS_SIGNAL_2( yesPressed, event )
    DECL_LSCS_SIGNAL_1( Public, void noPressed( QDeclarativeKeyEvent *event ) )
    DECL_LSCS_SIGNAL_2( noPressed, event )
    DECL_LSCS_SIGNAL_1( Public, void context1Pressed( QDeclarativeKeyEvent *event ) )
    DECL_LSCS_SIGNAL_2( context1Pressed, event )
    DECL_LSCS_SIGNAL_1( Public, void context2Pressed( QDeclarativeKeyEvent *event ) )
    DECL_LSCS_SIGNAL_2( context2Pressed, event )
    DECL_LSCS_SIGNAL_1( Public, void context3Pressed( QDeclarativeKeyEvent *event ) )
    DECL_LSCS_SIGNAL_2( context3Pressed, event )
    DECL_LSCS_SIGNAL_1( Public, void context4Pressed( QDeclarativeKeyEvent *event ) )
    DECL_LSCS_SIGNAL_2( context4Pressed, event )
    DECL_LSCS_SIGNAL_1( Public, void callPressed( QDeclarativeKeyEvent *event ) )
    DECL_LSCS_SIGNAL_2( callPressed, event )
    DECL_LSCS_SIGNAL_1( Public, void hangupPressed( QDeclarativeKeyEvent *event ) )
    DECL_LSCS_SIGNAL_2( hangupPressed, event )
    DECL_LSCS_SIGNAL_1( Public, void flipPressed( QDeclarativeKeyEvent *event ) )
    DECL_LSCS_SIGNAL_2( flipPressed, event )
    DECL_LSCS_SIGNAL_1( Public, void menuPressed( QDeclarativeKeyEvent *event ) )
    DECL_LSCS_SIGNAL_2( menuPressed, event )
    DECL_LSCS_SIGNAL_1( Public, void volumeUpPressed( QDeclarativeKeyEvent *event ) )
    DECL_LSCS_SIGNAL_2( volumeUpPressed, event )
    DECL_LSCS_SIGNAL_1( Public, void volumeDownPressed( QDeclarativeKeyEvent *event ) )
    DECL_LSCS_SIGNAL_2( volumeDownPressed, event )
