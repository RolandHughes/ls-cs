...
{
    DECL_LSCS_OBJECT( QDeclarativeItem )

    LSCS_INTERFACES( QDeclarativeParserStatus )

    DECL_LSCS_PROPERTY_READ( *, parentItem )
    DECL_LSCS_PROPERTY_WRITE( *, setParentItem )
    DECL_LSCS_PROPERTY_NOTIFY( *, parentChanged )
    DECL_LSCS_PROPERTY_DESIGNABLE( *, false )
    DECL_LSCS_PROPERTY_FINAL( * )
    ...
    */
    ...
    DECL_LSCS_PROPERTY_DESIGNABLE( data, false )

    DECL_LSCS_PROPERTY_READ( resources, resources )
    DECL_LSCS_PROPERTY_DESIGNABLE( resources, false )

    DECL_LSCS_PROPERTY_READ( states, states )
    DECL_LSCS_PROPERTY_DESIGNABLE( states, false )

    DECL_LSCS_PROPERTY_READ( transitions, transitions )
    ...
    DECL_LSCS_PROPERTY_READ( childrenRect, childrenRect )
    DECL_LSCS_PROPERTY_NOTIFY( childrenRect, childrenRectChanged )
    DECL_LSCS_PROPERTY_DESIGNABLE( childrenRect, false )
    DECL_LSCS_PROPERTY_FINAL( childrenRect )
    ...
    */
    ...
    DECL_LSCS_PROPERTY_DESIGNABLE( anchors, false )
    DECL_LSCS_PROPERTY_CONSTANT( anchors )
    DECL_LSCS_PROPERTY_FINAL( anchors )

    DECL_LSCS_PROPERTY_READ( left, left )
    DECL_LSCS_PROPERTY_CONSTANT( left )
    DECL_LSCS_PROPERTY_FINAL( left )

    DECL_LSCS_PROPERTY_READ( right, right )
    DECL_LSCS_PROPERTY_CONSTANT( right )
    DECL_LSCS_PROPERTY_FINAL( right )

    DECL_LSCS_PROPERTY_READ( horizontalCenter, horizontalCenter )
    DECL_LSCS_PROPERTY_CONSTANT( horizontalCenter )
    DECL_LSCS_PROPERTY_FINAL( horizontalCenter )

    DECL_LSCS_PROPERTY_READ( top, top )
    DECL_LSCS_PROPERTY_CONSTANT( top )
    DECL_LSCS_PROPERTY_FINAL( top )

    DECL_LSCS_PROPERTY_READ( bottom, bottom )
    DECL_LSCS_PROPERTY_CONSTANT( bottom )
    DECL_LSCS_PROPERTY_FINAL( bottom )

    DECL_LSCS_PROPERTY_READ( verticalCenter, verticalCenter )
    DECL_LSCS_PROPERTY_CONSTANT( verticalCenter )
    DECL_LSCS_PROPERTY_FINAL( verticalCenter )

    DECL_LSCS_PROPERTY_READ( baseline, baseline )
    DECL_LSCS_PROPERTY_CONSTANT( baseline )
    DECL_LSCS_PROPERTY_FINAL( baseline )
    ...
    DECL_LSCS_PROPERTY_READ( clip, clip )
    DECL_LSCS_PROPERTY_WRITE( clip, setClip )
    DECL_LSCS_PROPERTY_NOTIFY( clip, clipChanged ) // ### move to QGI/QGO, NOTIFY
    DECL_LSCS_PROPERTY_READ( focus, hasFocus )
    DECL_LSCS_PROPERTY_WRITE( focus, setFocus )
    DECL_LSCS_PROPERTY_NOTIFY( focus, focusChanged )
    DECL_LSCS_PROPERTY_FINAL( focus )
    DECL_LSCS_PROPERTY_READ( activeFocus, hasActiveFocus )
    DECL_LSCS_PROPERTY_NOTIFY( activeFocus, activeFocusChanged )
    DECL_LSCS_PROPERTY_READ( transform, transform )
    DECL_LSCS_PROPERTY_DESIGNABLE( transform, false )
    DECL_LSCS_PROPERTY_FINAL( transform )
    DECL_LSCS_PROPERTY_READ( transformOrigin, transformOrigin )
    DECL_LSCS_PROPERTY_WRITE( transformOrigin, setTransformOrigin )
    DECL_LSCS_PROPERTY_NOTIFY( transformOrigin, transformOriginChanged )
    DECL_LSCS_PROPERTY_READ( transformOriginPoint, transformOriginPoint ) // transformOriginPoint is read-only for Item
    DECL_LSCS_PROPERTY_READ( smooth, smooth )
    DECL_LSCS_PROPERTY_WRITE( smooth, setSmooth )
    DECL_LSCS_PROPERTY_NOTIFY( smooth, smoothChanged )
    DECL_LSCS_PROPERTY_READ( implicitWidth, implicitWidth )
    DECL_LSCS_PROPERTY_WRITE( implicitWidth, setImplicitWidth )
...
public:
    ...
    DECL_LSCS_INVOKABLE_METHOD_1( Public, QScriptValue mapFromItem( const QScriptValue &item, qreal x, qreal y ) const )
    DECL_LSCS_INVOKABLE_METHOD_2( mapFromItem )

    DECL_LSCS_INVOKABLE_METHOD_1( Public, QScriptValue mapToItem( const QScriptValue &item, qreal x, qreal y ) const )
    DECL_LSCS_INVOKABLE_METHOD_2( maptToItem )

    DECL_LSCS_INVOKABLE_METHOD_1( Public, void forceActiveFocus() )
    DECL_LSCS_INVOKABLE_METHOD_2( forceActiveFocus )

    DECL_LSCS_INVOKABLE_METHOD_1( Public, QDeclarativeItem *childAt( qreal x, qreal y ) const )
    DECL_LSCS_INVOKABLE_METHOD_2( childAt )

    DECL_LSCS_SIGNAL_1( Public, void childrenRectChanged( const QRectF &un_named_arg1 ) )
    DECL_LSCS_SIGNAL_2( childrenRectChanged, un_named_arg1 )
    DECL_LSCS_SIGNAL_1( Public, void baselineOffsetChanged( qreal un_named_arg1 ) )
    DECL_LSCS_SIGNAL_2( baselineOffsetChanged, un_named_arg1 )
    DECL_LSCS_SIGNAL_1( Public, void stateChanged( const QString &un_named_arg1 ) )
    DECL_LSCS_SIGNAL_2( stateChanged, un_named_arg1 )
    DECL_LSCS_SIGNAL_1( Public, void focusChanged( bool un_named_arg1 ) )
    DECL_LSCS_SIGNAL_2( focusChanged, un_named_arg1 )
    DECL_LSCS_SIGNAL_1( Public, void activeFocusChanged( bool un_named_arg1 ) )
    DECL_LSCS_SIGNAL_2( activeFocusChanged, un_named_arg1 )
    DECL_LSCS_SIGNAL_1( Public, void parentChanged( QDeclarativeItem *un_named_arg1 ) )
    DECL_LSCS_SIGNAL_2( parentChanged, un_named_arg1 )
    DECL_LSCS_SIGNAL_1( Public, void transformOriginChanged( TransformOrigin un_named_arg1 ) )
    DECL_LSCS_SIGNAL_2( transformOriginChanged, un_named_arg1 )
    DECL_LSCS_SIGNAL_1( Public, void smoothChanged( bool un_named_arg1 ) )
    DECL_LSCS_SIGNAL_2( smoothChanged, un_named_arg1 )
    DECL_LSCS_SIGNAL_1( Public, void clipChanged( bool un_named_arg1 ) )
    DECL_LSCS_SIGNAL_2( clipChanged, un_named_arg1 )
