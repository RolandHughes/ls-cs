...
{
    DECL_LSCS_OBJECT( QDeclarativeTextEdit )

    LSCS_ENUM( VAlignment )
    LSCS_ENUM( HAlignment )
    LSCS_ENUM( TextFormat )
    LSCS_ENUM( WrapMode )
    ...
    DECL_LSCS_PROPERTY_NOTIFY( selectedText, selectionChanged )
    ...
    DECL_LSCS_PROPERTY_READ( persistentSelection, persistentSelection )
    DECL_LSCS_PROPERTY_WRITE( persistentSelection, setPersistentSelection )
    DECL_LSCS_PROPERTY_NOTIFY( persistentSelection, persistentSelectionChanged )
    DECL_LSCS_PROPERTY_READ( textMargin, textMargin )
    DECL_LSCS_PROPERTY_WRITE( textMargin, setTextMargin )
    DECL_LSCS_PROPERTY_NOTIFY( textMargin, textMarginChanged )
    DECL_LSCS_PROPERTY_READ( inputMethodHints, inputMethodHints )
    DECL_LSCS_PROPERTY_WRITE( inputMethodHints, setInputMethodHints )
...
public:
    ...
    LSCS_INVOKABLE_METHOD_1( Public, QRectF positionToRectangle( int ) const )
    LSCS_INVOKABLE_METHOD_2( positionToRectangle )

    LSCS_INVOKABLE_METHOD_1( Public, int positionAt( int x, int y ) const )
    LSCS_INVOKABLE_METHOD_2( positionAt )

    LSCS_INVOKABLE_METHOD_1( Public, void moveCursorSelection( int pos ) )
    LSCS_INVOKABLE_METHOD_2( moveCursorSelection )

    LSCS_INVOKABLE_METHOD_1( Public, void moveCursorSelection( int pos, SelectionMode mode ) )
    LSCS_INVOKABLE_METHOD_2( moveCursorSelection )
    LSCS_REVISION( moveCursorSelection, 1 )
    ...
    DECL_LSCS_SIGNAL_1( Public, void textChanged( const QString &un_named_arg1 ) )
    DECL_LSCS_SIGNAL_2( textChanged, un_named_arg1 )
    ...
    DECL_LSCS_SIGNAL_1( Public, void selectionChanged() )
    DECL_LSCS_SIGNAL_2( selectionChanged )
    ...
    DECL_LSCS_SIGNAL_1( Public, void activeFocusOnPressChanged( bool activeFocusOnPressed ) )
    DECL_LSCS_SIGNAL_2( activeFocusOnPressChanged, activeFocusOnPressed )
    DECL_LSCS_SIGNAL_1( Public, void persistentSelectionChanged( bool isPersistentSelection ) )
    DECL_LSCS_SIGNAL_2( persistentSelectionChanged, isPersistentSelection )
    DECL_LSCS_SIGNAL_1( Public, void textMarginChanged( qreal textMargin ) )
    DECL_LSCS_SIGNAL_2( textMarginChanged, textMargin )
...
private :
    DECL_LSCS_SLOT_1( Private, void updateImgCache( const QRectF &rect ) )
    DECL_LSCS_SLOT_2( updateImgCache )
    DECL_LSCS_SLOT_1( Private, void q_textChanged() )
    DECL_LSCS_SLOT_2( q_textChanged )
    DECL_LSCS_SLOT_1( Private, void updateSelectionMarkers() )
    DECL_LSCS_SLOT_2( updateSelectionMarkers )
    DECL_LSCS_SLOT_1( Private, void moveCursorDelegate() )
    DECL_LSCS_SLOT_2( moveCursorDelegate )
    DECL_LSCS_SLOT_1( Private, void loadCursorDelegate() )
    DECL_LSCS_SLOT_2( loadCursorDelegate )
