...
{
    DECL_LSCS_OBJECT( QDeclarativeFontLoader )
...
private :
    DECL_LSCS_SLOT_1( Private, void updateFontInfo( const QString &un_named_arg1, QDeclarativeFontLoader::Status un_named_arg2 ) )
    DECL_LSCS_SLOT_2( updateFontInfo )
